...
public final class SegmentedByteString {
    ...
    public static final String toHexString(byte b) {
        char[] cArr = {ByteString.getHEX_DIGIT_CHARS()[(b >> 4) & 15], ByteString.getHEX_DIGIT_CHARS()[b & Ascii.SI]};
    ...
    public static final String toHexString(long j) {
        ...
        char c7 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 36) & 15)];
        char c8 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 32) & 15)];
        char c9 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 28) & 15)];
        char c10 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 24) & 15)];
        char c11 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 20) & 15)];
        char c12 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 16) & 15)];
        char c13 = c12;
        char[] cArr = {c, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c13, ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 12) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 8) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 4) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) (j & 15)]};
        int i = 0;
        while (i < 16 && cArr[i] == '0') {
            i++;
        }
        return StringsKt.l(cArr, i, 16);
    }
}
