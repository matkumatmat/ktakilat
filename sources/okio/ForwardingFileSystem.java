...
public abstract class ForwardingFileSystem extends FileSystem {
    ...
    public Sequence<Path> listRecursively(@NotNull Path path, boolean z) {
        Intrinsics.checkNotNullParameter(path, "dir");
        Sequence<Path> listRecursively = this.delegate.listRecursively(onPathParameter(path, "listRecursively", "dir"), z);
        ...
        Intrinsics.checkNotNullParameter(forwardingFileSystem$listRecursively$1, "transform");
    ...
    public String toString() {
        return Reflection.a(getClass()).f() + '(' + this.delegate + ')';
    }
}
