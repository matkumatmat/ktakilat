...
public class TypeIntrinsics {
    public static List a(Object obj) {
        if (!(obj instanceof KMappedMarker) || (obj instanceof KMutableList)) {
            try {
                ...
                Intrinsics.h(e, TypeIntrinsics.class.getName());
                throw e;
            }
        } else {
    ...
    public static void e(Object obj, String str) {
        ...
        ClassCastException classCastException = new ClassCastException(e.m(str2, " cannot be cast to ", str));
        Intrinsics.h(classCastException, TypeIntrinsics.class.getName());
