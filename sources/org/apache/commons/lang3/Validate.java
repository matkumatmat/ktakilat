...
public class Validate {
    ...
    public static void isAssignableFrom(Class<?> cls, Class<?> cls2) {
        if (!cls.isAssignableFrom(cls2)) {
            throw new IllegalArgumentException(e.n("Cannot assign a ", cls2 == null ? "null" : cls2.getName(), " to a ", cls.getName()));
        }
    }
    ...
    public static void isInstanceOf(Class<?> cls, Object obj) {
        ...
        if (!cls.isInstance(obj)) {
            ...
            throw new IllegalArgumentException(e.n("Expected type: ", name, ", actual: ", str));
        }
    }
    ...
    public static <T extends CharSequence> T notBlank(T t, String str, Object... objArr) {
        Objects.requireNonNull((CharSequence) t, new ug(str, 3, objArr));
    ...
    public static <T> T[] notEmpty(T[] tArr, String str, Object... objArr) {
        Objects.requireNonNull(tArr, new ug(str, 1, objArr));
        if (tArr.length != 0) {
            return tArr;
        }
        throw new IllegalArgumentException(String.format(str, objArr));
    ...
    public static <T> T notNull(T t, String str, Object... objArr) {
        Objects.requireNonNull(t, new ug(str, 4, objArr));
        return t;
    }
    ...
    public static void exclusiveBetween(long j, long j2, long j3) {
        if (j3 <= j || j3 >= j2) {
            throw new IllegalArgumentException("The value " + j3 + " is not in the specified exclusive range of " + j + " to " + j2);
        }
    }

    public static void inclusiveBetween(long j, long j2, long j3) {
        if (j3 < j || j3 > j2) {
            throw new IllegalArgumentException("The value " + j3 + " is not in the specified inclusive range of " + j + " to " + j2);
        }
    }

    public static <T extends Collection<?>> T notEmpty(T t, String str, Object... objArr) {
        Objects.requireNonNull((Collection) t, new ug(str, 0, objArr));
        if (!t.isEmpty()) {
            return t;
        }
        throw new IllegalArgumentException(String.format(str, objArr));
    ...
    public static void exclusiveBetween(double d, double d2, double d3) {
        if (d3 <= d || d3 >= d2) {
            throw new IllegalArgumentException("The value " + d3 + " is not in the specified exclusive range of " + d + " to " + d2);
        }
    }

    public static void inclusiveBetween(double d, double d2, double d3) {
        if (d3 < d || d3 > d2) {
            throw new IllegalArgumentException("The value " + d3 + " is not in the specified inclusive range of " + d + " to " + d2);
        }
    }
    ...
    public static <T extends Map<?, ?>> T notEmpty(T t, String str, Object... objArr) {
        Objects.requireNonNull((Map) t, new ug(str, 2, objArr));
        if (!t.isEmpty()) {
            return t;
        }
        throw new IllegalArgumentException(String.format(str, objArr));
    ...
    public static <T extends CharSequence> T notEmpty(T t, String str, Object... objArr) {
        Objects.requireNonNull((CharSequence) t, new ug(str, 5, objArr));
        if (t.length() != 0) {
            return t;
        }
        throw new IllegalArgumentException(String.format(str, objArr));
