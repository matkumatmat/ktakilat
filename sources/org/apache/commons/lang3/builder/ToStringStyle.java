...
public abstract class ToStringStyle implements Serializable {
    ...
    public static final class JsonToStringStyle extends ToStringStyle {
        ...
        public void appendDetail(StringBuffer stringBuffer, String str, Collection<?> collection) {
            ...
            int i = 0;
            for (Object appendDetail : collection) {
                appendDetail(stringBuffer, str, i, appendDetail);
                i++;
            }
        ...
        public void appendDetail(StringBuffer stringBuffer, String str, Map<?, ?> map) {
            ...
            for (Map.Entry next : map.entrySet()) {
                String objects = Objects.toString(next.getKey(), (String) null);
                if (objects != null) {
                    if (z) {
                        z = false;
                    } else {
    ...
    public void appendToString(StringBuffer stringBuffer, String str) {
        ...
        if (str != null && (length = this.contentStart.length() + str.indexOf(this.contentStart)) != (lastIndexOf = str.lastIndexOf(this.contentEnd)) && length >= 0 && lastIndexOf >= 0) {
            ...
            stringBuffer.append(str, length, lastIndexOf);
            appendFieldSeparator(stringBuffer);
        }
    }
