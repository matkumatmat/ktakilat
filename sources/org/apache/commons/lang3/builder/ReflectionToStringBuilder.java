...
public class ReflectionToStringBuilder extends ToStringBuilder {
    ...
    public void appendFieldsIn(Class<?> cls) {
        ...
        Field[] fieldArr = (Field[]) ArraySorter.sort(cls.getDeclaredFields(), Comparator.comparing(new d6(1)));
    ...
    public ReflectionToStringBuilder setExcludeFieldNames(String... strArr) {
        if (strArr == null) {
            ...
            this.excludeFieldNames = (String[]) ArraySorter.sort((T[]) toNoNullStringArray((Object[]) strArr));
        }
        return this;
    }
