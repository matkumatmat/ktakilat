...
public class Conversion {
    ...
    public static int byteArrayToInt(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        if (e.A(i4, 1, 8, i3) < 32) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i5 * 8) + i3;
                i2 = (i2 & (~(255 << i6))) | ((bArr[i5 + i] & UnsignedBytes.MAX_VALUE) << i6);
            }
            return i2;
        }
    ...
    public static short byteArrayToShort(byte[] bArr, int i, short s, int i2, int i3) {
        ...
        if (e.A(i3, 1, 8, i2) < 16) {
            for (int i4 = 0; i4 < i3; i4++) {
                int i5 = (i4 * 8) + i2;
                s = (short) ((s & (~(255 << i5))) | ((bArr[i4 + i] & UnsignedBytes.MAX_VALUE) << i5));
            }
            return s;
        }
    ...
    public static char intToHexDigit(int i) {
        ...
        throw new IllegalArgumentException(ba.k(i, "nibble value not between 0 and 15: "));
    }
