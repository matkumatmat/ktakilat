...
public class RandomStringUtils {
    ...
    public static String random(int i, int i2, int i3, boolean z, boolean z2, char[] cArr, Random random) {
        ...
        if (i < 0) {
            throw new IllegalArgumentException(ba.l(i, "Requested random string length ", " is less than 0."));
            ...
            if (cArr != null || ((!z2 || i3 > 48) && (!z || i3 > 65))) {
                ...
                while (true) {
                    ...
                    if ((i6 != 0 || charCount <= 1) && ((z && Character.isLetter(i4)) || ((z2 && Character.isDigit(i4)) || (!z && !z2)))) {
                        ...
                        i = charCount == 2 ? i - 2 : i6;
                    }
                }
            } else {
                throw new IllegalArgumentException(ba.l(i3, "Parameter end (", ") must be greater then (48) for generating digits or greater then (65) for generating letters."));
            }
        } else {
