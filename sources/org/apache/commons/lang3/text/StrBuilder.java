...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public StrBuilder insert(int i, char[] cArr, int i2, int i3) {
        ...
        if (i2 < 0 || i2 > cArr.length) {
            throw new StringIndexOutOfBoundsException(ba.k(i2, "Invalid offset: "));
        } else if (i3 < 0 || i2 + i3 > cArr.length) {
            throw new StringIndexOutOfBoundsException(ba.k(i3, "Invalid length: "));
        } else {
            if (i3 > 0) {
    ...
    public StrBuilder append(char[] cArr, int i, int i2) {
        ...
        if (i < 0 || i > cArr.length) {
            throw new StringIndexOutOfBoundsException(ba.k(i2, "Invalid startIndex: "));
        } else if (i2 < 0 || i + i2 > cArr.length) {
            throw new StringIndexOutOfBoundsException(ba.k(i2, "Invalid length: "));
        } else {
            if (i2 > 0) {
                int length = length();
                ensureCapacity(length + i2);
