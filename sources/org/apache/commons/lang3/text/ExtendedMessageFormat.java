...
public class ExtendedMessageFormat extends MessageFormat {
    ...
    private StringBuilder appendQuotedString(String str, ParsePosition parsePosition, StringBuilder sb) {
        ...
        throw new IllegalArgumentException(ba.k(index, "Unterminated quoted string at position "));
    }
    ...
    private String parseFormatDescription(String str, ParsePosition parsePosition) {
        ...
        throw new IllegalArgumentException(ba.k(index, "Unterminated format element at position "));
    }
    ...
    private int readArgumentIndex(String str, ParsePosition parsePosition) {
        ...
        if (z) {
            StringBuilder t = ba.t(index, "Invalid format argument index at position ", ": ");
            t.append(str.substring(index, parsePosition.getIndex()));
        ...
        while (parsePosition.getIndex() < str.length()) {
            ...
            if (c != '\'') {
                if (c == '{') {
                    ...
                    Validate.isTrue(z2);
                    if (charArray[parsePosition.getIndex()] != '}') {
                        throw new IllegalArgumentException(ba.k(index, "Unreadable format element at position "));
                    }
                }
    ...
    public int hashCode() {
        int hashCode = Objects.hashCode(this.registry);
        return Objects.hashCode(this.toPattern) + ((hashCode + (super.hashCode() * 31)) * 31);
    }
