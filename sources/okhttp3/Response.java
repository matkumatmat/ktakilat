    ...
    public static class Builder {
        ...
        private final void checkSupportResponse(String str, Response response) {
            ...
            if (response.body() != null) {
                throw new IllegalArgumentException(e.l(str, ".body != null").toString());
            } else if (response.networkResponse() != null) {
                throw new IllegalArgumentException(e.l(str, ".networkResponse != null").toString());
            } else if (response.cacheResponse() != null) {
                throw new IllegalArgumentException(e.l(str, ".cacheResponse != null").toString());
            } else if (response.priorResponse() != null) {
                throw new IllegalArgumentException(e.l(str, ".priorResponse != null").toString());
            }
        }
