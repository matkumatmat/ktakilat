...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:31:0x017c  */
    ...
    private final void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r11) throws java.io.IOException {
        /*
            ...
            r4 = 0
            kotlin.jvm.internal.Intrinsics.c(r3)     // Catch:{ all -> 0x016e }
            java.net.Socket r5 = r10.rawSocket     // Catch:{ all -> 0x016e }
            okhttp3.HttpUrl r6 = r2.url()     // Catch:{ all -> 0x016e }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x016e }
            okhttp3.HttpUrl r7 = r2.url()     // Catch:{ all -> 0x016e }
            int r7 = r7.port()     // Catch:{ all -> 0x016e }
            r8 = 1
            java.net.Socket r3 = r3.createSocket(r5, r6, r7, r8)     // Catch:{ all -> 0x016e }
            java.lang.String r5 = "null cannot be cast to non-null type javax.net.ssl.SSLSocket"
            kotlin.jvm.internal.Intrinsics.d(r3, r5)     // Catch:{ all -> 0x016e }
            javax.net.ssl.SSLSocket r3 = (javax.net.ssl.SSLSocket) r3     // Catch:{ all -> 0x016e }
            okhttp3.ConnectionSpec r11 = r11.configureSecureSocket(r3)     // Catch:{ all -> 0x0050 }
            boolean r5 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x0050 }
            if (r5 == 0) goto L_0x0054
            okhttp3.internal.platform.Platform$Companion r5 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0050 }
            okhttp3.internal.platform.Platform r5 = r5.get()     // Catch:{ all -> 0x0050 }
            okhttp3.HttpUrl r6 = r2.url()     // Catch:{ all -> 0x0050 }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x0050 }
            java.util.List r7 = r2.protocols()     // Catch:{ all -> 0x0050 }
            r5.configureTlsExtensions(r3, r6, r7)     // Catch:{ all -> 0x0050 }
            goto L_0x0054
        L_0x0050:
            r11 = move-exception
            r4 = r3
            goto L_0x016f
        L_0x0054:
            r3.startHandshake()     // Catch:{ all -> 0x0050 }
            javax.net.ssl.SSLSession r5 = r3.getSession()     // Catch:{ all -> 0x0050 }
            okhttp3.Handshake$Companion r6 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x0050 }
            java.lang.String r7 = "sslSocketSession"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r5, r7)     // Catch:{ all -> 0x0050 }
            okhttp3.Handshake r6 = r6.get(r5)     // Catch:{ all -> 0x0050 }
            javax.net.ssl.HostnameVerifier r7 = r2.hostnameVerifier()     // Catch:{ all -> 0x0050 }
            kotlin.jvm.internal.Intrinsics.c(r7)     // Catch:{ all -> 0x0050 }
            okhttp3.HttpUrl r8 = r2.url()     // Catch:{ all -> 0x0050 }
            java.lang.String r8 = r8.host()     // Catch:{ all -> 0x0050 }
            boolean r5 = r7.verify(r8, r5)     // Catch:{ all -> 0x0050 }
            if (r5 != 0) goto L_0x0102
            java.util.List r11 = r6.peerCertificates()     // Catch:{ all -> 0x0050 }
            r4 = r11
            java.util.Collection r4 = (java.util.Collection) r4     // Catch:{ all -> 0x0050 }
            boolean r4 = r4.isEmpty()     // Catch:{ all -> 0x0050 }
            if (r4 != 0) goto L_0x00e3
            r0 = 0
            java.lang.Object r11 = r11.get(r0)     // Catch:{ all -> 0x0050 }
            java.lang.String r0 = "null cannot be cast to non-null type java.security.cert.X509Certificate"
            kotlin.jvm.internal.Intrinsics.d(r11, r0)     // Catch:{ all -> 0x0050 }
            java.security.cert.X509Certificate r11 = (java.security.cert.X509Certificate) r11     // Catch:{ all -> 0x0050 }
            javax.net.ssl.SSLPeerUnverifiedException r0 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x0050 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x0050 }
            r4.<init>(r1)     // Catch:{ all -> 0x0050 }
            okhttp3.HttpUrl r1 = r2.url()     // Catch:{ all -> 0x0050 }
            java.lang.String r1 = r1.host()     // Catch:{ all -> 0x0050 }
            r4.append(r1)     // Catch:{ all -> 0x0050 }
            java.lang.String r1 = " not verified:\n              |    certificate: "
            r4.append(r1)     // Catch:{ all -> 0x0050 }
            okhttp3.CertificatePinner$Companion r1 = okhttp3.CertificatePinner.Companion     // Catch:{ all -> 0x0050 }
            java.lang.String r1 = r1.pin(r11)     // Catch:{ all -> 0x0050 }
            r4.append(r1)     // Catch:{ all -> 0x0050 }
            java.lang.String r1 = "\n              |    DN: "
            r4.append(r1)     // Catch:{ all -> 0x0050 }
            java.security.Principal r1 = r11.getSubjectDN()     // Catch:{ all -> 0x0050 }
            java.lang.String r1 = r1.getName()     // Catch:{ all -> 0x0050 }
            r4.append(r1)     // Catch:{ all -> 0x0050 }
            java.lang.String r1 = "\n              |    subjectAltNames: "
            r4.append(r1)     // Catch:{ all -> 0x0050 }
            okhttp3.internal.tls.OkHostnameVerifier r1 = okhttp3.internal.tls.OkHostnameVerifier.INSTANCE     // Catch:{ all -> 0x0050 }
            java.util.List r11 = r1.allSubjectAltNames(r11)     // Catch:{ all -> 0x0050 }
            r4.append(r11)     // Catch:{ all -> 0x0050 }
            java.lang.String r11 = "\n              "
            r4.append(r11)     // Catch:{ all -> 0x0050 }
            java.lang.String r11 = r4.toString()     // Catch:{ all -> 0x0050 }
            java.lang.String r11 = kotlin.text.StringsKt.S(r11)     // Catch:{ all -> 0x0050 }
            r0.<init>(r11)     // Catch:{ all -> 0x0050 }
            throw r0     // Catch:{ all -> 0x0050 }
        L_0x00e3:
            javax.net.ssl.SSLPeerUnverifiedException r11 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x0050 }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ all -> 0x0050 }
            r1.<init>(r0)     // Catch:{ all -> 0x0050 }
            okhttp3.HttpUrl r0 = r2.url()     // Catch:{ all -> 0x0050 }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x0050 }
            r1.append(r0)     // Catch:{ all -> 0x0050 }
            java.lang.String r0 = " not verified (no certificates)"
            r1.append(r0)     // Catch:{ all -> 0x0050 }
            java.lang.String r0 = r1.toString()     // Catch:{ all -> 0x0050 }
            r11.<init>(r0)     // Catch:{ all -> 0x0050 }
            throw r11     // Catch:{ all -> 0x0050 }
        L_0x0102:
            okhttp3.CertificatePinner r0 = r2.certificatePinner()     // Catch:{ all -> 0x0050 }
            kotlin.jvm.internal.Intrinsics.c(r0)     // Catch:{ all -> 0x0050 }
            okhttp3.Handshake r1 = new okhttp3.Handshake     // Catch:{ all -> 0x0050 }
            okhttp3.TlsVersion r5 = r6.tlsVersion()     // Catch:{ all -> 0x0050 }
            okhttp3.CipherSuite r7 = r6.cipherSuite()     // Catch:{ all -> 0x0050 }
            java.util.List r8 = r6.localCertificates()     // Catch:{ all -> 0x0050 }
            okhttp3.internal.connection.RealConnection$connectTls$1 r9 = new okhttp3.internal.connection.RealConnection$connectTls$1     // Catch:{ all -> 0x0050 }
            r9.<init>(r0, r6, r2)     // Catch:{ all -> 0x0050 }
            r1.<init>(r5, r7, r8, r9)     // Catch:{ all -> 0x0050 }
            r10.handshake = r1     // Catch:{ all -> 0x0050 }
            okhttp3.HttpUrl r1 = r2.url()     // Catch:{ all -> 0x0050 }
            java.lang.String r1 = r1.host()     // Catch:{ all -> 0x0050 }
            okhttp3.internal.connection.RealConnection$connectTls$2 r2 = new okhttp3.internal.connection.RealConnection$connectTls$2     // Catch:{ all -> 0x0050 }
            r2.<init>(r10)     // Catch:{ all -> 0x0050 }
            r0.check$okhttp(r1, r2)     // Catch:{ all -> 0x0050 }
            boolean r11 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x0050 }
            if (r11 == 0) goto L_0x0141
            okhttp3.internal.platform.Platform$Companion r11 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0050 }
            okhttp3.internal.platform.Platform r11 = r11.get()     // Catch:{ all -> 0x0050 }
            java.lang.String r4 = r11.getSelectedProtocol(r3)     // Catch:{ all -> 0x0050 }
        L_0x0141:
            r10.socket = r3     // Catch:{ all -> 0x0050 }
            okio.Source r11 = okio.Okio.source((java.net.Socket) r3)     // Catch:{ all -> 0x0050 }
            okio.BufferedSource r11 = okio.Okio.buffer((okio.Source) r11)     // Catch:{ all -> 0x0050 }
            r10.source = r11     // Catch:{ all -> 0x0050 }
            okio.Sink r11 = okio.Okio.sink((java.net.Socket) r3)     // Catch:{ all -> 0x0050 }
            okio.BufferedSink r11 = okio.Okio.buffer((okio.Sink) r11)     // Catch:{ all -> 0x0050 }
            r10.sink = r11     // Catch:{ all -> 0x0050 }
            if (r4 == 0) goto L_0x0160
            okhttp3.Protocol$Companion r11 = okhttp3.Protocol.Companion     // Catch:{ all -> 0x0050 }
            okhttp3.Protocol r11 = r11.get(r4)     // Catch:{ all -> 0x0050 }
            goto L_0x0162
        L_0x0160:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ all -> 0x0050 }
        L_0x0162:
            r10.protocol = r11     // Catch:{ all -> 0x0050 }
        ...
        while (true) {
            ...
            if (code != 200) {
                if (code == 407) {
                    ...
                    } else if ("close".equalsIgnoreCase(Response.header$default(build, HttpHeaders.CONNECTION, (String) null, 2, (Object) null))) {
                        return authenticate;
                    } else {
    ...
    private final boolean routeMatchesAny(List<Route> list) {
        ...
        for (Route route2 : iterable) {
            ...
            if (type == type2 && this.route.proxy().type() == type2 && Intrinsics.a(this.route.socketAddress(), route2.socketAddress())) {
                return true;
            }
        }
        return false;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:18:0x008e A[Catch:{ IOException -> 0x00a9 }] */
    ...
    public final void connect(int r17, int r18, int r19, int r20, boolean r21, @org.jetbrains.annotations.NotNull okhttp3.Call r22, @org.jetbrains.annotations.NotNull okhttp3.EventListener r23) {
        ...
        L_0x0052:
            ...
            java.lang.String r0 = defpackage.ba.o(r3, r0, r4)
            r2.<init>(r0)
            r1.<init>(r2)
            throw r1
        L_0x0065:
        ...
        L_0x0084:
            ...
            r12 = r11
        L_0x0086:
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00a9 }
            boolean r0 = r0.requiresTunnel()     // Catch:{ IOException -> 0x00a9 }
            ...
            r5 = r22
            r6 = r23
            r1.connectTunnel(r2, r3, r4, r5, r6)     // Catch:{ IOException -> 0x00a9 }
            java.net.Socket r0 = r7.rawSocket     // Catch:{ IOException -> 0x00a9 }
        ...
        L_0x00b1:
            ...
            goto L_0x00a6
        L_0x00b9:
            r7.establishProtocol(r10, r15, r8, r9)     // Catch:{ IOException -> 0x00ee }
