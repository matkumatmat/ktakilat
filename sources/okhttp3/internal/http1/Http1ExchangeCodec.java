...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public final class ChunkedSource extends AbstractSource {
        ...
        private final void readChunkSize() {
            ...
            try {
                ...
                String obj = StringsKt.Q(this.this$0.source.readUtf8LineStrict()).toString();
                if (this.bytesRemainingInChunk < 0 || (obj.length() > 0 && !StringsKt.I(obj, ";", false))) {
    ...
    private final boolean isChunked(Response response) {
        return "chunked".equalsIgnoreCase(Response.header$default(response, com.google.common.net.HttpHeaders.TRANSFER_ENCODING, (String) null, 2, (Object) null));
    }
    ...
    public Response.Builder readResponseHeaders(boolean z) {
        ...
        if (i == 1 || i == 2 || i == 3) {
            try {
                ...
                throw new IOException(e.B("unexpected end of stream on ", getConnection().route().address().url().redact()), e);
            }
        } else {
            throw new IllegalStateException(("state: " + this.state).toString());
        }
