    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers headers, Headers headers2) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((!HttpHeaders.WARNING.equalsIgnoreCase(name) || !StringsKt.I(value, AppEventsConstants.EVENT_PARAM_VALUE_YES, false)) && (isContentSpecificHeader(name) || !isEndToEnd(name) || headers2.get(name) == null)) {
