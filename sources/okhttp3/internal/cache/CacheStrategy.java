        ...
        public Factory(long j, @NotNull Request request2, @Nullable Response response) {
            ...
            if (response != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (StringsKt.q(name, HttpHeaders.DATE, true)) {
                        this.servedDate = DatesKt.toHttpDateOrNull(value);
                        this.servedDateString = value;
                    } else if (StringsKt.q(name, HttpHeaders.EXPIRES, true)) {
                        this.expires = DatesKt.toHttpDateOrNull(value);
                    } else if (StringsKt.q(name, HttpHeaders.LAST_MODIFIED, true)) {
                        this.lastModified = DatesKt.toHttpDateOrNull(value);
                        this.lastModifiedString = value;
                    } else if (StringsKt.q(name, HttpHeaders.ETAG, true)) {
                        this.etag = value;
                    } else if (StringsKt.q(name, HttpHeaders.AGE, true)) {
