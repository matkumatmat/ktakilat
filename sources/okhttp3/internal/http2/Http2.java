...
public final class Http2 {
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            strArr[i] = StringsKt.D(Util.format("%8s", binaryString), ' ', '0');
        }
        BINARY = strArr;
        ...
        strArr2[8] = "PADDED";
        int i2 = iArr[0];
        strArr2[i2 | 8] = ba.r(new StringBuilder(), strArr2[i2], "|PADDED");
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            ...
            sb.append('|');
            strArr3[i6 | 8] = ba.r(sb, strArr3[i4], "|PADDED");
        }
    ...
    public final String formatFlags(int i, int i2) {
        ...
        if (!(i == 2 || i == 3)) {
            if (i == 4 || i == 6) {
                ...
                if (i == 5 && (i2 & 4) != 0) {
                    return StringsKt.E(str, "HEADERS", "PUSH_PROMISE");
                }
                if (i != 0 || (i2 & 32) == 0) {
                    return str;
                }
                return StringsKt.E(str, "PRIORITY", "COMPRESSED");
            }
        }
        return BINARY[i2];
    }
