    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(@NotNull Request request) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (Intrinsics.a(lowerCase, Http2ExchangeCodec.TE) && Intrinsics.a(headers.value(i), "trailers"))) {
