    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(@NotNull Headers headers) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                if (StringsKt.q(headers2.name(i), "Sec-WebSocket-Extensions", true)) {
                    ...
                    while (i2 < value.length()) {
                        ...
                        if (StringsKt.q(trimSubstring, "permessage-deflate", true)) {
                            if (z) {
                                z4 = true;
                            }
                            i2 = i3;
                            while (i2 < delimiterOffset$default) {
                                ...
                                if (delimiterOffset3 < delimiterOffset2) {
                                    str = StringsKt.B(Util.trimSubstring(value, delimiterOffset3 + 1, delimiterOffset2));
                                } else {
                                    str = null;
                                }
                                i2 = delimiterOffset2 + 1;
                                if (StringsKt.q(trimSubstring2, "client_max_window_bits", true)) {
                                    if (num != null) {
                                        z4 = true;
                                    }
                                    if (str != null) {
                                ...
                                } else if (StringsKt.q(trimSubstring2, "client_no_context_takeover", true)) {
                                    if (z2) {
                                        z4 = true;
                                    }
                                    if (str != null) {
                                    ...
                                    z2 = true;
                                } else if (StringsKt.q(trimSubstring2, "server_max_window_bits", true)) {
                                    if (num2 != null) {
                                        z4 = true;
                                    }
                                    if (str != null) {
                                ...
                                } else if (StringsKt.q(trimSubstring2, "server_no_context_takeover", true)) {
                                    if (z3) {
                                        z4 = true;
                                    }
                                    if (str != null) {
