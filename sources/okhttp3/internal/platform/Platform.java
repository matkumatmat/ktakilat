...
public class Platform {
    ...
    public void logCloseableLeak(@NotNull String str, @Nullable Object obj) {
        Intrinsics.checkNotNullParameter(str, ShareConstants.WEB_DIALOG_PARAM_MESSAGE);
        if (obj == null) {
            str = e.l(str, " To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);");
        }
    ...
    public X509TrustManager trustManager(@NotNull SSLSocketFactory sSLSocketFactory) {
        ...
        try {
            ...
            Object readFieldOrNull = Util.readFieldOrNull(sSLSocketFactory, cls, PlaceFields.CONTEXT);
