...
public final class Request {
    ...
    public static class Builder {
        ...
        @NotNull
        public Builder get() {
            return method(FirebasePerformance.HttpMethod.GET, (RequestBody) null);
        }
            ...
            if (str.length() > 0) {
                if (requestBody == null) {
                    if (HttpMethod.requiresRequestBody(str)) {
                        throw new IllegalArgumentException(ba.o("method ", str, " must have a request body.").toString());
                    }
                } else if (!HttpMethod.permitsRequestBody(str)) {
                    throw new IllegalArgumentException(ba.o("method ", str, " must not have a request body.").toString());
                }
                this.method = str;
        ...
        public Builder url(@NotNull String str) {
            ...
            if (StringsKt.I(str, "ws:", true)) {
                StringBuilder sb = new StringBuilder("http:");
                String substring = str.substring(3);
                Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String).substring(startIndex)");
                sb.append(substring);
                str = sb.toString();
            } else if (StringsKt.I(str, "wss:", true)) {
        ...
        public Builder(@NotNull Request request) {
            ...
            if (request.getTags$okhttp().isEmpty()) {
                ...
                linkedHashMap = MapsKt.i(request.getTags$okhttp());
            }
