...
public final class CertificatePinner {
    ...
    public static final class Builder {
        ...
        public final CertificatePinner build() {
            return new CertificatePinner(CollectionsKt.G(this.pins), (CertificateChainCleaner) null, 2, (DefaultConstructorMarker) null);
        }
    ...
    public static final class Pin {
        ...
        public Pin(@NotNull String str, @NotNull String str2) {
            ...
            if ((!StringsKt.I(str, "*.", false) || StringsKt.s(str, "*", 1, false, 4) != -1) && ((!StringsKt.I(str, "**.", false) || StringsKt.s(str, "*", 2, false, 4) != -1) && StringsKt.s(str, "*", 0, false, 6) != -1)) {
                throw new IllegalArgumentException("Unexpected pattern: ".concat(str).toString());
            }
            String canonicalHost = HostnamesKt.toCanonicalHost(str);
            if (canonicalHost != null) {
                this.pattern = canonicalHost;
                if (StringsKt.I(str2, "sha1/", false)) {
                ...
                } else if (StringsKt.I(str2, "sha256/", false)) {
        ...
        public int hashCode() {
            return this.hash.hashCode() + ba.d(this.pattern.hashCode() * 31, 31, this.hashAlgorithm);
        }
        ...
        public final boolean matchesHostname(@NotNull String str) {
            ...
            if (StringsKt.I(this.pattern, "**.", false)) {
                int length = this.pattern.length() - 3;
                int length2 = str.length() - length;
                if (!StringsKt__StringsJVMKt.a(str, str.length() - length, false, this.pattern, 3, length)) {
                    return false;
                }
                ...
                return false;
            } else if (!StringsKt.I(this.pattern, "*.", false)) {
                return Intrinsics.a(str, this.pattern);
            } else {
                int length3 = this.pattern.length() - 1;
                int length4 = str.length() - length3;
                if (!StringsKt__StringsJVMKt.a(str, str.length() - length3, false, this.pattern, 1, length3) || StringsKt.w(str, ClassUtils.PACKAGE_SEPARATOR_CHAR, length4 - 1, 4) != -1) {
                    return false;
                }
            }
            return true;
    ...
    public final void check(@NotNull String str, @NotNull Certificate... certificateArr) throws SSLPeerUnverifiedException {
        ...
        check(str, (List<? extends Certificate>) ArraysKt.y(certificateArr));
    }
