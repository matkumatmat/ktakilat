...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            strArr2 = Util.intersect(enabledProtocols, this.tlsVersionsAsString, ComparisonsKt.b());
        } else {
    ...
    public final boolean isCompatible(@NotNull SSLSocket sSLSocket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), ComparisonsKt.b())) {
            return false;
        }
