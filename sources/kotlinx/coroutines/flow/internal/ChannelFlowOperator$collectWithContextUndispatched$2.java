...
final class ChannelFlowOperator$collectWithContextUndispatched$2 extends SuspendLambda implements Function2<FlowCollector<Object>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        ChannelFlowOperator$collectWithContextUndispatched$2 channelFlowOperator$collectWithContextUndispatched$2 = new ChannelFlowOperator$collectWithContextUndispatched$2(this.e, continuation);
        channelFlowOperator$collectWithContextUndispatched$2.d = obj;
        return channelFlowOperator$collectWithContextUndispatched$2;
    }

    public final Object invoke(Object obj, Object obj2) {
        return ((ChannelFlowOperator$collectWithContextUndispatched$2) create((FlowCollector) obj, (Continuation) obj2)).invokeSuspend(Unit.f696a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            this.c = 1;
            if (this.e.g((FlowCollector) this.d, this) == coroutineSingletons) {
