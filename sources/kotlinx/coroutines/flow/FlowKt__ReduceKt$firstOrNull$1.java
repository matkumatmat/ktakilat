...
final class FlowKt__ReduceKt$firstOrNull$1<T> extends ContinuationImpl {
    ...
    public FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1 d;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                this.c = objectRef2;
                this.d = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1;
                this.f = 1;
                throw null;
                ...
                if (e2.owner != flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) {
                    throw e2;
                }
                return objectRef.element;
            }
        } else if (i == 1) {
            flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1 = this.d;
            objectRef = this.c;
            try {
                ResultKt.b(obj);
