...
public final class ObservableSwitchMapMaybe<T, R> extends Observable<R> {
    ...
    public static final class SwitchMapMaybeMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        public static final SwitchMapMaybeObserver l = new SwitchMapMaybeObserver((SwitchMapMaybeMainObserver) null);
        ...
        public static final class SwitchMapMaybeObserver<R> extends AtomicReference<Disposable> implements MaybeObserver<R> {
            ...
            public final SwitchMapMaybeMainObserver c;
            ...
            public final void onComplete() {
                SwitchMapMaybeMainObserver switchMapMaybeMainObserver = this.c;
                AtomicReference atomicReference = switchMapMaybeMainObserver.g;
            ...
            public final void onError(Throwable th) {
                ...
                while (true) {
                    ...
                    } else if (switchMapMaybeMainObserver.f.addThrowable(th)) {
                        if (!switchMapMaybeMainObserver.e) {
                            switchMapMaybeMainObserver.i.dispose();
        ...
        public final void b() {
            ...
            L_0x0060:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.operators.mixed.ObservableSwitchMapMaybe.SwitchMapMaybeMainObserver.b():void");
        }
    ...
    public final void subscribeActual(Observer observer) {
        ...
        if (!ScalarXMapZHelper.b(observable, function, observer)) {
            observable.subscribe(new SwitchMapMaybeMainObserver(observer, function, this.e));
        }
    }
}
