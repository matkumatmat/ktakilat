...
public final class StaticImageDecoder$decode$lambda$2$lambda$1$$inlined$decodeBitmap$1 implements ImageDecoder.OnHeaderDecodedListener {
    ...
    public final /* synthetic */ StaticImageDecoder f78a;
    ...
    public StaticImageDecoder$decode$lambda$2$lambda$1$$inlined$decodeBitmap$1(StaticImageDecoder staticImageDecoder, Ref.BooleanRef booleanRef) {
        this.f78a = staticImageDecoder;
        this.b = booleanRef;
    }

    /* JADX WARNING: type inference failed for: r10v2, types: [ef, java.lang.Object] */
    public final void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
        ...
        if (width > 0 && height > 0 && !(width == i3 && height == i4)) {
            double b2 = DecodeUtils.b(width, height, i3, i4, this.f78a.c.c);
            ...
            if (z || this.f78a.c.d == Precision.EXACT) {
                imageDecoder.setTargetSize(MathKt.a(((double) width) * b2), MathKt.a(b2 * ((double) height)));
            }
        }
        StaticImageDecoder staticImageDecoder = this.f78a;
        imageDecoder.setOnPartialImageListener(new Object());
        Options options2 = staticImageDecoder.c;
        ...
        imageDecoder.setUnpremultipliedRequired(!((Boolean) ExtrasKt.b(options2, ImageRequests_androidKt.e)).booleanValue());
    }
}
