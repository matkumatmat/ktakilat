    ...
    public void onStateChanged(@NotNull LifecycleOwner lifecycleOwner, @NotNull Lifecycle.Event event) {
        ...
        if (event == Lifecycle.Event.Companion.upTo(this.$state)) {
            ...
            try {
                ...
                obj = Result.m16constructorimpl(function0.invoke());
            } catch (Throwable th) {
            ...
            cancellableContinuation2.resumeWith(Result.m16constructorimpl(ResultKt.a(new LifecycleDestroyedException())));
        }
    }
}
