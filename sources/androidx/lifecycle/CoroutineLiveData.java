...
public final class CoroutineLiveData<T> extends MediatorLiveData<T> {
    ...
    public CoroutineLiveData(@NotNull CoroutineContext coroutineContext, long j, @NotNull Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        CompletableJob a2 = SupervisorKt.a((Job) coroutineContext.get(Job.Key.c));
        DefaultScheduler defaultScheduler = Dispatchers.f767a;
        this.blockRunner = new BlockRunner(this, function2, j, CoroutineScopeKt.a(MainDispatcherLoader.f801a.t().plus(coroutineContext).plus(a2)), new Function0<Unit>(this) {
