...
public final class ViewModelProviderImpl {
    ...
    public ViewModelProviderImpl(@NotNull ViewModelStore viewModelStore, @NotNull ViewModelProvider.Factory factory2, @NotNull CreationExtras creationExtras) {
    ...
    public final <T extends ViewModel> T getViewModel$lifecycle_viewmodel_release(@NotNull KClass<T> kClass, @NotNull String str) {
        ...
        if (kClass.d(t)) {
            ...
            Intrinsics.d(t, "null cannot be cast to non-null type T of androidx.lifecycle.viewmodel.ViewModelProviderImpl.getViewModel");
            return t;
        }
    ...
    public ViewModelProviderImpl(@NotNull ViewModelStoreOwner viewModelStoreOwner, @NotNull ViewModelProvider.Factory factory2, @NotNull CreationExtras creationExtras) {
