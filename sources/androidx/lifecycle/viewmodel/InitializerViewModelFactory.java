...
public final class InitializerViewModelFactory implements ViewModelProvider.Factory {
    ...
    public final /* synthetic */ ViewModel create(Class cls) {
        return hh.a(this, cls);
    }

    public final /* synthetic */ ViewModel create(KClass kClass, CreationExtras creationExtras) {
        return hh.c(this, kClass, creationExtras);
    }
    ...
    public <VM extends ViewModel> VM create(@NotNull Class<VM> cls, @NotNull CreationExtras creationExtras) {
        ...
        return viewModelProviders.createViewModelFromInitializers$lifecycle_viewmodel_release(a2, creationExtras, (ViewModelInitializer[]) Arrays.copyOf(viewModelInitializerArr, viewModelInitializerArr.length));
    }
}
