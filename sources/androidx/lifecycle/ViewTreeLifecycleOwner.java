...
public final class ViewTreeLifecycleOwner {
    ...
    public static final LifecycleOwner get(@NotNull View view) {
        ...
        return (LifecycleOwner) SequencesKt.f(SequencesKt.k(SequencesKt.i(ViewTreeLifecycleOwner$findViewTreeLifecycleOwner$1.INSTANCE, view), ViewTreeLifecycleOwner$findViewTreeLifecycleOwner$2.INSTANCE));
    }
