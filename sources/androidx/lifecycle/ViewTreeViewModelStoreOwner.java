...
public final class ViewTreeViewModelStoreOwner {
    ...
    public static final ViewModelStoreOwner get(@NotNull View view) {
        ...
        return (ViewModelStoreOwner) SequencesKt.f(SequencesKt.k(SequencesKt.i(ViewTreeViewModelStoreOwner$findViewTreeViewModelStoreOwner$1.INSTANCE, view), ViewTreeViewModelStoreOwner$findViewTreeViewModelStoreOwner$2.INSTANCE));
    }
