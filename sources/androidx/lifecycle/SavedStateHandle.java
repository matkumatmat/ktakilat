...
public final class SavedStateHandle {
    ...
    public SavedStateHandle(@NotNull Map<String, ? extends Object> map) {
        ...
        this.savedStateProvider = new o3(this, 3);
    ...
    public static final Bundle savedStateProvider$lambda$0(SavedStateHandle savedStateHandle) {
        ...
        for (Map.Entry entry : MapsKt.h(savedStateHandle.savedStateProviders).entrySet()) {
    ...
    public final <T> MutableLiveData<T> getLiveData(@NotNull String str) {
        ...
        Intrinsics.d(liveDataInternal, "null cannot be cast to non-null type androidx.lifecycle.MutableLiveData<T of androidx.lifecycle.SavedStateHandle.getLiveData>");
    ...
    public final <T> StateFlow<T> getStateFlow(@NotNull String str, T t) {
        ...
        return FlowKt.a(mutableStateFlow);
    }

    @NotNull
    @MainThread
    public final Set<String> keys() {
        return SetsKt.a(SetsKt.a(this.regular.keySet(), this.savedStateProviders.keySet()), this.liveDatas.keySet());
    }
