...
public final class LifecycleCoroutineScopeImpl extends LifecycleCoroutineScope implements LifecycleEventObserver {
    ...
    public LifecycleCoroutineScopeImpl(@NotNull Lifecycle lifecycle2, @NotNull CoroutineContext coroutineContext2) {
        ...
        if (getLifecycle$lifecycle_common().getCurrentState() == Lifecycle.State.DESTROYED && (job = (Job) getCoroutineContext().get(Job.Key.c)) != null) {
    ...
    public void onStateChanged(@NotNull LifecycleOwner lifecycleOwner, @NotNull Lifecycle.Event event) {
        ...
        if (getLifecycle$lifecycle_common().getCurrentState().compareTo(Lifecycle.State.DESTROYED) <= 0) {
            ...
            Job job = (Job) getCoroutineContext().get(Job.Key.c);
            if (job != null) {
                job.c((CancellationException) null);
            }
        }
    ...
    public final void register() {
        ...
        BuildersKt.b(this, MainDispatcherLoader.f801a.t(), (CoroutineStart) null, new LifecycleCoroutineScopeImpl$register$1(this, (Continuation<? super LifecycleCoroutineScopeImpl$register$1>) null), 2);
    }
}
