...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(@androidx.annotation.NonNull android.content.Intent r23) {
        /*
            ...
            monitor-enter(r2)
            java.lang.String r10 = r23.getAction()     // Catch:{ all -> 0x0035 }
            android.content.Context r3 = r1.mAppContext     // Catch:{ all -> 0x0035 }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ all -> 0x0035 }
            java.lang.String r11 = r0.resolveTypeIfNeeded(r3)     // Catch:{ all -> 0x0035 }
            android.net.Uri r12 = r23.getData()     // Catch:{ all -> 0x0035 }
            java.lang.String r13 = r23.getScheme()     // Catch:{ all -> 0x0035 }
            java.util.Set r14 = r23.getCategories()     // Catch:{ all -> 0x0035 }
            int r3 = r23.getFlags()     // Catch:{ all -> 0x0035 }
            r3 = r3 & 8
            r9 = 1
        ...
        L_0x002f:
            ...
            r23.toString()     // Catch:{ all -> 0x0035 }
            goto L_0x0038
        L_0x0035:
            r0 = move-exception
            goto L_0x00e0
        L_0x0038:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r3 = r1.mActions     // Catch:{ all -> 0x0035 }
            java.lang.String r4 = r23.getAction()     // Catch:{ all -> 0x0035 }
            java.lang.Object r3 = r3.get(r4)     // Catch:{ all -> 0x0035 }
            r8 = r3
            java.util.ArrayList r8 = (java.util.ArrayList) r8     // Catch:{ all -> 0x0035 }
            if (r8 == 0) goto L_0x00dd
            if (r16 == 0) goto L_0x004c
            r8.toString()     // Catch:{ all -> 0x0035 }
        L_0x004c:
            r3 = 0
            r7 = r3
            r6 = 0
        L_0x004f:
            int r3 = r8.size()     // Catch:{ all -> 0x0035 }
            if (r6 >= r3) goto L_0x00ad
            java.lang.Object r3 = r8.get(r6)     // Catch:{ all -> 0x0035 }
            r5 = r3
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r5 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x0035 }
            if (r16 == 0) goto L_0x0063
            android.content.IntentFilter r3 = r5.filter     // Catch:{ all -> 0x0035 }
            java.util.Objects.toString(r3)     // Catch:{ all -> 0x0035 }
        L_0x0063:
            boolean r3 = r5.broadcasting     // Catch:{ all -> 0x0035 }
        ...
        L_0x0072:
            ...
            r11 = 1
            r9 = r17
            int r3 = r3.match(r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0035 }
            if (r3 < 0) goto L_0x00a2
            if (r16 == 0) goto L_0x0093
            java.lang.Integer.toHexString(r3)     // Catch:{ all -> 0x0035 }
        L_0x0093:
        ...
        L_0x009b:
            r7 = r10
        L_0x009c:
            r7.add(r15)     // Catch:{ all -> 0x0035 }
            r15.broadcasting = r11     // Catch:{ all -> 0x0035 }
            goto L_0x00a3
        L_0x00a2:
            r7 = r10
        L_0x00a3:
        ...
        L_0x00ad:
            ...
            r3 = 0
        L_0x00b2:
            int r4 = r10.size()     // Catch:{ all -> 0x0035 }
            if (r3 >= r4) goto L_0x00c4
            java.lang.Object r4 = r10.get(r3)     // Catch:{ all -> 0x0035 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r4 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x0035 }
            r5 = 0
            r4.broadcasting = r5     // Catch:{ all -> 0x0035 }
            int r3 = r3 + 1
            goto L_0x00b2
        L_0x00c4:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r1.mPendingBroadcasts     // Catch:{ all -> 0x0035 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r4 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x0035 }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x0035 }
            r3.add(r4)     // Catch:{ all -> 0x0035 }
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x0035 }
            boolean r0 = r0.hasMessages(r11)     // Catch:{ all -> 0x0035 }
            if (r0 != 0) goto L_0x00db
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x0035 }
            r0.sendEmptyMessage(r11)     // Catch:{ all -> 0x0035 }
        L_0x00db:
