...
public class MotionLabel extends View implements FloatLayout {
    ...
    private float getHorizontalOffset() {
        ...
        return ((this.mTextPanX + 1.0f) * (((f2 - ((float) getPaddingLeft())) - ((float) getPaddingRight())) - measureText)) / 2.0f;
    }
            ...
            if (this.mViewOutlineProvider == null) {
                AnonymousClass1 r6 = new ViewOutlineProvider() {
                    public void getOutline(View view, Outline outline) {
                        ...
                        outline.setRoundRect(0, 0, width, height, (MotionLabel.this.mRoundPercent * ((float) Math.min(width, height))) / 2.0f);
                    }
                };
