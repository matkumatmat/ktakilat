...
public abstract class ViewTimeCycle extends TimeCycleSplineSet {
    ...
    public static class CustomSet extends ViewTimeCycle {
        ...
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
            ...
            float f4 = (float) ((((((double) j3) * 1.0E-9d) * ((double) f2)) + ((double) this.last_cycle)) % 1.0d);
            this.last_cycle = f4;
            this.last_time = j2;
    ...
    public float get(float f, long j, View view, KeyCache keyCache) {
        ...
        float f3 = (float) ((((((double) (j2 - this.last_time)) * 1.0E-9d) * ((double) f2)) + ((double) this.last_cycle)) % 1.0d);
        this.last_cycle = f3;
