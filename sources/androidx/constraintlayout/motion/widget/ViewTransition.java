...
public class ViewTransition {
    ...
    public static class Animate {
        ...
        public void mutateForward() {
            ...
            long nanoTime = System.nanoTime();
            this.mLastRender = nanoTime;
            float f = (((float) (((double) (nanoTime - this.mLastRender)) * 1.0E-6d)) * this.mDpositionDt) + this.mPosition;
            this.mPosition = f;
            if (f >= 1.0f) {
                this.mPosition = 1.0f;
            }
    ...
    public ViewTransition(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        ...
        L_0x0086:
            ...
            java.lang.String r3 = TAG     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            ...
            java.lang.String r5 = androidx.constraintlayout.motion.widget.Debug.getLoc()     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            ...
            java.lang.String r2 = TAG     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            ...
            goto L_0x00e2
        L_0x00c8:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = r9.mConstraintDelta     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r2 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r10, r11, r2)     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            goto L_0x00e2
        L_0x00d0:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = androidx.constraintlayout.widget.ConstraintSet.buildDelta(r10, r11)     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            r9.mConstraintDelta = r2     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            goto L_0x00e2
        L_0x00d7:
            ...
            r9.mKeyFrames = r2     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
            goto L_0x00e2
        L_0x00df:
            r9.parseViewTransitionTags(r10, r11)     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0042 }
        L_0x00e2:
    ...
    public void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i, ConstraintSet constraintSet, View... viewArr) {
        if (!this.mDisabled) {
            ...
            motionLayout.transitionToEnd(new ib(23, this, viewArr));
        }
    }
