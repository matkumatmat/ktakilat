        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                if (this.previous[indexOf] != -1) {
                    StringBuilder v = ba.v(l);
                    v.append(this.mCache.mIndexedVariables[this.variables[this.previous[indexOf]]]);
                    str = v.toString();
                } else {
                    str = e.l(l, "none");
                }
                ...
                if (this.next[indexOf] != -1) {
                    StringBuilder v2 = ba.v(l2);
                    v2.append(this.mCache.mIndexedVariables[this.variables[this.next[indexOf]]]);
                    str2 = v2.toString();
                } else {
                    str2 = e.l(l2, "none");
                }
