...
public class Direct {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:100:0x01d8, code lost:
        if (r6.mOwner == r0) goto L_0x01dc;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0056, code lost:
        r9 = r4.mListAnchors[r23].getMargin() + r7.mTarget.getFinalValue();
     */
    ...
    public static boolean solveChain(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r20, androidx.constraintlayout.core.LinearSystem r21, int r22, int r23, androidx.constraintlayout.core.widgets.ChainHead r24, boolean r25, boolean r26, boolean r27) {
        ...
        L_0x017d:
            ...
            int r4 = r0.getWidth()
            int r4 = r4 + r2
            r0.setFinalHorizontal(r2, r4)
            androidx.constraintlayout.core.widgets.analyzer.BasicMeasure$Measurer r4 = r20.getMeasurer()
            r6 = 1
            horizontalSolvingPass(r6, r0, r4, r1)
            int r4 = r0.getWidth()
        L_0x019c:
            int r4 = r4 + r2
            goto L_0x01b3
        L_0x019e:
            ...
            int r4 = r0.getHeight()
            int r4 = r4 + r2
            r0.setFinalVertical(r2, r4)
            androidx.constraintlayout.core.widgets.analyzer.BasicMeasure$Measurer r4 = r20.getMeasurer()
            verticalSolvingPass(r6, r0, r4)
            int r4 = r0.getHeight()
            goto L_0x019c
        L_0x01b3:
            androidx.constraintlayout.core.widgets.ConstraintAnchor[] r2 = r0.mListAnchors
        ...
        L_0x01e4:
            ...
            if (r12 != r0) goto L_0x022c
            if (r22 != 0) goto L_0x020b
            int r0 = r4.getWidth()
            int r0 = r0 + r9
            r4.setFinalHorizontal(r9, r0)
            int r0 = r5.getWidth()
            int r0 = r3 - r0
    ...
    private static void solveHorizontalMatchConstraint(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2, boolean z) {
        ...
        if (finalValue >= margin) {
            ...
            int i5 = margin + ((int) ((horizontalBiasPercent * ((float) ((finalValue - margin) - width))) + 0.5f));
    ...
    private static void solveVerticalMatchConstraint(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2) {
        ...
        if (finalValue >= margin) {
            ...
            int i5 = margin + ((int) ((verticalBiasPercent * ((float) ((finalValue - margin) - height))) + 0.5f));
