...
class RunGroup {
    ...
    public long computeWrapSize(ConstraintWidgetContainer constraintWidgetContainer, int i) {
        ...
        if (contains && contains2) {
            ...
            float f = (float) j;
            long a2 = ((long) ((f * biasPercent) + 0.5f)) + wrapDimension + ((long) e.a(1.0f, biasPercent, f, 0.5f));
            WidgetRun widgetRun5 = this.firstRun;
            return (((long) widgetRun5.start.margin) + a2) - ((long) widgetRun5.end.margin);
        } else if (contains) {
            ...
            return (widgetRun6.getWrapDimension() + ((long) widgetRun6.start.margin)) - ((long) this.firstRun.end.margin);
        }
    }
