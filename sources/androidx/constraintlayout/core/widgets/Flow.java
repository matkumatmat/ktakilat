    ...
    public class WidgetsList {
        ...
        public void add(ConstraintWidget constraintWidget) {
            ...
            if (this.mOrientation == 0) {
                ...
                this.mWidth = access$200 + i + this.mWidth;
                int access$300 = Flow.this.getWidgetHeight(constraintWidget, this.mMax);
                if (this.biggest == null || this.biggestDimension < access$300) {
                    this.biggest = constraintWidget;
                    this.biggestDimension = access$300;
                ...
                this.mHeight = access$3002 + i + this.mHeight;
            ...
            if (i2 == 0) {
                ...
                while (i13 < i10) {
                    ...
                    if (z) {
                        ...
                        i12 = this.mHorizontalGap + widgetWidth + i12;
                ...
                while (i17 < i10) {
                    ...
                    if (z2) {
                        ...
                        i16 = this.mVerticalGap + widgetHeight + i16;
            ...
            if (i2 == 0) {
                ...
                while (i14 < i10) {
                    ...
                    if (z) {
                        ...
                        i13 = i14 > 0 ? this.mHorizontalGap + widgetWidth + i13 : widgetWidth;
                        i12 = 0;
                    }
                    widgetsList.add(constraintWidget);
                    i14++;
