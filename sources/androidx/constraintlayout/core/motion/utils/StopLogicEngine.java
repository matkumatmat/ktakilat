...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        String str2;
        StringBuilder s = e.s(ba.r(e.s(str, " ===== "), this.mType, StringUtils.LF), str);
        if (this.mBackwards) {
            str2 = "backwards";
        } else {
            str2 = "forward ";
        ...
        s.append(f);
        s.append("  stages ");
        String str3 = ba.q(s, StringUtils.LF, this.mNumberOfStages) + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + StringUtils.LF;
        ...
        float f2 = this.mStage1Duration;
        if (f <= f2) {
            return e.m(str3, str, "stage 0\n");
        }
        int i = this.mNumberOfStages;
        if (i == 1) {
            return e.m(str3, str, "end stage 0\n");
        }
        float f3 = f - f2;
        float f4 = this.mStage2Duration;
        if (f3 < f4) {
            return e.m(str3, str, " stage 1\n");
        }
        if (i == 2) {
            return e.m(str3, str, "end stage 1\n");
        }
        if (f3 - f4 < this.mStage3Duration) {
            return e.m(str3, str, " stage 2\n");
        }
        return e.m(str3, str, " end stage 2\n");
    }
