...
public class SpringStopEngine implements StopEngine {
    ...
    private void compute(double d) {
        ...
        while (i < sqrt) {
            ...
            float f3 = this.mMass;
            double d7 = d3;
            double d8 = ((((((-d2) * (((double) f) - d5)) - (((double) f2) * d3)) / ((double) f3)) * d4) / 2.0d) + ((double) f2);
            double d9 = ((((-((((d4 * d8) / 2.0d) + ((double) f)) - d5)) * d6) - (d8 * d7)) / ((double) f3)) * d4;
            float f4 = (float) (((double) f2) + d9);
            this.mV = f4;
            float f5 = (float) ((((d9 / 2.0d) + ((double) f2)) * d4) + ((double) f));
            this.mPos = f5;
    ...
    public boolean isStopped() {
        ...
        if (Math.sqrt((((d2 * d) * d) + ((d3 * d3) * ((double) this.mMass))) / d2) <= ((double) this.mStopThreshold)) {
            return true;
        }
        return false;
    }
