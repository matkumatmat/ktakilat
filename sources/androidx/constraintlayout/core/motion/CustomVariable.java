...
public class CustomVariable {
    ...
    public static int hsvToRgb(float f, float f2, float f3) {
        ...
        float f5 = f4 - ((float) i);
        float f6 = f3 * 255.0f;
        int a2 = (int) e.a(1.0f, f2, f6, 0.5f);
        int i2 = (int) (((1.0f - (f5 * f2)) * f6) + 0.5f);
        int i3 = (int) (((1.0f - ((1.0f - f5) * f2)) * f6) + 0.5f);
        int i4 = (int) (f6 + 0.5f);
        if (i == 0) {
            return ((i4 << 16) + (i3 << 8) + a2) | ViewCompat.MEASURED_STATE_MASK;
        }
        if (i == 1) {
            return ((i2 << 16) + (i4 << 8) + a2) | ViewCompat.MEASURED_STATE_MASK;
        }
        if (i == 2) {
            return ((a2 << 16) + (i4 << 8) + i3) | ViewCompat.MEASURED_STATE_MASK;
        }
        if (i == 3) {
            return ((a2 << 16) + (i2 << 8) + i4) | ViewCompat.MEASURED_STATE_MASK;
        }
        if (i == 4) {
            return ((i3 << 16) + (a2 << 8) + i4) | ViewCompat.MEASURED_STATE_MASK;
        }
        if (i != 5) {
            return 0;
        }
        return ((i4 << 16) + (a2 << 8) + i2) | ViewCompat.MEASURED_STATE_MASK;
    }
    ...
    public String toString() {
        ...
        switch (this.mType) {
            case 900:
                ...
                v.append(this.mIntegerValue);
                return v.toString();
            case TypedValues.Custom.TYPE_FLOAT /*901*/:
                StringBuilder v2 = ba.v(str);
                v2.append(this.mFloatValue);
                return v2.toString();
            case TypedValues.Custom.TYPE_COLOR /*902*/:
                StringBuilder v3 = ba.v(str);
                v3.append(colorString(this.mIntegerValue));
                return v3.toString();
            case TypedValues.Custom.TYPE_STRING /*903*/:
                StringBuilder v4 = ba.v(str);
                v4.append(this.mStringValue);
                return v4.toString();
            case TypedValues.Custom.TYPE_BOOLEAN /*904*/:
                StringBuilder v5 = ba.v(str);
                v5.append(Boolean.valueOf(this.mBooleanValue));
                return v5.toString();
            case TypedValues.Custom.TYPE_DIMENSION /*905*/:
                StringBuilder v6 = ba.v(str);
                v6.append(this.mFloatValue);
                return v6.toString();
            default:
                return e.l(str, "????");
        }
