...
public class ConstraintSet {
    ...
    public class WriteXmlEngine {
        ...
        public WriteXmlEngine(Writer writer2, ConstraintLayout constraintLayout, int i) throws IOException {
            this.writer = writer2;
        ...
        private void writeEnum(String str, int i, String[] strArr, int i2) throws IOException {
            if (i != i2) {
                Writer writer2 = this.writer;
                StringBuilder t = e.t(SPACE, str, "=\"");
                t.append(strArr[i]);
                t.append("\"");
                writer2.write(t.toString());
            }
        }

        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                return ba.r(new StringBuilder("@+id/"), this.idMap.get(Integer.valueOf(i)), "");
            }
            if (i == 0) {
            ...
            switch (i2) {
                case 1:
                    if (i4 == 1) {
                        ...
                        throw new IllegalArgumentException(ba.r(new StringBuilder("Left to "), sideToString(i4), " undefined"));
                    }
                ...
                case 2:
                    if (i4 == 1) {
                        ...
                        throw new IllegalArgumentException(ba.r(new StringBuilder("right to "), sideToString(i4), " undefined"));
                    }
                ...
                default:
                    ...
                    sb.append(" to ");
                    throw new IllegalArgumentException(ba.r(sb, sideToString(i4), " unknown"));
            }
        }
    }
    ...
    public class WriteJsonEngine {
        ...
        public WriteJsonEngine(Writer writer2, ConstraintLayout constraintLayout, int i) throws IOException {
            this.writer = writer2;
            this.layout = constraintLayout;
            this.context = constraintLayout.getContext();
            this.flags = i;
        ...
        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                return ba.r(new StringBuilder("'"), this.idMap.get(Integer.valueOf(i)), "'");
            }
            if (i == 0) {
                return "'parent'";
            }
    ...
    public void load(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        ...
        L_0x0054:
            ...
            goto L_0x01cf
        L_0x005e:
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r0 = r9.mConstraints     // Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0031 }
        ...
        L_0x00e6:
            ...
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r0 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0031 }
