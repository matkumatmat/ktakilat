...
public class ConstraintAttribute {
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (String next : hashMap.keySet()) {
            ...
            try {
                ...
                StringBuilder t = e.t(" Custom Attribute \"", next, "\" not found on ");
                t.append(cls.getName());
                Log.e(TAG, t.toString());
                e2.printStackTrace();
            } catch (InvocationTargetException e3) {
                StringBuilder t2 = e.t(" Custom Attribute \"", next, "\" not found on ");
    ...
    public void applyCustom(View view) {
        ...
        try {
            ...
            StringBuilder t = e.t(" Custom Attribute \"", str2, "\" not found on ");
            t.append(cls.getName());
            Log.e(TAG, t.toString());
            e2.printStackTrace();
        } catch (InvocationTargetException e3) {
            StringBuilder t2 = e.t(" Custom Attribute \"", str2, "\" not found on ");
            t2.append(cls.getName());
            Log.e(TAG, t2.toString());
            e3.printStackTrace();
        }
