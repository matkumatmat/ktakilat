        ...
        switch (i) {
            case 1:
                if (i3 == 1) {
                    ...
                    throw new IllegalArgumentException(ba.r(new StringBuilder("Left to "), sideToString(i3), " undefined"));
                }
            ...
            case 2:
                if (i3 == 1) {
                    ...
                    throw new IllegalArgumentException(ba.r(new StringBuilder("right to "), sideToString(i3), " undefined"));
                }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(ba.r(sb, sideToString(i3), " unknown"));
        }
        return this;
    }
