            ...
            if (constraintWidget2 != null) {
                if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                    ...
                    if (i13 == 1) {
                        ...
                        i = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, constraintWidget.getHorizontalMargin() + i12, -1);
                    } else if (i13 != 4) {
                        i = 0;
                    } else {
                        i = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i12, -2);
                        ...
                        if (i14 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i14 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                            ...
                            if (measure2.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z11 || ((z11 && z12) || (view instanceof Placeholder) || constraintWidget.isResolvedHorizontally())) {
                    ...
                    if (i15 == 1) {
                        ...
                        i2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, constraintWidget.getVerticalMargin() + i11, -1);
                    } else if (i15 != 4) {
                        i2 = 0;
                    } else {
                        i2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i11, -2);
                        ...
                        if (i16 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i16 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                            ...
                            if (measure2.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z9 || ((z9 && z10) || (view instanceof Placeholder) || constraintWidget.isResolvedVertically())) {
