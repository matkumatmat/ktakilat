...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        ...
        ring.setStartTrim(e.a(ring.getStartingEndTrim() - MIN_PROGRESS_ARC, ring.getStartingStartTrim(), f, ring.getStartingStartTrim()));
        ring.setEndTrim(ring.getStartingEndTrim());
        ring.setRotation(e.a((float) (Math.floor((double) (ring.getStartingRotation() / MAX_PROGRESS_ARC)) + 1.0d), ring.getStartingRotation(), f, ring.getStartingRotation()));
    }
    ...
    public void applyTransformation(float f, Ring ring, boolean z) {
        ...
        if (this.mFinishing) {
            ...
            float f5 = (RING_ROTATION * f) + startingRotation;
