...
public final class ViewTreeFullyDrawnReporterOwner {
    ...
    public static final FullyDrawnReporterOwner get(@NotNull View view) {
        ...
        return (FullyDrawnReporterOwner) SequencesKt.f(SequencesKt.k(SequencesKt.i(ViewTreeFullyDrawnReporterOwner$findViewTreeFullyDrawnReporterOwner$1.INSTANCE, view), ViewTreeFullyDrawnReporterOwner$findViewTreeFullyDrawnReporterOwner$2.INSTANCE));
    }
