...
public final class PipHintTrackerKt {
    ...
    public static final Object trackPipAnimationHintView(@NotNull Activity activity, @NotNull View view, @NotNull Continuation<? super Unit> continuation) {
        Object collect = ((ChannelFlow) FlowKt.b(new PipHintTrackerKt$trackPipAnimationHintView$flow$1(view, (Continuation<? super PipHintTrackerKt$trackPipAnimationHintView$flow$1>) null))).collect(new PipHintTrackerKt$trackPipAnimationHintView$2(activity), continuation);
