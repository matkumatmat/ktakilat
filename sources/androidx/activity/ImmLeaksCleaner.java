...
public final class ImmLeaksCleaner implements LifecycleEventObserver {
    ...
    @NotNull
    public static final Lazy<Cleaner> cleaner$delegate = LazyKt.b(ImmLeaksCleaner$Companion$cleaner$2.INSTANCE);
    @NotNull
    ...
    public ImmLeaksCleaner(@NotNull Activity activity2) {
