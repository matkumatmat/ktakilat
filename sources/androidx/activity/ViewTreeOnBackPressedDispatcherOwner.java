...
public final class ViewTreeOnBackPressedDispatcherOwner {
    ...
    public static final OnBackPressedDispatcherOwner get(@NotNull View view) {
        ...
        return (OnBackPressedDispatcherOwner) SequencesKt.f(SequencesKt.k(SequencesKt.i(ViewTreeOnBackPressedDispatcherOwner$findViewTreeOnBackPressedDispatcherOwner$1.INSTANCE, view), ViewTreeOnBackPressedDispatcherOwner$findViewTreeOnBackPressedDispatcherOwner$2.INSTANCE));
    }
