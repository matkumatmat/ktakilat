...
public final class MulticastFileObserver extends FileObserver {
    ...
    public static final class Companion {
        ...
        public final Flow<Unit> observe(@NotNull File file) {
            ...
            return FlowKt.d(new MulticastFileObserver$Companion$observe$1(file, (Continuation<? super MulticastFileObserver$Companion$observe$1>) null));
        }
        ...
        public final DisposableHandle observe(File file, Function1<? super String, Unit> function1) {
            ...
            return new ca(1, path, function1);
        }
    }
