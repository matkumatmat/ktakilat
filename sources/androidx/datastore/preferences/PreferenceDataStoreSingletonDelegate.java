        ...
        synchronized (this.lock) {
            try {
                if (this.INSTANCE == null) {
                    ...
                    this.INSTANCE = preferenceDataStoreFactory.create(replaceFileCorruptionHandler, (List<? extends DataMigration<Preferences>>) (List) function1.invoke(applicationContext), this.scope, (Function0<? extends File>) new PreferenceDataStoreSingletonDelegate$getValue$1$1(applicationContext, this));
                }
