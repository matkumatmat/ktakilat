...
public final class CaptureRequestParameterCompat {
    ...
    public static final void setSettingsOverrideZoom(@NotNull Camera2ImplConfig.Builder builder, @NotNull Config.OptionPriority optionPriority) {
        Intrinsics.checkNotNullParameter(builder, "options");
        Intrinsics.checkNotNullParameter(optionPriority, "priority");
