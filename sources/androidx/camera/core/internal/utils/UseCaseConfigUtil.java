...
public final class UseCaseConfigUtil {
    ...
    public static void updateTargetRotationAndRelatedConfigs(@NonNull UseCaseConfig.Builder<?, ?, ?> builder, int i) {
        ...
        if (targetRotation != -1 && i != -1 && targetRotation != i) {
            if (Math.abs(CameraOrientationUtil.surfaceRotationToDegrees(i) - CameraOrientationUtil.surfaceRotationToDegrees(targetRotation)) % BitmapUtils.ROTATE180 == 90 && (targetResolution = imageOutputConfig.getTargetResolution((Size) null)) != null) {
