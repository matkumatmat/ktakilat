...
public final class ImageCaptureExtKt$takePicture$4$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ Ref.ObjectRef<DelegatingImageSavedCallback> $delegatingCallback;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ImageCaptureExtKt$takePicture$4$2(Ref.ObjectRef<DelegatingImageSavedCallback> objectRef) {
        super(1);
