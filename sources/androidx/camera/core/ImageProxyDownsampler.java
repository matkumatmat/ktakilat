        ...
        if (imageProxy.getFormat() != 35) {
            ...
            for (int i9 = 3; i8 < i9; i9 = 3) {
                ...
                if (ordinal == 0) {
                    ...
                    int i11 = rowStride;
                    byte[] bArr3 = bArr2;
                    resizeAveraging(buffer, i10, pixelStride, i11, iArr2[i8], bArr3, iArr3[i8], iArr4[i8]);
                    bArr = bArr3;
                }
            ...
            try {
                ...
                while (i13 < i10) {
                    ...
                    for (int i17 = 0; i17 < i9; i17++) {
                        int i18 = iArr[i17];
                        bArr[i16 + i17] = (byte) ((((((bArr2[i18] & UnsignedBytes.MAX_VALUE) + (bArr2[i18 + i2] & UnsignedBytes.MAX_VALUE)) + (bArr3[i18] & UnsignedBytes.MAX_VALUE)) + (bArr3[i18 + i2] & UnsignedBytes.MAX_VALUE)) / 4) & 255);
                    }
                    i13++;
                    i11 = 0;
                }
