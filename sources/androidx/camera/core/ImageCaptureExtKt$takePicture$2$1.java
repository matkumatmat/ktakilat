...
public final class ImageCaptureExtKt$takePicture$2$1 extends ImageCapture.OnImageCapturedCallback {
    ...
    public ImageCaptureExtKt$takePicture$2$1(Function0<Unit> function0, Function1<? super Integer, Unit> function1, Function1<? super Bitmap, Unit> function12, Ref.ObjectRef<DelegatingImageCapturedCallback> objectRef, CancellableContinuation<? super ImageProxy> cancellableContinuation) {
    ...
    public void onCaptureSuccess(@NotNull ImageProxy imageProxy) {
        ...
        if (t != null) {
            ((DelegatingImageCapturedCallback) t).dispose();
            this.$continuation.resumeWith(Result.m16constructorimpl(imageProxy));
            return;
        }
    ...
    public void onError(@NotNull ImageCaptureException imageCaptureException) {
        ...
        if (t != null) {
            ((DelegatingImageCapturedCallback) t).dispose();
            CancellableContinuation<ImageProxy> cancellableContinuation = this.$continuation;
