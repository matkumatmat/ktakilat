...
final class AutoValue_Packet<T> extends Packet<T> {
    ...
    public AutoValue_Packet(T t, @Nullable Exif exif2, int i, Size size2, Rect rect, int i2, Matrix matrix, CameraCaptureResult cameraCaptureResult2) {
        if (t != null) {
            this.data = t;
            this.exif = exif2;
            this.format = i;
    ...
    public int hashCode() {
        ...
        return ((((((((((((hashCode ^ i) * 1000003) ^ this.format) * 1000003) ^ this.size.hashCode()) * 1000003) ^ this.cropRect.hashCode()) * 1000003) ^ this.rotationDegrees) * 1000003) ^ this.sensorToBufferTransform.hashCode()) * 1000003) ^ this.cameraCaptureResult.hashCode();
    }
