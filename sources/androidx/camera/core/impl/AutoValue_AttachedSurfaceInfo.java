...
final class AutoValue_AttachedSurfaceInfo extends AttachedSurfaceInfo {
    ...
    public AutoValue_AttachedSurfaceInfo(SurfaceConfig surfaceConfig2, int i, Size size2, DynamicRange dynamicRange2, List<UseCaseConfigFactory.CaptureType> list, @Nullable Config config, @Nullable Range<Integer> range) {
