...
public class QuirkSettingsLoader implements Function<Context, QuirkSettings> {
    ...
    public QuirkSettings apply(@NonNull Context context) {
        try {
            Bundle bundle = context.getPackageManager().getServiceInfo(new ComponentName(context, MetadataHolderService.class), FaceEnvironment.VALUE_CROP_HEIGHT).metaData;
            if (bundle != null) {
