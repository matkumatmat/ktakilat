...
public final class ProcessCameraProvider$getOrCreateCameraXInstance$1$1$1$future$1 extends Lambda implements Function1<Void, ListenableFuture<Void>> {
    ...
    @NotNull
    public final ListenableFuture<Void> invoke(@Nullable Void voidR) {
