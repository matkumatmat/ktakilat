...
public final class ZoomGestureDetector {
    ...
    public static abstract class ZoomEvent {
        ...
        public static final class Begin extends ZoomEvent {
            public Begin(@IntRange(from = 0) long j, @Px @IntRange(from = 0) int i, @Px @IntRange(from = 0) int i2) {
        ...
        public static final class End extends ZoomEvent {
            ...
            public End(@IntRange(from = 0) long j, @Px @IntRange(from = 0) int i, @Px @IntRange(from = 0) int i2, @FloatRange(from = 0.0d, fromInclusive = false) float f) {
                super(j, i, i2, (DefaultConstructorMarker) null);
        ...
        public static final class Move extends ZoomEvent {
            ...
            public Move(@IntRange(from = 0) long j, @Px @IntRange(from = 0) int i, @Px @IntRange(from = 0) int i2, @FloatRange(from = 0.0d, fromInclusive = false) float f) {
                super(j, i, i2, (DefaultConstructorMarker) null);
                this.incrementalScaleFactor = f;
            }
        ...
        private ZoomEvent(@IntRange(from = 0) long j, @Px @IntRange(from = 0) int i, @Px @IntRange(from = 0) int i2) {
            this.eventTime = j;
            this.focusX = i;
            this.focusY = i2;
        }
    ...
    @JvmOverloads
    public ZoomGestureDetector(@NotNull Context context2, @Px int i, @NotNull OnZoomGestureListener onZoomGestureListener) {
    ...
    public final boolean onTouchEvent(@NotNull MotionEvent motionEvent) {
        ...
        if (actionMasked == 0 || z3) {
            if (this.isInProgress) {
                OnZoomGestureListener onZoomGestureListener = this.listener;
                ZoomEvent.End end = r12;
                ZoomEvent.End end2 = new ZoomEvent.End(this.eventTime, this.focusX, this.focusY, getIncrementalScaleFactor());
                onZoomGestureListener.onZoomEvent(end);
        ...
        if (inAnchoredZoomMode()) {
            ...
            for (int i4 = 0; i4 < pointerCount; i4++) {
                if (i != i4) {
                    f5 += motionEvent2.getX(i4);
                    f6 += motionEvent2.getY(i4);
                }
            }
            float f7 = (float) i2;
            float f8 = f5 / f7;
        ...
        for (int i5 = 0; i5 < pointerCount; i5++) {
            if (i != i5) {
                float abs = Math.abs(motionEvent2.getX(i5) - f2) + f4;
                f9 = Math.abs(motionEvent2.getY(i5) - f) + f9;
                f4 = abs;
            }
        }
        float f10 = (float) i2;
        ...
        if (inAnchoredZoomMode()) {
            ...
            f3 = (float) Math.hypot((double) f12, (double) f13);
        }
        boolean z8 = this.isInProgress;
        if (!Float.isNaN(f2)) {
            this.focusX = Math.round(f2);
            if (!Float.isNaN(f)) {
                ...
                if (z4) {
                    this.currentSpanX = f12;
                    this.previousSpanX = f12;
                    this.currentSpanY = f13;
                    this.previousSpanY = f13;
                    this.currentSpan = f3;
                ...
                if (!this.isInProgress && f3 >= ((float) i3) && (z8 || Math.abs(f3 - this.initialSpan) > ((float) this.spanSlop))) {
                    this.currentSpanX = f12;
                    this.previousSpanX = f12;
                    this.currentSpanY = f13;
                    this.previousSpanY = f13;
    ...
    @SuppressLint({"ExecutorRegistration"})
    @JvmOverloads
    public ZoomGestureDetector(@NotNull Context context2, @NotNull OnZoomGestureListener onZoomGestureListener) {
    ...
    @SuppressLint({"ExecutorRegistration"})
    @JvmOverloads
    public ZoomGestureDetector(@NotNull Context context2, @Px int i, @Px int i2, @NotNull OnZoomGestureListener onZoomGestureListener) {
        Intrinsics.checkNotNullParameter(context2, PlaceFields.CONTEXT);
        Intrinsics.checkNotNullParameter(onZoomGestureListener, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
