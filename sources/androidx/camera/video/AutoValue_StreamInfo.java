...
final class AutoValue_StreamInfo extends StreamInfo {
    ...
    public AutoValue_StreamInfo(int i, StreamInfo.StreamState streamState2, @Nullable SurfaceRequest.TransformationInfo transformationInfo) {
        this.id = i;
