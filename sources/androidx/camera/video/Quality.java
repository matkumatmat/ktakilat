...
public class Quality {
    ...
    static {
        ConstantQuality of = ConstantQuality.of(4, "SD", Collections.unmodifiableList(Arrays.asList(new Size[]{new Size(720, FaceEnvironment.VALUE_CROP_WIDTH), new Size(FaceEnvironment.VALUE_CROP_HEIGHT, FaceEnvironment.VALUE_CROP_WIDTH)})));
        SD = of;
