...
public class QualityExploredEncoderProfilesProvider implements EncoderProfilesProvider {
    ...
    private androidx.camera.core.impl.EncoderProfilesProxy exploreProfiles(@androidx.annotation.NonNull androidx.camera.video.Quality.ConstantQuality r12) {
        /*
            r11 = this;
    ...
    private static EncoderProfilesProxy mergeEncoderProfiles(@Nullable EncoderProfilesProxy encoderProfilesProxy, @Nullable EncoderProfilesProxy encoderProfilesProxy2) {
        int i;
        int i2;
        List<EncoderProfilesProxy.AudioProfileProxy> list;
        ...
        if (encoderProfilesProxy != null) {
            list = encoderProfilesProxy.getAudioProfiles();
        } else {
            list = encoderProfilesProxy2.getAudioProfiles();
        }
        ...
        return EncoderProfilesProxy.ImmutableEncoderProfilesProxy.create(i, i2, list, arrayList);
    }
