...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    ...
                    throw new IllegalStateException(ba.n(this.mRecyclerView, sb));
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(ba.n(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt != null) {
                ...
                if (findPositionOffset < 0 || findPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                    StringBuilder r = e.r(i, "Inconsistency detected. Invalid item position ", findPositionOffset, "(offset:", ").state:");
                    r.append(RecyclerView.this.mState.getItemCount());
                    throw new IndexOutOfBoundsException(ba.n(RecyclerView.this, r));
                }
            ...
            throw new IllegalArgumentException(ba.n(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
        }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            if (i < 0 || i >= RecyclerView.this.mState.getItemCount()) {
                StringBuilder t = ba.t(i, "invalid position ", ". State item count is ");
                t.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(ba.n(RecyclerView.this, t));
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            throw new IllegalStateException(ba.n(RecyclerView.this, sb));
        }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                sb.append(z3);
                throw new IllegalArgumentException(ba.n(RecyclerView.this, sb));
            } else if (viewHolder.isTmpDetached()) {
                StringBuilder sb2 = new StringBuilder("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
                sb2.append(viewHolder);
                throw new IllegalArgumentException(ba.n(RecyclerView.this, sb2));
                ...
                throw new IllegalArgumentException(ba.n(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(ba.n(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        }
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x00b1:
                ...
                java.lang.String r1 = defpackage.ba.n(r2, r1)
                r0.<init>(r1)
                throw r0
            L_0x00c4:
                java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
            ...
            L_0x0138:
                ...
                java.lang.StringBuilder r1 = defpackage.e.r(r3, r1, r5, r2, r4)
                androidx.recyclerview.widget.RecyclerView r2 = androidx.recyclerview.widget.RecyclerView.this
            ...
            L_0x0205:
                ...
                java.lang.StringBuilder r1 = defpackage.e.r(r3, r1, r3, r2, r4)
                androidx.recyclerview.widget.RecyclerView r2 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$State r2 = r2.mState
                int r2 = r2.getItemCount()
                r1.append(r2)
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            ...
            if (i < 0 || i >= RecyclerView.this.mAdapter.getItemCount()) {
                ...
                throw new IndexOutOfBoundsException(ba.n(RecyclerView.this, sb));
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(ba.n(this, sb));
                }
                StringBuilder sb2 = new StringBuilder("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:");
                sb2.append(childViewHolderInt);
                sb2.append(" \n View Holder 2:");
                sb2.append(viewHolder);
                throw new IllegalStateException(ba.n(this, sb2));
            }
        }
                    ...
                    if (i != 33) {
                        if (i != 66) {
                            if (i != 130) {
                                ...
                                sb.append(i);
                                throw new IllegalArgumentException(ba.n(this, sb));
                            } else if (c > 0) {
                                return true;
                            } else {
                                return false;
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(ba.n(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(ba.n(this, ba.v(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(ba.n(this, new StringBuilder("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(ba.n(this, new StringBuilder(""))));
        }
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(ba.n(this, new StringBuilder("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(ba.n(this, new StringBuilder("Trying to set fast scroller without both required drawables.")));
        }
        ...
        if (layoutManager != this.mLayout) {
            ...
            if (layoutManager != null) {
                if (layoutManager.mRecyclerView == null) {
                    ...
                    throw new IllegalArgumentException(ba.n(layoutManager.mRecyclerView, sb));
                }
            }
            this.mRecycler.updateViewCacheSize();
            requestLayout();
