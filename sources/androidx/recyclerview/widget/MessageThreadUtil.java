...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public static class MessageQueue {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:10:0x0015 A[Catch:{ all -> 0x0011 }] */
        ...
        public synchronized void removeMessages(int r5) {
            /*
                ...
                monitor-enter(r4)
            L_0x0001:
                androidx.recyclerview.widget.MessageThreadUtil$SyncQueueItem r0 = r4.mRoot     // Catch:{ all -> 0x0011 }
                if (r0 == 0) goto L_0x0013
                int r1 = r0.what     // Catch:{ all -> 0x0011 }
                if (r1 != r5) goto L_0x0013
                androidx.recyclerview.widget.MessageThreadUtil$SyncQueueItem r1 = r0.next     // Catch:{ all -> 0x0011 }
                r4.mRoot = r1     // Catch:{ all -> 0x0011 }
                r0.recycle()     // Catch:{ all -> 0x0011 }
                goto L_0x0001
            L_0x0011:
                r5 = move-exception
                goto L_0x002a
            ...
            L_0x0017:
                ...
                androidx.recyclerview.widget.MessageThreadUtil$SyncQueueItem r2 = r1.next     // Catch:{ all -> 0x0011 }
                int r3 = r1.what     // Catch:{ all -> 0x0011 }
                if (r3 != r5) goto L_0x0025
                r0.next = r2     // Catch:{ all -> 0x0011 }
                r1.recycle()     // Catch:{ all -> 0x0011 }
                goto L_0x0026
            L_0x0025:
                r0 = r1
            L_0x0026:
