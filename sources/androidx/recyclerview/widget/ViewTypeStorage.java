    ...
    public static class IsolatedViewTypeStorage implements ViewTypeStorage {
        ...
        public class WrapperViewTypeLookup implements ViewTypeLookup {
            ...
            public int globalToLocal(int i) {
                ...
                StringBuilder t = ba.t(i, "requested global type ", " does not belong to the adapter:");
                t.append(this.mWrapper.adapter);
        ...
        public NestedAdapterWrapper getWrapperForGlobalType(int i) {
            ...
            throw new IllegalArgumentException(ba.k(i, "Cannot find the wrapper for global view type "));
        }
