...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        while (i16 < this.mSpanCount && layoutState2.hasMore(state2) && i15 > 0) {
            ...
            if (spanSize <= this.mSpanCount) {
                ...
                throw new IllegalArgumentException(ba.q(e.r(i17, "Item at position ", spanSize, " requires ", " spans but GridLayoutManager has only "), " spans.", this.mSpanCount));
            }
        }
        if (i16 == 0) {
    ...
    public void setSpanCount(int i) {
        if (i != this.mSpanCount) {
            ...
            throw new IllegalArgumentException(ba.k(i, "Span count should be at least 1. Provided "));
        }
    }
