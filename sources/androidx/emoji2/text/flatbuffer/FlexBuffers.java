...
public class FlexBuffers {
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            int i2 = this.end;
            return new Reference(this.bb, (i * this.byteWidth) + i2, this.byteWidth, 1, this.elemType);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            int byteToUnsignedInt = Unsigned.byteToUnsignedInt(this.bb.get((int) ((size * ((long) this.byteWidth)) + ((long) this.end) + j)));
            int i2 = this.end;
            return new Reference(this.bb, (i * this.byteWidth) + i2, this.byteWidth, byteToUnsignedInt);
        }
