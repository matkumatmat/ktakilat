...
public final class ViewTreeSavedStateRegistryOwner {
    ...
    public static final SavedStateRegistryOwner get(@NotNull View view) {
        ...
        return (SavedStateRegistryOwner) SequencesKt.f(SequencesKt.k(SequencesKt.i(ViewTreeSavedStateRegistryOwner$findViewTreeSavedStateRegistryOwner$1.INSTANCE, view), ViewTreeSavedStateRegistryOwner$findViewTreeSavedStateRegistryOwner$2.INSTANCE));
    }
