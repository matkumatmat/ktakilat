...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i) {
        if (i == 0) {
            ...
            throw new AndroidRuntimeException(ba.k(i, "Invalid parameter for TransitionSet ordering: "));
        }
        return this;
    }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder s = e.s(transition, StringUtils.LF);
            s.append(this.mTransitions.get(i).toString(str + "  "));
