...
public abstract class Transition implements Cloneable {
    ...
    private static int[] parseMatchOrder(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if ("id".equalsIgnoreCase(trim)) {
                ...
                throw new InflateException(ba.o("Unknown match type in matchOrder: '", trim, "'"));
            }
            i++;
        }
        return iArr;
    ...
    public void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        if (sparseIntArray.size() != 0) {
            for (int i5 = 0; i5 < sparseIntArray.size(); i5++) {
                ...
                animator4.setStartDelay(animator4.getStartDelay() + (((long) sparseIntArray.valueAt(i5)) - j));
            }
        }
    }
    ...
    public String toString(String str) {
        ...
        if (this.mDuration != -1) {
            sb = ba.p(e.s(sb, "dur("), this.mDuration, ") ");
        }
        if (this.mStartDelay != -1) {
            sb = ba.p(e.s(sb, "dly("), this.mStartDelay, ") ");
        }
        if (this.mInterpolator != null) {
            StringBuilder s = e.s(sb, "interp(");
            s.append(this.mInterpolator);
            s.append(") ");
            sb = s.toString();
        }
        ...
        String l = e.l(sb, "tgts(");
        if (this.mTargetIds.size() > 0) {
            for (int i = 0; i < this.mTargetIds.size(); i++) {
                if (i > 0) {
                    l = e.l(l, ", ");
                }
                StringBuilder v2 = ba.v(l);
                v2.append(this.mTargetIds.get(i));
                l = v2.toString();
            }
        }
        if (this.mTargets.size() > 0) {
            for (int i2 = 0; i2 < this.mTargets.size(); i2++) {
                ...
                StringBuilder v3 = ba.v(l);
                v3.append(this.mTargets.get(i2));
                l = v3.toString();
            }
        }
        return e.l(l, ")");
