...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    static {
        /*
            ...
            log = r2
            androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper r2 = new androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper     // Catch:{ all -> 0x004a }
            java.lang.Class<java.lang.Thread> r3 = java.lang.Thread.class
            java.lang.String r4 = "thread"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r4 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r0, r3, r4)     // Catch:{ all -> 0x004a }
            java.lang.String r3 = "next"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r0, r0, r3)     // Catch:{ all -> 0x004a }
            java.lang.String r3 = "waiters"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r6 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r1, r0, r3)     // Catch:{ all -> 0x004a }
            ...
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r7 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r1, r0, r3)     // Catch:{ all -> 0x004a }
            java.lang.Class<java.lang.Object> r0 = java.lang.Object.class
            java.lang.String r3 = "value"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r8 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r1, r0, r3)     // Catch:{ all -> 0x004a }
            r3 = r2
            r3.<init>(r4, r5, r6, r7, r8)     // Catch:{ all -> 0x004a }
            r0 = 0
            goto L_0x0050
        L_0x004a:
            r0 = move-exception
    ...
    public final V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            if (nanos + 1000 < 0) {
                ...
                if (i > 0) {
                    String str2 = l + convert + StringUtils.SPACE + lowerCase;
                    if (z) {
                        str2 = e.l(str2, ",");
                    }
                    l = e.l(str2, StringUtils.SPACE);
                }
                if (z) {
            ...
            if (isDone()) {
                throw new TimeoutException(e.l(str, " but future completed as timeout expired"));
            }
            throw new TimeoutException(e.m(str, " for ", abstractResolvableFuture));
        }
        throw new InterruptedException();
    }
    ...
    public String pendingToString() {
        ...
        if (obj instanceof SetFuture) {
            return ba.r(new StringBuilder("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
