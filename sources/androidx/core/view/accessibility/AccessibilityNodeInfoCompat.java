...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public boolean perform(android.view.View r4, android.os.Bundle r5) {
            /*
                r3 = this;
                androidx.core.view.accessibility.AccessibilityViewCommand r0 = r3.mCommand
                if (r0 == 0) goto L_0x0039
                java.lang.Class<? extends androidx.core.view.accessibility.AccessibilityViewCommand$CommandArguments> r0 = r3.mViewCommandArgumentClass
                r1 = 0
                ...
                r0.setBundle(r5)     // Catch:{ Exception -> 0x0018 }
                r1 = r0
                goto L_0x0032
            L_0x0018:
                r5 = move-exception
            ...
            L_0x0032:
                androidx.core.view.accessibility.AccessibilityViewCommand r5 = r3.mCommand
                boolean r4 = r5.perform(r4, r1)
                return r4
            L_0x0039:
                r4 = 0
                return r4
    ...
    public TouchDelegateInfoCompat getTouchDelegateInfo() {
        AccessibilityNodeInfo.TouchDelegateInfo g;
        if (Build.VERSION.SDK_INT < 29 || (g = this.mInfo.getTouchDelegateInfo()) == null) {
            return null;
        }
        return new TouchDelegateInfoCompat(g);
    }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public AccessibilityNodeInfoCompat getTargetForRegion(@NonNull Region region) {
            ...
            if (Build.VERSION.SDK_INT < 29 || (i = this.mInfo.getTargetForRegion(region)) == null) {
                return null;
            }
            return AccessibilityNodeInfoCompat.wrap(i);
        }
