...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                throw new IllegalArgumentException(e.B("Failed to find configured root that contains ", canonicalPath));
            } catch (IOException unused) {
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i) {
        ...
        throw new IllegalArgumentException(e.B("Couldn't find meta-data for provider with authority ", str));
    }
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(e.B("Invalid mode: ", str));
    }
