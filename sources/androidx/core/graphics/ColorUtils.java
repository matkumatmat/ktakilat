...
public final class ColorUtils {
    ...
    public static void RGBToXYZ(@IntRange(from = 0, to = 255) int i, @IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, @NonNull double[] dArr) {
        ...
        if (dArr2.length == 3) {
            ...
            dArr2[0] = ((0.1805d * d) + (0.3576d * pow2) + (0.4124d * pow)) * XYZ_WHITE_REFERENCE_Y;
            dArr2[1] = ((0.0722d * d) + (0.7152d * pow2) + (0.2126d * pow)) * XYZ_WHITE_REFERENCE_Y;
            double d5 = d * 0.9505d;
            dArr2[2] = (d5 + (pow2 * 0.1192d) + (pow * 0.0193d)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
    ...
    private static int compositeComponent(int i, int i2, int i3, int i4, int i5) {
        ...
        return e.A(255, i2, i3 * i4, (i * 255) * i2) / (i5 * 255);
    }
