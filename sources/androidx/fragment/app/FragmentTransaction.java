...
public abstract class FragmentTransaction {
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    throw new IllegalArgumentException(ba.o("A shared element with the target name '", str, "' has already been added to the transaction."));
                } else if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(ba.o("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        if (str != null) {
            ...
            if (str3 == null || str.equals(str3)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(e.q(sb, fragment.mTag, " now ", str));
            }
        }
        if (i != 0) {
            if (i != -1) {
    ...
    @NonNull
    public FragmentTransaction runOnCommitInternal(boolean z, @NonNull Runnable runnable) {
        if (!z) {
