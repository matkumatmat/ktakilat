...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull Function<Void, ActivityResultRegistry> function, @NonNull ActivityResultCallback<O> activityResultCallback) {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
    }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(e.l(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        throw new IllegalStateException(e.k("Can't access the Fragment View's LifecycleOwner for ", this, " when getView() is null i.e., before onCreateView() or after onDestroyView()"));
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onActivityCreated()"));
    }
    ...
    public void performAttach() {
        ...
        throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onAttach()"));
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onCreate()"));
    }
    ...
    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new x0(this, 21));
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onDestroyView()"));
    }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onDetach()"));
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onResume()"));
    }
    ...
    public void performStart() {
        ...
        throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onStart()"));
    }
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i) {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " not attached to Activity"));
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(e.k("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(e.k("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(e.k("Fragment ", this, " did not call through to super.onViewStateRestored()"));
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i) {
        ...
        throw new IllegalArgumentException(e.k("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
    }
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(ba.o("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (IllegalAccessException e2) {
            throw new InstantiationException(ba.o("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e2);
        } catch (NoSuchMethodException e3) {
            throw new InstantiationException(ba.o("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e3);
        } catch (InvocationTargetException e4) {
            throw new InstantiationException(ba.o("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e4);
        }
    }
