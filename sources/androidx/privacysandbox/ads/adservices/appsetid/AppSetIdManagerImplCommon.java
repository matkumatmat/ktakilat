...
public class AppSetIdManagerImplCommon extends AppSetIdManager {
    ...
    public AppSetIdManagerImplCommon(@NotNull AppSetIdManager appSetIdManager) {
    ...
    private final AppSetId convertResponse(AppSetId appSetId) {
        if (appSetId.getScope() == 1) {
            String v = appSetId.getId();
            Intrinsics.checkNotNullExpressionValue(v, "response.id");
            return new AppSetId(v, 1);
        }
        String v2 = appSetId.getId();
        Intrinsics.checkNotNullExpressionValue(v2, "response.id");
        return new AppSetId(v2, 2);
    }
    ...
    public static java.lang.Object getAppSetId$suspendImpl(androidx.privacysandbox.ads.adservices.appsetid.AppSetIdManagerImplCommon r4, kotlin.coroutines.Continuation<? super androidx.privacysandbox.ads.adservices.appsetid.AppSetId> r5) {
        /*
        ...
        L_0x0033:
            ...
            return r1
        L_0x0041:
            android.adservices.appsetid.AppSetId r5 = defpackage.u.c(r5)
    ...
    public final Object getAppSetIdAsyncInternal(Continuation<? super AppSetId> continuation) {
        ...
        this.mAppSetIdManager.getAppSetId(new t(0), OutcomeReceiverKt.asOutcomeReceiver(cancellableContinuationImpl));
