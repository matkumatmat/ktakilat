...
public final class ProtectedSignalsManagerFutures$JavaImpl$updateSignalsAsync$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Intrinsics.c(access$getMProtectedSignalsManager$p);
            UpdateSignalsRequest updateSignalsRequest = this.$request;
            this.label = 1;
            if (access$getMProtectedSignalsManager$p.updateSignals(updateSignalsRequest, this) == coroutineSingletons) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ProtectedSignalsManagerFutures$JavaImpl$updateSignalsAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f696a);
    }
}
