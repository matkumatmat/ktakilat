...
public final class DeletionRequest {
    ...
    public static final class Builder {
        ...
        public Builder(int i, int i2) {
            ...
            Instant p = Instant.MIN;
            Intrinsics.checkNotNullExpressionValue(p, "MIN");
            this.start = p;
            Instant w = Instant.MAX;
            Intrinsics.checkNotNullExpressionValue(w, "MAX");
            this.end = w;
    ...
    public final android.adservices.measurement.DeletionRequest convertToAdServices$ads_adservices_release() {
        android.adservices.measurement.DeletionRequest s = w4.o().setDeletionMode(this.deletionMode).setMatchBehavior(this.matchBehavior).setStart(this.start).setEnd(this.end).setDomainUris(this.domainUris).setOriginUris(this.originUris).build();
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.deletionMode != deletionRequest.deletionMode || !new HashSet(this.domainUris).equals(new HashSet(deletionRequest.domainUris)) || !new HashSet(this.originUris).equals(new HashSet(deletionRequest.originUris)) || !Intrinsics.a(this.start, deletionRequest.start) || !Intrinsics.a(this.end, deletionRequest.end) || this.matchBehavior != deletionRequest.matchBehavior) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        int hashCode = this.domainUris.hashCode();
        int hashCode2 = this.originUris.hashCode();
        int d = this.start.hashCode();
        return ((this.end.hashCode() + ((d + ((hashCode2 + ((hashCode + (this.deletionMode * 31)) * 31)) * 31)) * 31)) * 31) + this.matchBehavior;
    }
    ...
    public String toString() {
        ...
        StringBuilder u = e.u("DeletionRequest { DeletionMode=", str, ", MatchBehavior=", str2, ", Start=");
        u.append(this.start);
        u.append(", End=");
        u.append(this.end);
        u.append(", DomainUris=");
        u.append(this.domainUris);
        u.append(", OriginUris=");
        u.append(this.originUris);
        u.append(" }");
        return u.toString();
    }
    ...
    public DeletionRequest(int r8, int r9, java.time.Instant r10, java.time.Instant r11, java.util.List r12, java.util.List r13, int r14, kotlin.jvm.internal.DefaultConstructorMarker r15) {
        /*
            r7 = this;
            r15 = r14 & 4
