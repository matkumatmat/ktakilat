...
public final class UpdateAdCounterHistogramRequest {
    ...
    public final android.adservices.adselection.UpdateAdCounterHistogramRequest convertToAdServices$ads_adservices_release() {
        zd.d();
        android.adservices.adselection.UpdateAdCounterHistogramRequest c = zd.b(this.adSelectionId, this.adEventType, this.callerAdTech.convertToAdServices$ads_adservices_release()).build();
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.adSelectionId == updateAdCounterHistogramRequest.adSelectionId && this.adEventType == updateAdCounterHistogramRequest.adEventType && Intrinsics.a(this.callerAdTech, updateAdCounterHistogramRequest.callerAdTech)) {
            return true;
        }
        return false;
    }
