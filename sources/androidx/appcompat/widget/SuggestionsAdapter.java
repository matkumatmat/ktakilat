...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder t = ba.t(iconResource, "Invalid icon resource ", " for ");
            t.append(componentName.flattenToShortString());
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r8) {
        /*
            ...
            android.graphics.drawable.Drawable r8 = r7.getDrawableFromResourceUri(r8)     // Catch:{ NotFoundException -> 0x001c }
            return r8
        L_0x001a:
            r1 = move-exception
            goto L_0x007b
        L_0x001c:
            java.io.FileNotFoundException r1 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x001a }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x001a }
            r2.<init>(r3)     // Catch:{ FileNotFoundException -> 0x001a }
            r2.append(r8)     // Catch:{ FileNotFoundException -> 0x001a }
            java.lang.String r2 = r2.toString()     // Catch:{ FileNotFoundException -> 0x001a }
            r1.<init>(r2)     // Catch:{ FileNotFoundException -> 0x001a }
            throw r1     // Catch:{ FileNotFoundException -> 0x001a }
        L_0x002e:
            android.content.Context r3 = r7.mProviderContext     // Catch:{ FileNotFoundException -> 0x001a }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ FileNotFoundException -> 0x001a }
            java.io.InputStream r3 = r3.openInputStream(r8)     // Catch:{ FileNotFoundException -> 0x001a }
        ...
        L_0x0042:
            r3 = move-exception
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x001a }
            r5.<init>(r1)     // Catch:{ FileNotFoundException -> 0x001a }
            r5.append(r8)     // Catch:{ FileNotFoundException -> 0x001a }
            java.lang.String r1 = r5.toString()     // Catch:{ FileNotFoundException -> 0x001a }
            android.util.Log.e(r0, r1, r3)     // Catch:{ FileNotFoundException -> 0x001a }
        L_0x0052:
            return r2
        L_0x0053:
            r2 = move-exception
        ...
        L_0x0069:
            ...
            r3.<init>(r2)     // Catch:{ FileNotFoundException -> 0x001a }
            r3.append(r8)     // Catch:{ FileNotFoundException -> 0x001a }
            java.lang.String r2 = r3.toString()     // Catch:{ FileNotFoundException -> 0x001a }
            r1.<init>(r2)     // Catch:{ FileNotFoundException -> 0x001a }
            throw r1     // Catch:{ FileNotFoundException -> 0x001a }
        L_0x007b:
