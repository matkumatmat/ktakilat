...
public class VideoUploader {
    ...
    public static class StartUploadWorkItem extends UploadWorkItemBase {
        ...
        public Bundle getParameters() {
            Bundle c = e.c(VideoUploader.PARAM_UPLOAD_PHASE, VideoUploader.PARAM_VALUE_UPLOAD_START_PHASE);
            c.putLong(VideoUploader.PARAM_FILE_SIZE, this.uploadContext.videoSize);
            return c;
        }
    ...
    public static class TransferChunkWorkItem extends UploadWorkItemBase {
        ...
        public Bundle getParameters() throws IOException {
            Bundle c = e.c(VideoUploader.PARAM_UPLOAD_PHASE, VideoUploader.PARAM_VALUE_UPLOAD_TRANSFER_PHASE);
            c.putString(VideoUploader.PARAM_SESSION_ID, this.uploadContext.sessionId);
            c.putString(VideoUploader.PARAM_START_OFFSET, this.chunkStart);
            byte[] access$600 = VideoUploader.getChunk(this.uploadContext, this.chunkStart, this.chunkEnd);
            if (access$600 != null) {
                c.putByteArray(VideoUploader.PARAM_VIDEO_FILE_CHUNK, access$600);
                return c;
            }
    ...
    public static abstract class UploadWorkItemBase implements Runnable {
        ...
        public UploadWorkItemBase(UploadContext uploadContext2, int i) {
        ...
        public void executeGraphRequestSynchronously(Bundle bundle) {
            ...
            AccessToken accessToken = uploadContext2.accessToken;
            Locale locale = Locale.ROOT;
            GraphResponse executeAndWait = new GraphRequest(accessToken, e.l(uploadContext2.graphNode, "/videos"), bundle, HttpMethod.POST, (GraphRequest.Callback) null).executeAndWait();
