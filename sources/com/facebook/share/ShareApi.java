...
public final class ShareApi {
    ...
    public String getGraphPath(String str) {
        try {
            ...
            String encode = URLEncoder.encode(getGraphNode(), "UTF-8");
            return encode + RemoteSettings.FORWARD_SLASH_STRING + str;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:?, code lost:
        putImageInBundleWithArrayFormat(r8, 0, new org.json.JSONObject(r1));
        r8.remove(com.facebook.share.internal.MessengerShareContentUtility.MEDIA_IMAGE);
     */
    ...
    public static void handleImagesOnAction(android.os.Bundle r8) {
        /*
            java.lang.String r0 = "image"
            java.lang.String r1 = r8.getString(r0)
            if (r1 == 0) goto L_0x0050
            r2 = 0
            org.json.JSONArray r3 = new org.json.JSONArray     // Catch:{ JSONException -> 0x0045 }
            r3.<init>(r1)     // Catch:{ JSONException -> 0x0045 }
            r4 = 0
        L_0x000f:
            int r5 = r3.length()     // Catch:{ JSONException -> 0x0045 }
            if (r4 >= r5) goto L_0x0041
            org.json.JSONObject r5 = r3.optJSONObject(r4)     // Catch:{ JSONException -> 0x0045 }
            if (r5 == 0) goto L_0x001f
            putImageInBundleWithArrayFormat(r8, r4, r5)     // Catch:{ JSONException -> 0x0045 }
            goto L_0x003e
        L_0x001f:
            java.lang.String r5 = r3.getString(r4)     // Catch:{ JSONException -> 0x0045 }
            java.util.Locale r6 = java.util.Locale.ROOT     // Catch:{ JSONException -> 0x0045 }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x0045 }
            r6.<init>()     // Catch:{ JSONException -> 0x0045 }
            java.lang.String r7 = "image["
            r6.append(r7)     // Catch:{ JSONException -> 0x0045 }
            r6.append(r4)     // Catch:{ JSONException -> 0x0045 }
            java.lang.String r7 = "][url]"
            r6.append(r7)     // Catch:{ JSONException -> 0x0045 }
            java.lang.String r6 = r6.toString()     // Catch:{ JSONException -> 0x0045 }
            r8.putString(r6, r5)     // Catch:{ JSONException -> 0x0045 }
        L_0x003e:
            int r4 = r4 + 1
            goto L_0x000f
        L_0x0041:
            r8.remove(r0)     // Catch:{ JSONException -> 0x0045 }
            return
        L_0x0045:
            org.json.JSONObject r3 = new org.json.JSONObject     // Catch:{ JSONException -> 0x0050 }
            r3.<init>(r1)     // Catch:{ JSONException -> 0x0050 }
            putImageInBundleWithArrayFormat(r8, r2, r3)     // Catch:{ JSONException -> 0x0050 }
            r8.remove(r0)     // Catch:{ JSONException -> 0x0050 }
        L_0x0050:
            return
        */
    ...
    public void stageOpenGraphObject(final ShareOpenGraphObject shareOpenGraphObject, final CollectionMapper.OnMapValueCompleteListener onMapValueCompleteListener) {
        ...
        stageCollectionValues(r0, new CollectionMapper.OnMapperCompleteListener() {
            public void onComplete() {
                Bundle c = e.c("object", jSONObject.toString());
                try {
                    AccessToken currentAccessToken = AccessToken.getCurrentAccessToken();
                    ShareApi shareApi = ShareApi.this;
                    new GraphRequest(currentAccessToken, shareApi.getGraphPath("objects/" + URLEncoder.encode(str, "UTF-8")), c, HttpMethod.POST, r5).executeAsync();
                } catch (UnsupportedEncodingException e) {
                    String localizedMessage = e.getLocalizedMessage();
                    if (localizedMessage == null) {
