...
public final class MessageDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    public static void logDialogShare(Context context, ShareContent shareContent, AppCall appCall) {
        ...
        Bundle c = e.c(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_TYPE, str);
        c.putString(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_UUID, appCall.getCallId().toString());
        c.putString(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_PAGE_ID, shareContent.getPageId());
        newLogger.logSdkEvent(AnalyticsEvents.EVENT_SHARE_MESSENGER_DIALOG_SHOW, (Double) null, c);
    }
