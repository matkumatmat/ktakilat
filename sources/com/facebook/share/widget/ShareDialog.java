...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    public class CameraEffectHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ CameraEffectHandler(ShareDialog shareDialog, AnonymousClass1 r2) {
            this();
        }
    ...
    public class FeedHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ FeedHandler(ShareDialog shareDialog, AnonymousClass1 r2) {
            this();
        }
    ...
    public class NativeHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ NativeHandler(ShareDialog shareDialog, AnonymousClass1 r2) {
            this();
        }
    ...
    public class WebShareHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ WebShareHandler(ShareDialog shareDialog, AnonymousClass1 r2) {
            this();
        }
    ...
    private static boolean canShowWebTypeCheck(Class<? extends ShareContent> cls) {
        ...
        if (ShareLinkContent.class.isAssignableFrom(cls) || ShareOpenGraphContent.class.isAssignableFrom(cls) || (SharePhotoContent.class.isAssignableFrom(cls) && z)) {
            return true;
        }
        return false;
    }
    ...
    public void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        AppEventsLogger.newLogger(context).logSdkEvent("fb_share_dialog_show", (Double) null, ba.f("fb_share_dialog_show", str, AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_TYPE, str2));
    }
