...
public final class Utility {
    ...
    public static int copyAndCloseInputStream(java.io.InputStream r6, java.io.OutputStream r7) throws java.io.IOException {
        /*
            ...
            r3 = 0
        L_0x000c:
            int r4 = r1.read(r0)     // Catch:{ all -> 0x0018 }
            r5 = -1
            if (r4 == r5) goto L_0x001b
            r7.write(r0, r2, r4)     // Catch:{ all -> 0x0018 }
            int r3 = r3 + r4
            goto L_0x000c
        L_0x0018:
            r7 = move-exception
    ...
    private static GraphRequest getGraphMeRequestWithCache(String str) {
        return new GraphRequest((AccessToken) null, "me", ba.f(GraphRequest.FIELDS_PARAM, "id,name,first_name,middle_name,last_name,link", "access_token", str), HttpMethod.GET, (GraphRequest.Callback) null);
    }
    ...
    public static boolean isAutofillAvailable(Context context) {
        AutofillManager g;
        if (Build.VERSION.SDK_INT >= 26 && (g = sd.g(context.getSystemService(sd.i()))) != null && g.isAutofillSupported() && g.isEnabled()) {
            return true;
        }
        return false;
    }
