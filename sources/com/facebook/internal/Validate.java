...
public final class Validate {
    ...
    public static void containsNoNullOrEmpty(Collection<String> collection, String str) {
        ...
        for (String next : collection) {
            if (next == null) {
                throw new NullPointerException(ba.o("Container '", str, "' cannot contain null values"));
            } else if (next.length() == 0) {
                throw new IllegalArgumentException(ba.o("Container '", str, "' cannot contain empty values"));
            }
        }
    }
    ...
    public static void hasContentProvider(Context context) {
        ...
        if (packageManager != null) {
            String B = e.B(CONTENT_PROVIDER_BASE, hasAppID);
            if (packageManager.resolveContentProvider(B, 0) == null) {
                throw new IllegalStateException(ba.o("A ContentProvider for this app was not set up in the AndroidManifest.xml, please add ", B, " as a provider to your AndroidManifest.xml file. See https://developers.facebook.com/docs/sharing/android for more info."));
            }
        }
    }
    ...
    public static <T> void notEmpty(Collection<T> collection, String str) {
        if (collection.isEmpty()) {
            throw new IllegalArgumentException(ba.o("Container '", str, "' cannot be empty"));
        }
    }
    ...
    public static void notNull(Object obj, String str) {
        if (obj == null) {
            throw new NullPointerException(ba.o("Argument '", str, "' cannot be null"));
        }
    }

    public static void notNullOrEmpty(String str, String str2) {
        if (Utility.isNullOrEmpty(str)) {
            throw new IllegalArgumentException(ba.o("Argument '", str2, "' cannot be null or empty"));
        }
    }
    ...
    public static void oneOf(Object obj, String str, Object... objArr) {
        ...
        throw new IllegalArgumentException(ba.o("Argument '", str, "' was not one of the allowed values"));
    }
