...
public final class NativeProtocol {
    ...
    public static java.util.TreeSet<java.lang.Integer> fetchAllAvailableProtocolVersionsForAppInfo(com.facebook.internal.NativeProtocol.NativeAppInfo r10) {
        /*
            ...
            r9 = 0
            android.content.Context r6 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ all -> 0x003d }
            android.content.pm.PackageManager r6 = r6.getPackageManager()     // Catch:{ all -> 0x003d }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ all -> 0x003d }
            r7.<init>()     // Catch:{ all -> 0x003d }
            java.lang.String r10 = r10.getPackage()     // Catch:{ all -> 0x003d }
            r7.append(r10)     // Catch:{ all -> 0x003d }
            java.lang.String r10 = ".provider.PlatformProvider"
            r7.append(r10)     // Catch:{ all -> 0x003d }
            java.lang.String r10 = r7.toString()     // Catch:{ all -> 0x003d }
            r7 = 0
            android.content.pm.ProviderInfo r10 = r6.resolveContentProvider(r10, r7)     // Catch:{ RuntimeException -> 0x003f }
            goto L_0x0046
        L_0x003d:
            r10 = move-exception
            goto L_0x0073
        L_0x003f:
            r10 = move-exception
            java.lang.String r6 = TAG     // Catch:{ all -> 0x003d }
            android.util.Log.e(r6, r0, r10)     // Catch:{ all -> 0x003d }
            r10 = r9
        L_0x0046:
            ...
            r8 = 0
            r6 = 0
            android.database.Cursor r9 = r3.query(r4, r5, r6, r7, r8)     // Catch:{ NullPointerException | SecurityException -> 0x0050 }
            goto L_0x0055
        L_0x0050:
            java.lang.String r10 = TAG     // Catch:{ all -> 0x003d }
            android.util.Log.e(r10, r0)     // Catch:{ all -> 0x003d }
        L_0x0055:
            if (r9 == 0) goto L_0x006d
        L_0x0057:
            boolean r10 = r9.moveToNext()     // Catch:{ all -> 0x003d }
            if (r10 == 0) goto L_0x006d
            int r10 = r9.getColumnIndex(r2)     // Catch:{ all -> 0x003d }
            int r10 = r9.getInt(r10)     // Catch:{ all -> 0x003d }
            java.lang.Integer r10 = java.lang.Integer.valueOf(r10)     // Catch:{ all -> 0x003d }
            r1.add(r10)     // Catch:{ all -> 0x003d }
            goto L_0x0057
        L_0x006d:
