...
public final class ServerProtocol {
    ...
    public static final String getDialogAuthority() {
        return e.B("m.", FacebookSdk.getFacebookDomain());
    }

    public static final String getGraphUrlBase() {
        return e.B("https://graph.", FacebookSdk.getFacebookDomain());
    }

    public static final String getGraphVideoUrlBase() {
        return e.B("https://graph-video.", FacebookSdk.getFacebookDomain());
    }
    ...
    public static Bundle getQueryParamsForPlatformActivityIntentWebFallback(String str, int i, Bundle bundle) {
        ...
        Bundle c = e.c(FALLBACK_DIALOG_PARAM_KEY_HASH, applicationSignature);
        c.putString("app_id", FacebookSdk.getApplicationId());
        c.putInt("version", i);
        ...
        try {
            ...
            if (convertToJSON != null) {
                if (convertToJSON2 != null) {
                    c.putString(FALLBACK_DIALOG_PARAM_BRIDGE_ARGS, convertToJSON.toString());
                    c.putString(FALLBACK_DIALOG_PARAM_METHOD_ARGS, convertToJSON2.toString());
                    return c;
                }
            }
            return null;
