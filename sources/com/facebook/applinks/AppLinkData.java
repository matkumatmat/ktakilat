...
public class AppLinkData {
    ...
    public static void fetchDeferredAppLinkFromServer(Context context, String str, CompletionHandler completionHandler) {
        ...
        try {
            ...
            String l = e.l(str, "/activities");
            AppLinkData appLinkData = null;
            try {
                JSONObject jSONObject2 = GraphRequest.newPostRequest((AccessToken) null, l, jSONObject, (GraphRequest.Callback) null).executeAndWait().getJSONObject();
                if (jSONObject2 != null) {
