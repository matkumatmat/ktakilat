...
public class BleScannerImpl implements BleScanner {
    ...
    public synchronized void startScanning() throws com.facebook.places.internal.ScannerException {
        /*
            r5 = this;
            monitor-enter(r5)
            boolean r0 = r5.isScanInProgress     // Catch:{ all -> 0x003d }
            if (r0 != 0) goto L_0x0052
            com.facebook.places.internal.BleScannerImpl$ScanCallBackImpl r0 = new com.facebook.places.internal.BleScannerImpl$ScanCallBackImpl     // Catch:{ all -> 0x003d }
            r1 = 0
            r0.<init>()     // Catch:{ all -> 0x003d }
            r5.scanCallBack = r0     // Catch:{ all -> 0x003d }
            r0 = 1
            r5.isScanInProgress = r0     // Catch:{ all -> 0x003d }
            r2 = 0
            r5.errorCode = r2     // Catch:{ all -> 0x003d }
            java.util.List<com.facebook.places.internal.BluetoothScanResult> r2 = r5.scanResults     // Catch:{ all -> 0x003d }
            monitor-enter(r2)     // Catch:{ all -> 0x003d }
            java.util.List<com.facebook.places.internal.BluetoothScanResult> r3 = r5.scanResults     // Catch:{ all -> 0x004f }
            r3.clear()     // Catch:{ all -> 0x004f }
            monitor-exit(r2)     // Catch:{ all -> 0x004f }
            android.bluetooth.le.BluetoothLeScanner r2 = r5.bluetoothLeScanner     // Catch:{ all -> 0x003d }
            if (r2 == 0) goto L_0x0047
            android.bluetooth.le.ScanSettings$Builder r2 = new android.bluetooth.le.ScanSettings$Builder     // Catch:{ Exception -> 0x003f }
            r2.<init>()     // Catch:{ Exception -> 0x003f }
            r3 = 2
            r2.setScanMode(r3)     // Catch:{ Exception -> 0x003f }
            r3 = 0
            r2.setReportDelay(r3)     // Catch:{ Exception -> 0x003f }
            android.bluetooth.le.BluetoothLeScanner r3 = r5.bluetoothLeScanner     // Catch:{ Exception -> 0x003f }
            android.bluetooth.le.ScanSettings r2 = r2.build()     // Catch:{ Exception -> 0x003f }
            com.facebook.places.internal.BleScannerImpl$ScanCallBackImpl r4 = r5.scanCallBack     // Catch:{ Exception -> 0x003f }
            r3.startScan(r1, r2, r4)     // Catch:{ Exception -> 0x003f }
            r5.isScanInProgress = r0     // Catch:{ Exception -> 0x003f }
            monitor-exit(r5)
            return
        L_0x003d:
            r0 = move-exception
            goto L_0x005a
        L_0x003f:
            com.facebook.places.internal.ScannerException r0 = new com.facebook.places.internal.ScannerException     // Catch:{ all -> 0x003d }
            com.facebook.places.internal.ScannerException$Type r1 = com.facebook.places.internal.ScannerException.Type.UNKNOWN_ERROR     // Catch:{ all -> 0x003d }
        ...
        L_0x0052:
            com.facebook.places.internal.ScannerException r0 = new com.facebook.places.internal.ScannerException     // Catch:{ all -> 0x003d }
            com.facebook.places.internal.ScannerException$Type r1 = com.facebook.places.internal.ScannerException.Type.SCAN_ALREADY_IN_PROGRESS     // Catch:{ all -> 0x003d }
            r0.<init>(r1)     // Catch:{ all -> 0x003d }
            throw r0     // Catch:{ all -> 0x003d }
        L_0x005a:
