...
public class WifiScannerImpl implements WifiScanner {
    ...
    private java.util.List<com.facebook.places.internal.WifiScanResult> getActiveScanResults() throws com.facebook.places.internal.ScannerException {
        /*
            r5 = this;
            r0 = 0
            android.content.Context r1 = r5.context     // Catch:{ Exception -> 0x002d, all -> 0x0027 }
            boolean r1 = com.facebook.internal.Validate.hasChangeWifiStatePermission(r1)     // Catch:{ Exception -> 0x002d, all -> 0x0027 }
            if (r1 == 0) goto L_0x002d
            r5.registerBroadcastReceiver()     // Catch:{ Exception -> 0x002d, all -> 0x0027 }
            android.net.wifi.WifiManager r1 = r5.wifiManager     // Catch:{ Exception -> 0x002d, all -> 0x0027 }
            boolean r1 = r1.startScan()     // Catch:{ Exception -> 0x002d, all -> 0x0027 }
            if (r1 == 0) goto L_0x002d
            java.lang.Object r1 = r5.scanLock     // Catch:{ InterruptedException -> 0x0029 }
            monitor-enter(r1)     // Catch:{ InterruptedException -> 0x0029 }
        ...
        L_0x0027:
            ...
            goto L_0x0031
        L_0x0029:
            java.util.List r0 = r5.getCachedScanResults()     // Catch:{ Exception -> 0x002d, all -> 0x0027 }
        L_0x002d:
    ...
    private static boolean isWifiSsidBlacklisted(String str) {
        ...
        if (str.endsWith(SSID_NOMAP) || str.contains(SSID_OPTOUT)) {
            return true;
        }
        return false;
    }
