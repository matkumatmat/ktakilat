...
public class FaceSDKManager {
    ...
    public void initModel(Context context, final IInitCallback iInitCallback) {
        ...
        this.mFaceDetect.initModel(context, "detect/detect_rgb-customized-pa-faceid4_0.model.int8.0.0.6.1", "align/align-customized-pa-offlineCapture_withScore_quant_20200909.model.int8.6.4.7.1", BDFaceSDKCommon.DetectType.DETECT_VIS, BDFaceSDKCommon.AlignType.BDFACE_ALIGN_TYPE_RGB_ACCURATE, new Callback() {
            public void onResponse(int i, String str) {
                IInitCallback iInitCallback;
                if (i != 0 && (iInitCallback = iInitCallback) != null) {
        ...
        this.mFaceActionLive.initActionLiveModel(context, "eyes_close/eyes-customized-pa-caiji.model.float32.1.0.3.1", "mouth_close/mouth-customized-pa-caiji.model.float32.1.0.3.1", new Callback() {
            public void onResponse(int i, String str) {
                ...
                if (i == 0 && iInitCallback != null) {
                    boolean unused = FaceSDKManager.this.mInitFlag = true;
    ...
    public void initialize(final Context context, String str, String str2, final IInitCallback iInitCallback) {
        if (iInitCallback != null) {
            ...
            this.mFaceAuth.initLicense(context, str, str2, true, new Callback() {
                public void onResponse(int i, String str) {
                    if (i == 0) {
                        FaceSDKManager.this.initModel(context, iInitCallback);
                        return;
                    }
                    IInitCallback iInitCallback = iInitCallback;
                    if (iInitCallback != null) {
                        iInitCallback.initFailure(i, str);
                    }
                }
