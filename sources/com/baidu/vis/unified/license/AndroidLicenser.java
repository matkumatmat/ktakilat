...
public class AndroidLicenser {
        ...
        synchronized (AndroidLicenser.class) {
            if ("".equals(deviceID)) {
                try {
                    ...
                    loadClass.getDeclaredMethod("init", new Class[]{Context.class, cls}).invoke(loadClass, new Object[]{context, Boolean.valueOf(mOnline)});
                    loadClass.getDeclaredMethod("setAgreePolicy", new Class[]{Context.class, cls}).invoke(loadClass, new Object[]{context, Boolean.valueOf(mAgree)});
                    Pair pair = (Pair) loadClass.getDeclaredMethod("getId", new Class[]{Context.class, String.class}).invoke(loadClass, new Object[]{context, mIdFlag});
    ...
    public BDLicenseAuthInfo authGetAuthInfo(Context context, int i) {
        ...
        try {
            ...
            BDLicenseAuthInfo bDLicenseAuthInfo2 = new BDLicenseAuthInfo("", -1, "", "", "", 0, "");
            e.printStackTrace();
