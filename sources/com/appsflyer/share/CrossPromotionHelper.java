...
public class CrossPromotionHelper {
    ...
    private static void getMediationNetwork(@NonNull String str, @NonNull Context context, @Nullable AFk1rSDK aFk1rSDK) {
        ...
        copydefault.getRevenue.execute(new Runnable(aFe1jSDK) {
...
*/
    ...
    public static void setUrl(java.util.Map<java.lang.String, java.lang.String> r5) {
        ...
        L_0x004a:
            ...
            goto L_0x0008
        L_0x004d:
            com.appsflyer.internal.AFk1wSDK.getMediationNetwork = r1
            goto L_0x0008
        L_0x0050:
            return
        */
    ...
    public static void logAndOpenStore(@NonNull Context context, String str, String str2, Map<String, String> map) {
        LinkGenerator revenue = getRevenue(context, str, str2, map, String.format(AFk1wSDK.getMediationNetwork, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), ((AFa1tSDK) AFa1tSDK.getMonetizationNetwork(new Object[0], -631580017, 631580017, (int) System.currentTimeMillis())).getHostName()}));
    ...
    public static void logCrossPromoteImpression(@NonNull Context context, String str, String str2, Map<String, String> map) {
        if (AppsFlyerProperties.getInstance().getBoolean(AppsFlyerProperties.AF_WAITFOR_CUSTOMERID, false)) {
            ...
            getMediationNetwork(getRevenue(context, str, str2, map, String.format(getMediationNetwork, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), ((AFa1tSDK) AFa1tSDK.getMonetizationNetwork(new Object[0], -631580017, 631580017, (int) System.currentTimeMillis())).getHostName()})).generateLink(), context, (AFk1rSDK) null);
        }
    }
}
