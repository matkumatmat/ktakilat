...
public final class AFf1oSDK implements AFe1qSDK {
    ...
    private void getMediationNetwork(@NonNull AFf1nSDK aFf1nSDK, @Nullable AFf1mSDK aFf1mSDK) {
    ...
    public final void getCurrencyIso4217Code(@Nullable AFf1mSDK aFf1mSDK) {
        ...
        aFe1lSDK.getRevenue.execute(new Runnable(aFf1qSDK) {
