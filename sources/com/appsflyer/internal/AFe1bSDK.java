...
public final class AFe1bSDK extends AFe1sSDK<Boolean> {
    ...
    public final AFe1rSDK getCurrencyIso4217Code() throws Exception {
        for (AFc1rSDK next : this.component2.getRevenue()) {
            AFLogger aFLogger = AFLogger.INSTANCE;
            AFg1cSDK aFg1cSDK = AFg1cSDK.CACHE;
            StringBuilder sb = new StringBuilder("resending request: ");
            sb.append(next.getRevenue);
            aFLogger.i(aFg1cSDK, sb.toString());
            try {
                AFh1mSDK aFh1mSDK = new AFh1mSDK(getRevenue(next), next.getMediationNetwork(), next.getMediationNetwork, next.getMonetizationNetwork);
                AFe1lSDK aFe1lSDK = this.component4;
                aFe1lSDK.getRevenue.execute(new Runnable(new AFf1vSDK(aFh1mSDK, this.areAllFieldsValid)) {
