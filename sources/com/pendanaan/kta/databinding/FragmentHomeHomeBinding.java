...
public final class FragmentHomeHomeBinding implements ViewBinding {
    ...
    private FragmentHomeHomeBinding(@NonNull RelativeLayout relativeLayout, @NonNull FrameLayout frameLayout2) {
    ...
    public static FragmentHomeHomeBinding bind(@NonNull View view) {
        ...
        if (frameLayout2 != null) {
            return new FragmentHomeHomeBinding((RelativeLayout) view, frameLayout2);
        }
