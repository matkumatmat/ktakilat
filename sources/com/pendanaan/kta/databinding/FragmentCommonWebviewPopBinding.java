...
public final class FragmentCommonWebviewPopBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public final Button side;
    @NonNull
    public final TextView tryAgainTv;
    @NonNull
    public final LinearLayout webContainer;

    private FragmentCommonWebviewPopBinding(@NonNull RelativeLayout relativeLayout, @NonNull RelativeLayout relativeLayout2, @NonNull ImageView imageView, @NonNull Button button, @NonNull ImageView imageView2, @NonNull RelativeLayout relativeLayout3, @NonNull LinearLayout linearLayout, @NonNull WidgetH5ActionBarBinding widgetH5ActionBarBinding, @NonNull LinearLayout linearLayout2, @NonNull Button button2, @NonNull LinearLayout linearLayout3, @NonNull CWidgetActionBarBinding cWidgetActionBarBinding, @NonNull VerticalSwipeRefreshLayout verticalSwipeRefreshLayout, @NonNull RelativeLayout relativeLayout4, @NonNull Button button3, @NonNull TextView textView, @NonNull LinearLayout linearLayout4) {
        this.rootView_ = relativeLayout;
        this.errorLayout = relativeLayout2;
        this.faceIv = imageView;
        this.front = button;
        this.holderCacheIv = imageView2;
    ...
    @NonNull
    public static FragmentCommonWebviewPopBinding bind(@NonNull View view) {
        View view2 = view;
        int i = R.id.error_layout;
        RelativeLayout relativeLayout = (RelativeLayout) ViewBindings.findChildViewById(view2, R.id.error_layout);
        if (relativeLayout != null) {
            i = R.id.face_iv;
            ImageView imageView = (ImageView) ViewBindings.findChildViewById(view2, R.id.face_iv);
            if (imageView != null) {
                i = R.id.front;
                Button button = (Button) ViewBindings.findChildViewById(view2, R.id.front);
                if (button != null) {
                    i = R.id.holder_cache_iv;
                    ImageView imageView2 = (ImageView) ViewBindings.findChildViewById(view2, R.id.holder_cache_iv);
                    if (imageView2 != null) {
                            ...
                            if (linearLayout != null) {
                                ...
                                if (findChildViewById != null) {
                                    ...
                                    if (linearLayout2 != null) {
                                        i = R.id.live;
                                        Button button2 = (Button) ViewBindings.findChildViewById(view2, R.id.live);
                                        if (button2 != null) {
                                            i = R.id.oops_layout;
                                            ...
                                            if (linearLayout3 != null) {
                                                ...
                                                if (findChildViewById2 != null) {
                                                    ...
                                                    if (verticalSwipeRefreshLayout != null) {
                                                        ...
                                                        i = R.id.side;
                                                        Button button3 = (Button) ViewBindings.findChildViewById(view2, R.id.side);
                                                        if (button3 != null) {
                                                            i = R.id.try_again_tv;
                                                            ...
                                                            if (textView != null) {
                                                                ...
                                                                if (linearLayout4 != null) {
                                                                    return new FragmentCommonWebviewPopBinding(relativeLayout3, relativeLayout, imageView, button, imageView2, relativeLayout2, linearLayout, bind, linearLayout2, button2, linearLayout3, bind2, verticalSwipeRefreshLayout, relativeLayout3, button3, textView, linearLayout4);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @NonNull
    public static FragmentCommonWebviewPopBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    @NonNull
    public static FragmentCommonWebviewPopBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_common_webview_pop, viewGroup, false);
        if (z) {
