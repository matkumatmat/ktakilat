...
public class FirebaseMessaging {
    ...
    @VisibleForTesting
    static Provider<TransportFactory> transportFactory = new x3(6);
    ...
    private void handleProxiedNotificationData() {
        this.gmsRpc.getProxyNotificationData().addOnSuccessListener(this.initExecutor, new d9(this, 2));
    }
    ...
    public /* synthetic */ Task lambda$blockingGetToken$14(String str, Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new d(this, str, token));
    }
    ...
    public String blockingGetToken() throws IOException {
        ...
        if (firebaseInstanceIdInternal != null) {
            ...
            try {
                return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new d(this, defaultSenderId, tokenWithoutTriggeringSync)));
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new c9(this, taskCompletionSource, 2));
            return taskCompletionSource.getTask();
        } else if (getTokenWithoutTriggeringSync() == null) {
            return Tasks.forResult(null);
        } else {
            TaskCompletionSource taskCompletionSource2 = new TaskCompletionSource();
            FcmExecutors.newNetworkIOExecutor().execute(new c9(this, taskCompletionSource2, 0));
    ...
    public Task<String> getToken() {
        ...
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.initExecutor.execute(new c9(this, taskCompletionSource, 1));
        return taskCompletionSource.getTask();
    }
    ...
    public void send(@NonNull RemoteMessage remoteMessage) {
        ...
        if (!TextUtils.isEmpty(remoteMessage.getTo())) {
            ...
            intent.putExtra(EXTRA_DUMMY_P_INTENT, PendingIntent.getBroadcast(context2, 0, intent2, i));
    ...
    public Task<Void> setNotificationDelegationEnabled(boolean z) {
        return ProxyNotificationInitializer.setEnableProxyNotification(this.initExecutor, this.context, z).addOnSuccessListener((Executor) new t(0), new d9(this, 1));
    }
    ...
    public Task<Void> subscribeToTopic(@NonNull String str) {
        return this.topicsSubscriberTask.onSuccessTask(new b(str, 0));
    }
    ...
    public Task<Void> unsubscribeFromTopic(@NonNull String str) {
        return this.topicsSubscriberTask.onSuccessTask(new b(str, 1));
    }
    ...
    public FirebaseMessaging(FirebaseApp firebaseApp2, @Nullable FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<TransportFactory> provider, Subscriber subscriber, Metadata metadata2, GmsRpc gmsRpc2, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new d9(this, 0));
        }
        executor2.execute(new e9(this, 0));
        ...
        createInstance.addOnSuccessListener(executor2, (OnSuccessListener<? super TopicsSubscriber>) new c(this, 0));
        executor2.execute(new e9(this, 1));
    }
}
