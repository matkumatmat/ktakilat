...
final class TopicOperation {
    ...
    private TopicOperation(String str, String str2) {
        ...
        this.operation = str;
        this.serializedString = e.m(str, OPERATION_PAIR_DIVIDER, str2);
    }
    ...
    private static String normalizeTopicOrThrow(String str, String str2) {
        ...
        throw new IllegalArgumentException(ba.o("Invalid topic name: ", str, " does not match the allowed format [a-zA-Z0-9-_.~%]{1,900}."));
    }
