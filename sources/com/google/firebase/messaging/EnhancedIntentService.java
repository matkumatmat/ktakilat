...
public abstract class EnhancedIntentService extends Service {
    ...
    public Task<Void> processIntent(Intent intent) {
        ...
        this.executor.execute(new m0(this, 8, intent, taskCompletionSource));
    ...
    public final int onStartCommand(Intent intent, int i, int i2) {
        ...
        processIntent.addOnCompleteListener((Executor) new t(0), (OnCompleteListener<Void>) new t2(7, this, intent));
        return 3;
    }
