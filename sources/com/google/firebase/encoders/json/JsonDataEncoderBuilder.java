...
public final class JsonDataEncoderBuilder implements EncoderConfig<JsonDataEncoderBuilder> {
    private static final ValueEncoder<Boolean> BOOLEAN_ENCODER = new kb(1);
    private static final ObjectEncoder<Object> DEFAULT_FALLBACK_ENCODER = new jb(0);
    private static final ValueEncoder<String> STRING_ENCODER = new kb(0);
