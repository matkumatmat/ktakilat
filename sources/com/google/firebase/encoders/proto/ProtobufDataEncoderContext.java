...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    private static final ObjectEncoder<Map.Entry<Object, Object>> DEFAULT_MAP_ENCODER = new Object();
    private static final FieldDescriptor MAP_KEY_DESC = e.e(1, FieldDescriptor.builder("key"));
    private static final FieldDescriptor MAP_VALUE_DESC = e.e(2, FieldDescriptor.builder("value"));
