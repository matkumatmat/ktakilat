...
public final class ComponentDiscovery<T> {
    ...
    public static ComponentRegistrar instantiate(String str) {
        try {
            ...
            throw new InvalidRegistrarException(ba.o("Could not instantiate ", str, "."), e);
        } catch (InstantiationException e2) {
            throw new InvalidRegistrarException(ba.o("Could not instantiate ", str, "."), e2);
        } catch (NoSuchMethodException e3) {
            throw new InvalidRegistrarException(e.B("Could not instantiate ", str), e3);
        } catch (InvocationTargetException e4) {
            throw new InvalidRegistrarException(e.B("Could not instantiate ", str), e4);
        }
    }
    ...
    public List<Provider<ComponentRegistrar>> discoverLazy() {
        ArrayList arrayList = new ArrayList();
        for (String s3Var : this.retriever.retrieve(this.context)) {
            arrayList.add(new s3(s3Var, 0));
        }
        return arrayList;
    }
}
