...
public final class SessionEvents {
    ...
    public final ApplicationInfo getApplicationInfo(@NotNull FirebaseApp firebaseApp) {
        ...
        return new ApplicationInfo(applicationId, str3, BuildConfig.VERSION_NAME, str4, logEnvironment, new AndroidApplicationInfo(packageName, str, str2, str6, currentProcessDetails, processDetailsProvider.getAppProcessDetails(applicationContext3)));
    }
