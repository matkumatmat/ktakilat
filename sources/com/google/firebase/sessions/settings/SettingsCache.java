...
public final class SettingsCache {
    ...
    @Inject
    public SettingsCache(@NotNull @SessionConfigsDataStore DataStore<Preferences> dataStore2) {
        Intrinsics.checkNotNullParameter(dataStore2, "dataStore");
        this.dataStore = dataStore2;
        BuildersKt.c(new AnonymousClass1(this, (Continuation<? super AnonymousClass1>) null));
    }
    ...
    public final <T> java.lang.Object updateConfigValue(androidx.datastore.preferences.core.Preferences.Key<T> r6, T r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        ...
        L_0x0018:
            ...
            kotlin.ResultKt.b(r8)     // Catch:{ IOException -> 0x0027 }
            goto L_0x0058
        L_0x0027:
            r6 = move-exception
            goto L_0x0045
        ...
        L_0x0031:
            ...
            androidx.datastore.core.DataStore<androidx.datastore.preferences.core.Preferences> r8 = r5.dataStore     // Catch:{ IOException -> 0x0027 }
            com.google.firebase.sessions.settings.SettingsCache$updateConfigValue$2 r2 = new com.google.firebase.sessions.settings.SettingsCache$updateConfigValue$2     // Catch:{ IOException -> 0x0027 }
            r4 = 0
            r2.<init>(r7, r6, r5, r4)     // Catch:{ IOException -> 0x0027 }
            r0.label = r3     // Catch:{ IOException -> 0x0027 }
            java.lang.Object r6 = androidx.datastore.preferences.core.PreferencesKt.edit(r8, r2, r0)     // Catch:{ IOException -> 0x0027 }
    ...
    public final java.lang.Object removeConfigs$com_google_firebase_firebase_sessions(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L_0x0018:
            ...
            if (r2 == 0) goto L_0x0031
            if (r2 != r3) goto L_0x0029
            kotlin.ResultKt.b(r6)     // Catch:{ IOException -> 0x0027 }
            goto L_0x0058
        L_0x0027:
            r6 = move-exception
            goto L_0x0045
        ...
        L_0x0031:
            ...
            androidx.datastore.core.DataStore<androidx.datastore.preferences.core.Preferences> r6 = r5.dataStore     // Catch:{ IOException -> 0x0027 }
            com.google.firebase.sessions.settings.SettingsCache$removeConfigs$2 r2 = new com.google.firebase.sessions.settings.SettingsCache$removeConfigs$2     // Catch:{ IOException -> 0x0027 }
            r4 = 0
            r2.<init>(r5, r4)     // Catch:{ IOException -> 0x0027 }
            r0.label = r3     // Catch:{ IOException -> 0x0027 }
            java.lang.Object r6 = androidx.datastore.preferences.core.PreferencesKt.edit(r6, r2, r0)     // Catch:{ IOException -> 0x0027 }
            if (r6 != r1) goto L_0x0058
            return r1
        L_0x0045:
    ...
    public final Object updateSamplingRate(@Nullable Double d, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (updateConfigValue == CoroutineSingletons.COROUTINE_SUSPENDED) {
