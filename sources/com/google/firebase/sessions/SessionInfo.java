...
public final class SessionInfo {
    ...
    public SessionInfo(@NotNull String str, @NotNull String str2, int i, long j, @NotNull DataCollectionStatus dataCollectionStatus2, @NotNull String str3, @NotNull String str4) {
    ...
    @NotNull
    public final SessionInfo copy(@NotNull String str, @NotNull String str2, int i, long j, @NotNull DataCollectionStatus dataCollectionStatus2, @NotNull String str3, @NotNull String str4) {
        Intrinsics.checkNotNullParameter(str, "sessionId");
        Intrinsics.checkNotNullParameter(str2, "firstSessionId");
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.sessionId, sessionInfo.sessionId) && Intrinsics.a(this.firstSessionId, sessionInfo.firstSessionId) && this.sessionIndex == sessionInfo.sessionIndex && this.eventTimestampUs == sessionInfo.eventTimestampUs && Intrinsics.a(this.dataCollectionStatus, sessionInfo.dataCollectionStatus) && Intrinsics.a(this.firebaseInstallationId, sessionInfo.firebaseInstallationId) && Intrinsics.a(this.firebaseAuthenticationToken, sessionInfo.firebaseAuthenticationToken);
    }
    ...
    public int hashCode() {
        ...
        return this.firebaseAuthenticationToken.hashCode() + ba.d((this.dataCollectionStatus.hashCode() + ((((ba.d(this.sessionId.hashCode() * 31, 31, this.firstSessionId) + this.sessionIndex) * 31) + ((int) (j ^ (j >>> 32)))) * 31)) * 31, 31, this.firebaseInstallationId);
    }
