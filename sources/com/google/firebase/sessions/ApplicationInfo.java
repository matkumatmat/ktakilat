...
public final class ApplicationInfo {
    ...
    public int hashCode() {
        int d = ba.d(ba.d(ba.d(this.appId.hashCode() * 31, 31, this.deviceModel), 31, this.sessionSdkVersion), 31, this.osVersion);
        return this.androidAppInfo.hashCode() + ((this.logEnvironment.hashCode() + d) * 31);
    }
