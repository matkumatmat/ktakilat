...
public final class FirebaseSessionsComponent$MainModule$Companion$sessionDetailsDataStore$1 extends Lambda implements Function1<CorruptionException, Preferences> {
    ...
    public final Preferences invoke(@NotNull CorruptionException corruptionException) {
        ...
        Log.w(FirebaseSessionsRegistrar.TAG, "CorruptionException in sessions DataStore in " + ProcessDetailsProvider.INSTANCE.getProcessName$com_google_firebase_firebase_sessions() + ClassUtils.PACKAGE_SEPARATOR_CHAR, corruptionException);
