...
public final class SessionDetails {
    ...
    @NotNull
    public final SessionDetails copy(@NotNull String str, @NotNull String str2, int i, long j) {
        Intrinsics.checkNotNullParameter(str, "sessionId");
        Intrinsics.checkNotNullParameter(str2, "firstSessionId");
    ...
    public int hashCode() {
        ...
        return ((ba.d(this.sessionId.hashCode() * 31, 31, this.firstSessionId) + this.sessionIndex) * 31) + ((int) (j ^ (j >>> 32)));
    }
