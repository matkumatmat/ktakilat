...
public class CrashlyticsReportPersistence {
    ...
    private static final FilenameFilter EVENT_FILE_FILTER = new t4(0);
    private static final String EVENT_FILE_NAME_PREFIX = "event";
    private static final int EVENT_NAME_LENGTH = 15;
    private static final Comparator<? super File> LATEST_SESSION_ID_FIRST_COMPARATOR = new g0(1);
    ...
    private void synthesizeReport(String str, long j) {
        ...
        String appQualitySessionId = this.sessionsSubscriber.getAppQualitySessionId(str);
        synthesizeReportFile(this.fileStore.getSessionFile(str, REPORT_FILE_NAME), arrayList, j, z, readUserId, appQualitySessionId);
    }
    ...
    private int trimEvents(String str, int i) {
        List<File> sessionFiles = this.fileStore.getSessionFiles(str, new t4(1));
        Collections.sort(sessionFiles, new g0(2));
