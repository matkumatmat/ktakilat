...
final class ReportQueue {
    ...
    public void sendReport(CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, TaskCompletionSource<CrashlyticsReportWithSessionId> taskCompletionSource) {
        ...
        this.transport.schedule(Event.ofUrgent(crashlyticsReportWithSessionId.getReport()), new b(this, taskCompletionSource, z, crashlyticsReportWithSessionId));
    }
    ...
    public ReportQueue(double d, double d2, long j, Transport<CrashlyticsReport> transport2, OnDemandCounter onDemandCounter2) {
