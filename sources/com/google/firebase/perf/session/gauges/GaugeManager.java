...
public class GaugeManager {
    ...
    private GaugeManager() {
        this(new Lazy(new x3(7)), TransportManager.getInstance(), ConfigResolver.getInstance(), (GaugeMetadataManager) null, new Lazy(new x3(8)), new Lazy(new x3(9)));
    }
    ...
    public void startCollectingGauges(PerfSession perfSession, ApplicationProcessState applicationProcessState2) {
        ...
        try {
            ...
            this.gaugeManagerDataCollectionJob = this.gaugeManagerExecutor.get().scheduleAtFixedRate(new r9(this, sessionId2, applicationProcessState2, 1), j, j, TimeUnit.MILLISECONDS);
    ...
    public void stopCollectingGauges() {
        ...
        if (str != null) {
            ...
            this.gaugeManagerExecutor.get().schedule(new r9(this, str, applicationProcessState2, 0), 20, TimeUnit.MILLISECONDS);
            this.sessionId = null;
