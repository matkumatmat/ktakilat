...
public class AppStateMonitor implements Application.ActivityLifecycleCallbacks {
    ...
    public boolean isForeground() {
        if (this.currentAppState == ApplicationProcessState.FOREGROUND) {
            return true;
        }
        return false;
    }
    ...
    @VisibleForTesting
    public AppStateMonitor(TransportManager transportManager2, Clock clock2, ConfigResolver configResolver2, boolean z) {
