...
final class RateLimiter {
    ...
    public static class RateLimiterImpl {
        ...
        public RateLimiterImpl(Rate rate2, long j, Clock clock2, ConfigResolver configResolver, @ResourceType String str, boolean z) {
            this.clock = clock2;
            this.capacity = j;
            this.rate = rate2;
        ...
        public synchronized void changeRate(boolean z) {
            ...
            this.rate = rate2;
            if (z) {
                j = this.foregroundCapacity;
            } else {
                j = this.backgroundCapacity;
            }
            this.capacity = j;
        }
        ...
        public synchronized boolean check(@androidx.annotation.NonNull com.google.firebase.perf.v1.PerfMetric r6) {
            /*
                r5 = this;
                monitor-enter(r5)
                com.google.firebase.perf.util.Clock r6 = r5.clock     // Catch:{ all -> 0x002f }
                com.google.firebase.perf.util.Timer r6 = r6.getTime()     // Catch:{ all -> 0x002f }
                com.google.firebase.perf.util.Timer r0 = r5.lastTimeTokenReplenished     // Catch:{ all -> 0x002f }
                long r0 = r0.getDurationMicros(r6)     // Catch:{ all -> 0x002f }
                double r0 = (double) r0     // Catch:{ all -> 0x002f }
                com.google.firebase.perf.util.Rate r2 = r5.rate     // Catch:{ all -> 0x002f }
                double r2 = r2.getTokensPerSeconds()     // Catch:{ all -> 0x002f }
                double r0 = r0 * r2
                long r2 = MICROS_IN_A_SECOND     // Catch:{ all -> 0x002f }
                double r2 = (double) r2     // Catch:{ all -> 0x002f }
                double r0 = r0 / r2
                r2 = 0
                int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
                if (r4 <= 0) goto L_0x0031
                double r2 = r5.tokenCount     // Catch:{ all -> 0x002f }
                double r2 = r2 + r0
                long r0 = r5.capacity     // Catch:{ all -> 0x002f }
                double r0 = (double) r0     // Catch:{ all -> 0x002f }
                double r0 = java.lang.Math.min(r2, r0)     // Catch:{ all -> 0x002f }
                r5.tokenCount = r0     // Catch:{ all -> 0x002f }
                r5.lastTimeTokenReplenished = r6     // Catch:{ all -> 0x002f }
                goto L_0x0031
            L_0x002f:
                r6 = move-exception
                goto L_0x004d
            L_0x0031:
                double r0 = r5.tokenCount     // Catch:{ all -> 0x002f }
                ...
                return r6
            L_0x003f:
                boolean r6 = r5.isLogcatEnabled     // Catch:{ all -> 0x002f }
                if (r6 == 0) goto L_0x004a
                com.google.firebase.perf.logging.AndroidLogger r6 = logger     // Catch:{ all -> 0x002f }
                java.lang.String r0 = "Exceeded log rate limit, dropping the log."
                r6.warn(r0)     // Catch:{ all -> 0x002f }
            L_0x004a:
                monitor-exit(r5)
                r6 = 0
                return r6
    ...
    public RateLimiter(Rate rate, long j, Clock clock, double d, double d2, ConfigResolver configResolver2) {
        double d3 = d;
        double d4 = d2;
