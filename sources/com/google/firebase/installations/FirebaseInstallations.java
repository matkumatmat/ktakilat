...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public FirebaseInstallations(FirebaseApp firebaseApp2, @NonNull Provider<HeartBeatController> provider, @NonNull ExecutorService executorService, @NonNull Executor executor) {
        this(executorService, executor, firebaseApp2, new FirebaseInstallationServiceClient(firebaseApp2.getApplicationContext(), provider), new PersistedInstallation(firebaseApp2), Utils.getInstance(), new Lazy(new s3(firebaseApp2, 1)), new RandomFidGenerator());
    }
    ...
    public final void lambda$getToken$2(boolean z) {
        ...
        this.networkExecutor.execute(new b9(this, z, 0));
    }
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new q1(this, 4));
    }
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new x0(this, 20));
    ...
    public Task<InstallationTokenResult> getToken(boolean z) {
        ...
        this.backgroundExecutor.execute(new b9(this, z, 1));
