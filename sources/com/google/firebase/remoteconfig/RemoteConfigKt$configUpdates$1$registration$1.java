...
public final class RemoteConfigKt$configUpdates$1$registration$1 implements ConfigUpdateListener {
    ...
    public static final void m5onUpdate$lambda0(ProducerScope producerScope, ConfigUpdate configUpdate) {
    ...
    public void onUpdate(@NotNull ConfigUpdate configUpdate) {
        Intrinsics.checkNotNullParameter(configUpdate, "configUpdate");
        this.$this_configUpdates.schedule(new wd(this.$$this$callbackFlow, configUpdate, 1));
    }
}
