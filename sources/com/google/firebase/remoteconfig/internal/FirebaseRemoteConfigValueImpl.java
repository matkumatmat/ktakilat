...
public class FirebaseRemoteConfigValueImpl implements FirebaseRemoteConfigValue {
    ...
    public boolean asBoolean() throws IllegalArgumentException {
        ...
        throw new IllegalArgumentException(ba.o("[Value: ", asTrimmedString, "] cannot be converted to a boolean."));
    }
    ...
    public double asDouble() {
        ...
        try {
            ...
            throw new IllegalArgumentException(ba.o("[Value: ", asTrimmedString, "] cannot be converted to a double."), e);
        }
    }
    ...
    public long asLong() {
        ...
        try {
            ...
            throw new IllegalArgumentException(ba.o("[Value: ", asTrimmedString, "] cannot be converted to a long."), e);
        }
    }
