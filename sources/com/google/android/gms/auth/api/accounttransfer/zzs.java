...
public final class zzs extends zzbz {
    ...
    public final Object getFieldValue(FastJsonResponse.Field field) {
        switch (field.getSafeParcelableFieldId()) {
            ...
            case 6:
                return this.zzg;
            default:
                throw new IllegalStateException(ba.k(field.getSafeParcelableFieldId(), "Unknown SafeParcelable id="));
        }
    }
    ...
    public zzs(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) @Nullable List list, @SafeParcelable.Param(id = 3) @Nullable List list2, @SafeParcelable.Param(id = 4) @Nullable List list3, @SafeParcelable.Param(id = 5) @Nullable List list4, @SafeParcelable.Param(id = 6) @Nullable List list5) {
        this.zza = i;
        this.zzc = list;
        this.zzd = list2;
        this.zze = list3;
