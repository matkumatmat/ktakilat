...
public class zzl {
    ...
    @ShowFirstParty
    public static TokenData zza(Context context, Account account, String str, Bundle bundle, long j, @Nullable Executor executor) throws IOException, GoogleAuthException {
        Bundle bundle2;
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
    ...
    private static Object zzh(Context context, ComponentName componentName, zzk zzk, long j, @Nullable Executor executor) throws IOException, GoogleAuthException {
    ...
    private static Object zzi(Task task, String str) throws IOException, ApiException {
        try {
            ...
            String o = ba.o("Unable to get a result for ", str, " due to ExecutionException.");
            zzd.w(o, new Object[0]);
            throw new IOException(o, e);
        } catch (InterruptedException e2) {
            String o2 = ba.o("Interrupted while waiting for the task of ", str, " to finish.");
            zzd.w(o2, new Object[0]);
            throw new IOException(o2, e2);
        } catch (CancellationException e3) {
            String o3 = ba.o("Canceled while waiting for the task of ", str, " to finish.");
            zzd.w(o3, new Object[0]);
            throw new IOException(o3, e3);
        }
    }
        ...
        if (zzby.BAD_AUTHENTICATION.equals(zza2) || zzby.CAPTCHA.equals(zza2) || zzby.NEED_PERMISSION.equals(zza2) || zzby.NEED_REMOTE_CONSENT.equals(zza2) || zzby.NEEDS_BROWSER.equals(zza2) || zzby.USER_CANCEL.equals(zza2) || zzby.DEVICE_MANAGEMENT_REQUIRED.equals(zza2) || zzby.DM_INTERNAL_ERROR.equals(zza2) || zzby.DM_SYNC_DISABLED.equals(zza2) || zzby.DM_ADMIN_BLOCKED.equals(zza2) || zzby.DM_ADMIN_PENDING_APPROVAL.equals(zza2) || zzby.DM_STALE_SYNC_REQUIRED.equals(zza2) || zzby.DM_DEACTIVATED.equals(zza2) || zzby.DM_REQUIRED.equals(zza2) || zzby.THIRD_PARTY_DEVICE_MANAGEMENT_REQUIRED.equals(zza2) || zzby.DM_SCREENLOCK_REQUIRED.equals(zza2)) {
            ...
            if (!zzht.zzc()) {
                ...
                if (GoogleApiAvailability.getInstance().getApkVersion(context) >= Integer.MAX_VALUE && pendingIntent == null) {
                    logger.e(ba.o("Recovery PendingIntent is missing on current Gms version: 2147483647 for method: ", str, ". It should always be present on or above Gms version 2147483647. This indicates a bug in Gms implementation."), new Object[0]);
                }
                if (intent == null) {
                    logger.e(e.o("no recovery Intent found with status=", str2, " for method=", str, ". This shouldn't happen"), new Object[0]);
                }
                throw new UserRecoverableAuthException(str2, intent);
            } else {
