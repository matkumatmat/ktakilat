...
final class zzln extends zzkt implements RandomAccess, zzmh, zzns {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzln.zzb, 0, this.zzb, this.zzc, zzln.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzln zzln = (zzln) obj;
        if (this.zzc != zzln.zzc) {
            return false;
        }
        double[] dArr = zzln.zzb;
    ...
    public final zzmh zzg(int i) {
        ...
        if (i >= this.zzc) {
            ...
            return new zzln(dArr, this.zzc, true);
        }
