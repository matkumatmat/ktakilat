...
interface zzou {
    ...
    void zzM(int i, zznd zznd, Map map) throws IOException;
    ...
    void zzn(int i, zzlg zzlg) throws IOException;
    ...
    void zzr(int i, Object obj, zznw zznw) throws IOException;

    @Deprecated
    void zzs(int i, Object obj, zznw zznw) throws IOException;
