...
final class zzdu {
    public static int zza(byte[] bArr, int i, zzdt zzdt) throws zzfb {
    ...
    public static int zzc(zzgi zzgi, byte[] bArr, int i, int i2, int i3, zzdt zzdt) throws IOException {
        Object zzd = zzgi.zzd();
    ...
    public static int zzd(zzgi zzgi, byte[] bArr, int i, int i2, zzdt zzdt) throws IOException {
        Object zzd = zzgi.zzd();
    ...
    public static int zze(zzgi zzgi, int i, byte[] bArr, int i2, int i3, zzez zzez, zzdt zzdt) throws IOException {
    ...
    public static int zzf(byte[] bArr, int i, zzez zzez, zzdt zzdt) throws IOException {
        zzew zzew = (zzew) zzez;
        int zzh = zzh(bArr, i, zzdt);
        int i2 = zzdt.zza + zzh;
        while (zzh < i2) {
    ...
    public static int zzg(int i, byte[] bArr, int i2, int i3, zzha zzha, zzdt zzdt) throws zzfb {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
    ...
    public static int zzh(byte[] bArr, int i, zzdt zzdt) {
        int i2 = i + 1;
        byte b = bArr[i];
        if (b < 0) {
    ...
    public static int zzi(int i, byte[] bArr, int i2, zzdt zzdt) {
        byte b = bArr[i2];
        int i3 = i2 + 1;
        int i4 = i & 127;
        if (b >= 0) {
    ...
    public static int zzj(int i, byte[] bArr, int i2, int i3, zzez zzez, zzdt zzdt) {
        zzew zzew = (zzew) zzez;
        int zzh = zzh(bArr, i2, zzdt);
        zzew.zze(zzdt.zza);
        while (zzh < i3) {
    ...
    public static int zzk(byte[] bArr, int i, zzdt zzdt) {
        long j = (long) bArr[i];
        int i2 = i + 1;
        if (j >= 0) {
            zzdt.zzb = j;
    ...
    public static int zzl(Object obj, zzgi zzgi, byte[] bArr, int i, int i2, int i3, zzdt zzdt) throws IOException {
