...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(ba.k(i, "Overread allowed size end="), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            throw new ParseException(e.h(dataPosition, "Size read is invalid start=", " end=", i), parcel);
        }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            throw new ParseException(ba.r(e.r(i3, "Expected size ", i2, " got ", " (0x"), Integer.toHexString(i2), ")"), parcel);
        }
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        int readSize = readSize(parcel, i);
        if (readSize != i2) {
            throw new ParseException(ba.r(e.r(i2, "Expected size ", readSize, " got ", " (0x"), Integer.toHexString(readSize), ")"), parcel);
        }
    }
}
