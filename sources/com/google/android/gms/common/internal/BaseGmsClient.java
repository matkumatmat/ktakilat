            ...
            try {
                ...
                if (i3 == 1) {
                    ...
                    if (!(zze3 == null || (zzv3 = this.zza) == null)) {
                        ...
                        gmsClientSupervisor2.zzc(zzb4, this.zza.zza(), 4225, zze3, zze(), this.zza.zzc());
                    ...
                    ConnectionResult zza4 = gmsClientSupervisor3.zza(new zzo(zzb5, zza3, 4225, zzc2), zze4, zze5, getBindServiceExecutor());
                    if (!zza4.isSuccess()) {
                        String zzb6 = this.zza.zzb();
                        String zza5 = this.zza.zza();
                        Log.w("GmsClient", "unable to connect to service: " + zzb6 + " on " + zza5);
                        if (zza4.getErrorCode() == -1) {
                            i2 = 16;
                        } else {
                            i2 = zza4.getErrorCode();
                        }
    ...
    public void getRemoteService(@Nullable IAccountAccessor iAccountAccessor, @NonNull Set<Scope> set) {
        ...
        if (Build.VERSION.SDK_INT < 31) {
            ...
            if (attributionSource == null) {
                ...
                r = attributionSource.getAttributionTag();
            }
        }
        String str = r;
        int i = this.zzy;
