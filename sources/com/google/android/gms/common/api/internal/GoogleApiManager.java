...
public class GoogleApiManager implements Handler.Callback {
    ...
    public static Status zaF(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, e.n("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
            ...
            case 5:
                ...
                if (zabq != null) {
                    if (connectionResult.getErrorCode() != 13) {
                        ...
                        zabq.zaE(new Status(17, e.n("Error resolution was canceled by the user, original error message: ", this.zaj.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                        break;
                    }
                } else {
                    Log.wtf("GoogleApiManager", ba.l(i2, "Could not find API instance ", " while trying to fail enqueued calls."), new Exception());
                    break;
                }
            case 6:
