...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final android.app.Dialog zaa(@androidx.annotation.NonNull android.content.Context r6, int r7, @androidx.annotation.Nullable com.google.android.gms.common.internal.zag r8, @androidx.annotation.Nullable android.content.DialogInterface.OnCancelListener r9, @androidx.annotation.Nullable android.content.DialogInterface.OnClickListener r10) {
        ...
        L_0x004b:
            ...
            r0.setTitle(r6)
        L_0x0054:
            java.lang.String r6 = "Creating dialog for Google Play services availability issue. ConnectionResult="
            java.lang.String r6 = defpackage.ba.k(r7, r6)
    ...
    public final void zae(Context context, int i, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        int i2;
        String str2;
        Log.w("GoogleApiAvailability", ba.l(i, "GMS core API Availability. ConnectionResult=", ", tag=null"), new IllegalArgumentException());
        if (i == 18) {
            zaf(context);
            ...
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (str2 == null) {
                    ...
                    NotificationChannel c = notificationManager.getNotificationChannel("com.google.android.gms.availability");
                    String string = context.getResources().getString(R.string.common_google_play_services_notification_channel_name);
                    if (c == null) {
                        notificationManager.createNotificationChannel(u5.e(string));
                    } else if (!string.contentEquals(c.getName())) {
                        c.setName(string);
