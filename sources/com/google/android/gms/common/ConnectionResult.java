...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public ConnectionResult(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) @Nullable PendingIntent pendingIntent, @SafeParcelable.Param(id = 4) @Nullable String str) {
        this.zza = i;
        this.zzb = i2;
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        return ba.l(i, "UNKNOWN_ERROR_CODE(", ")");
                }
        }
    }
