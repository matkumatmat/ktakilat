...
final class zzp implements ServiceConnection {
    ...
    public final synchronized void zzf() {
        /*
            r2 = this;
            monitor-enter(r2)
            int r0 = r2.zza     // Catch:{ all -> 0x002d }
            r1 = 2
            if (r0 != r1) goto L_0x002f
            java.util.Queue r0 = r2.zzd     // Catch:{ all -> 0x002d }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x002d }
            if (r0 == 0) goto L_0x002f
            android.util.SparseArray r0 = r2.zze     // Catch:{ all -> 0x002d }
            int r0 = r0.size()     // Catch:{ all -> 0x002d }
            if (r0 != 0) goto L_0x002f
            java.lang.String r0 = "MessengerIpcClient"
            android.util.Log.isLoggable(r0, r1)     // Catch:{ all -> 0x002d }
            r0 = 3
            r2.zza = r0     // Catch:{ all -> 0x002d }
            com.google.android.gms.cloudmessaging.zzv r0 = r2.zzf     // Catch:{ all -> 0x002d }
            com.google.android.gms.common.stats.ConnectionTracker r1 = com.google.android.gms.common.stats.ConnectionTracker.getInstance()     // Catch:{ all -> 0x002d }
            android.content.Context r0 = r0.zzb     // Catch:{ all -> 0x002d }
            r1.unbindService(r0, r2)     // Catch:{ all -> 0x002d }
            monitor-exit(r2)
            return
        L_0x002d:
            r0 = move-exception
