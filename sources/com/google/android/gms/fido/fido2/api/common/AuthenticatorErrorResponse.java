...
public class AuthenticatorErrorResponse extends AuthenticatorResponse {
    ...
    public AuthenticatorErrorResponse(@SafeParcelable.Param(id = 2) @NonNull int i, @SafeParcelable.Param(id = 3) @Nullable String str, @SafeParcelable.Param(id = 4) int i2) {
        try {
