...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    public KeyHandle(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) byte[] bArr, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) @Nullable List list) {
        this.zza = i;
        this.zzb = bArr;
        try {
