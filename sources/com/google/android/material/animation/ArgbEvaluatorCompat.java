...
public class ArgbEvaluatorCompat implements TypeEvaluator<Integer> {
    ...
    public Integer evaluate(float f, Integer num, Integer num2) {
        ...
        float a2 = e.a(((float) ((intValue2 >> 24) & 255)) / 255.0f, f2, f, f2);
        float a3 = e.a(pow4, pow, f, pow);
        float a4 = e.a((float) Math.pow((double) (((float) ((intValue2 >> 8) & 255)) / 255.0f), 2.2d), pow2, f, pow2);
        float a5 = e.a((float) Math.pow((double) (((float) (intValue2 & 255)) / 255.0f), 2.2d), pow3, f, pow3);
