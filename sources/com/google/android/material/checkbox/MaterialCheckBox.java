...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int FRAMEWORK_BUTTON_DRAWABLE_RES_ID = Resources.getSystem().getIdentifier("btn_check_material_anim", "drawable", FaceEnvironment.OS);
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            ...
            return ba.r(sb, getCheckedStateString(), "}");
        }
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (!this.broadcasting) {
                ...
                if (Build.VERSION.SDK_INT >= 26 && (g = sd.g(getContext().getSystemService(sd.i()))) != null) {
                    g.notifyValueChanged(this);
                }
