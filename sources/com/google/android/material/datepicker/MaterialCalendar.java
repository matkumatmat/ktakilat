...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    @NonNull
    public static <T> MaterialCalendar<T> newInstance(@NonNull DateSelector<T> dateSelector2, @StyleRes int i, @NonNull CalendarConstraints calendarConstraints2, @Nullable DayViewDecorator dayViewDecorator2) {
