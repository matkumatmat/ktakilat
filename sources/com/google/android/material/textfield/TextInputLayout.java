...
public class TextInputLayout extends LinearLayout {
    ...
    private void assignBoxBackgroundByMode() {
        ...
        if (i == 0) {
            ...
            throw new IllegalArgumentException(ba.q(new StringBuilder(), " is illegal; only @BoxBackgroundMode constants are supported.", this.boxBackgroundMode));
        }
    }
    ...
    private void updateCursorColor() {
        ...
        if (editText2 != null && editText2.getTextCursorDrawable() != null) {
            Drawable c = this.editText.getTextCursorDrawable();
            if (isOnError() && (colorStateList = this.cursorErrorColor) != null) {
                colorStateList2 = colorStateList;
            }
            DrawableCompat.setTintList(c, colorStateList2);
        }
    }
    ...
    public TextInputLayout(@androidx.annotation.NonNull android.content.Context r22, @androidx.annotation.Nullable android.util.AttributeSet r23, int r24) {
        ...
        L_0x0201:
            ...
            android.content.res.ColorStateList r4 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r11, (androidx.appcompat.widget.TintTypedArray) r1, (int) r3)
            int r3 = r1.getColor(r3, r13)
