...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class DrawableHelperV29 {
        ...
        @DoNotInline
        @Nullable
        public static ColorStateList maybeGetBackgroundCSL(@Nullable Drawable drawable) {
            if (i.r(drawable)) {
                return i.e(drawable).getColorStateList();
            }
            return null;
        }
    }
    ...
    private void initializeLiftOnScrollWithColor(MaterialShapeDrawable materialShapeDrawable) {
        ...
        this.liftOnScrollColorUpdateListener = new y(this, materialShapeDrawable, 1);
    }

    private void initializeLiftOnScrollWithElevation(Context context, MaterialShapeDrawable materialShapeDrawable) {
        materialShapeDrawable.initializeElevationOverlay(context);
        this.liftOnScrollColorUpdateListener = new y(this, materialShapeDrawable, 0);
    }
    ...
    public AppBarLayout(@androidx.annotation.NonNull android.content.Context r10, @androidx.annotation.Nullable android.util.AttributeSet r11, int r12) {
        ...
        L_0x002f:
            ...
            r9.initializeLiftOnScrollWithColor(r1)
            goto L_0x0065
        L_0x0062:
