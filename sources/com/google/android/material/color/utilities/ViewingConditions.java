...
public final class ViewingConditions {
    ...
    public static ViewingConditions make(double[] dArr, double d, double d2, double d3, boolean z2) {
        ...
        if (z2) {
            ...
            d4 = (1.0d - (Math.exp(((-d5) - 42.0d) / 92.0d) * 0.2777777777777778d)) * d13;
        }
        double clampDouble = MathUtils.clampDouble(0.0d, 1.0d, d4);
        ...
        double d18 = 1.0d - d17;
        double cbrt = (Math.cbrt(d15) * 0.1d * d18 * d18) + (d17 * d5);
        ...
        return new ViewingConditions(d19, ((dArr8[2] * 0.05d) + (dArr8[0] * 2.0d) + dArr8[1]) * pow, d20, d21, d14, d13, dArr6, cbrt, Math.pow(cbrt, 0.25d), sqrt);
    }
