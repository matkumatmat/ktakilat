...
public class HctSolver {
    ...
    public static int findResultByJ(double r34, double r36, double r38) {
        ...
        L_0x0075:
            ...
            double r9 = r9 + r0
            r12 = 4627167142146473984(0x4037000000000000, double:23.0)
            double r9 = r9 * r12
            double r9 = r9 * r4
            double r13 = r22 * r12
            ...
            double r26 = r26 * r17
            double r26 = r26 + r13
            r12 = 4637300241308057600(0x405b000000000000, double:108.0)
            double r4 = r4 * r12
            double r4 = r4 * r15
            double r4 = r4 + r26
            double r9 = r9 / r4
            double r4 = r9 * r17
            double r9 = r9 * r15
            r12 = 4646800021772042240(0x407cc00000000000, double:460.0)
            double r0 = r0 * r12
            r12 = 4646641692097642496(0x407c300000000000, double:451.0)
            double r12 = r12 * r4
            double r12 = r12 + r0
            r26 = 4643774165772402688(0x4072000000000000, double:288.0)
            double r26 = r26 * r9
            double r26 = r26 + r12
            r12 = 4653885274701430784(0x4095ec0000000000, double:1403.0)
            double r26 = r26 / r12
            ...
            double r0 = r0 - r9
            double r0 = r0 / r12
            double r4 = inverseChromaticAdaptation(r26)
            double r9 = inverseChromaticAdaptation(r28)
            double r0 = inverseChromaticAdaptation(r0)
            r12 = 3
            ...
            r5 = 2
            r12[r5] = r0
            double[][] r0 = LINRGB_FROM_SCALED_DISCOUNT
            double[] r0 = com.google.android.material.color.utilities.MathUtils.matrixMultiply(r12, r0)
            r9 = r0[r19]
            ...
            if (r1 < 0) goto L_0x018d
            r26 = r0[r5]
            int r1 = (r26 > r20 ? 1 : (r26 == r20 ? 0 : -1))
            if (r1 >= 0) goto L_0x0131
            goto L_0x018d
        L_0x0131:
            double[] r1 = Y_FROM_LINRGB
            r28 = r1[r19]
            r30 = r1[r4]
            r32 = r1[r5]
            double r28 = r28 * r9
        ...
        L_0x0148:
            ...
            double r4 = r32 - r38
            double r9 = java.lang.Math.abs(r4)
        ...
        L_0x016f:
            r2 = r0[r19]
            r4 = 4636737995042078065(0x405900a3d70a3d71, double:100.01)
            ...
            goto L_0x018d
        L_0x0188:
            int r0 = com.google.android.material.color.utilities.ColorUtils.argbFromLinrgb(r0)
            return r0
        L_0x018d:
            return r19
        */
    ...
    public static double[] lerpPoint(double[] dArr, double d, double[] dArr2) {
        double d2 = dArr[0];
        double d3 = dArr[1];
        double d4 = ((dArr2[1] - d3) * d) + d3;
        double d5 = dArr[2];
        return new double[]{((dArr2[0] - d2) * d) + d2, d4, ((dArr2[2] - d5) * d) + d5};
    }
