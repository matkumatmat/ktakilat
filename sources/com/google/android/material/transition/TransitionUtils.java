...
class TransitionUtils {
    ...
    public static View findAncestorById(View view, @IdRes int i) {
        ...
        throw new IllegalArgumentException(e.l(resourceName, " is not a valid ancestor"));
    }
    ...
    public static PathMotion resolveThemePath(Context context, @AttrRes int i) {
        ...
        if (i2 == 16) {
            ...
            throw new IllegalArgumentException(ba.k(i3, "Invalid motion path type: "));
        } else if (i2 == 3) {
