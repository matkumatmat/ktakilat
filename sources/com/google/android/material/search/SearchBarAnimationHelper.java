...
class SearchBarAnimationHelper {
    ...
    private ValueAnimator.AnimatorUpdateListener getExpandedViewBackgroundUpdateListener(SearchBar searchBar, View view) {
        ...
        return new d(view, createWithElevationOverlay);
    }
    ...
    public void startExpandAnimation(SearchBar searchBar, View view, @Nullable AppBarLayout appBarLayout, boolean z) {
        Animator animator;
        ...
        view.post(new c(this, searchBar, view, appBarLayout, z));
    }
    ...
    public void startOnLoadAnimation(SearchBar searchBar) {
        ...
        if (centerView instanceof AnimatableView) {
            ((AnimatableView) centerView).startAnimation(new lb(secondaryViewAnimator2, 16));
