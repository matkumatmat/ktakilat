...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public void onAttachedToWindow() {
        WindowInsets p;
        if (Build.VERSION.SDK_INT >= 29 && (p = this.view.getRootWindowInsets()) != null) {
            this.extraBottomMarginGestureInset = p.getMandatorySystemGestureInsets().bottom;
            updateMargins();
        }
    }
    ...
    public BaseTransientBottomBar(@NonNull Context context2, @NonNull ViewGroup viewGroup, @NonNull View view2, @NonNull ContentViewCallback contentViewCallback2) {
        ...
        if (viewGroup == null) {
            ...
            this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context2, i, DEFAULT_ANIMATION_FADE_IN_DURATION);
    ...
    public B setAnchorView(@IdRes int i) {
        ...
        throw new IllegalArgumentException(ba.k(i, "Unable to find anchor view with id: "));
    }
}
