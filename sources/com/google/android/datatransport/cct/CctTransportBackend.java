...
final class CctTransportBackend implements TransportBackend {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            for (EventInternal eventInternal2 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.of("proto"))) {
                    ...
                    builder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName(CharEncoding.UTF_8)));
                } else {
    ...
    private static URL parseUrlOrThrow(String str) {
        try {
            ...
            throw new IllegalArgumentException(e.B("Invalid url: ", str), e);
        }
    }
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.google.android.datatransport.runtime.retries.RetryStrategy, java.lang.Object] */
