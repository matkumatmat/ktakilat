...
final class MathPreconditions {
    ...
    public static void checkNoOverflow(boolean z, String str, int i, int i2) {
        if (!z) {
            StringBuilder sb = new StringBuilder(ba.e(36, str));
            sb.append("overflow: ");
            sb.append(str);
            sb.append("(");
            sb.append(i);
    ...
    public static int checkNonNegative(String str, int i) {
        ...
        StringBuilder sb = new StringBuilder(ba.e(27, str));
        sb.append(str);
        sb.append(" (");
        sb.append(i);
        sb.append(") must be >= 0");
    ...
    public static int checkPositive(String str, int i) {
        ...
        StringBuilder sb = new StringBuilder(ba.e(26, str));
        sb.append(str);
        sb.append(" (");
        sb.append(i);
        sb.append(") must be > 0");
    ...
    public static void checkNoOverflow(boolean z, String str, long j, long j2) {
        if (!z) {
            StringBuilder sb = new StringBuilder(ba.e(54, str));
            sb.append("overflow: ");
            sb.append(str);
            sb.append("(");
            sb.append(j);
    ...
    public static long checkPositive(String str, long j) {
        ...
        StringBuilder sb = new StringBuilder(ba.e(35, str));
        sb.append(str);
        sb.append(" (");
        sb.append(j);
        sb.append(") must be > 0");
    ...
    public static BigInteger checkNonNegative(String str, BigInteger bigInteger) {
        ...
        throw new IllegalArgumentException(e.i(valueOf.length() + ba.e(16, str), str, " (", valueOf, ") must be >= 0"));
    }
    ...
    public static BigInteger checkPositive(String str, BigInteger bigInteger) {
        ...
        String valueOf = String.valueOf(bigInteger);
        throw new IllegalArgumentException(e.i(valueOf.length() + ba.e(15, str), str, " (", valueOf, ") must be > 0"));
    }
    ...
    public static double checkNonNegative(String str, double d) {
        ...
        StringBuilder sb = new StringBuilder(ba.e(40, str));
        sb.append(str);
        sb.append(" (");
        sb.append(d);
        sb.append(") must be >= 0");
