...
public final class MediaType {
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, (Iterable<? extends Map.Entry<?, ?>>) Multimaps.transformValues(this.parameters, new nc(0)).entries());
        }
        return sb.toString();
    }
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new nc(1));
    }
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(ba.m(ba.e(18, str), "Could not parse '", str, "'"), e);
        }
    }
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    ...
                    throw new IllegalStateException(e.i(ba.e(str.length() + 35, str2), "Multiple charset values defined: ", str, ", ", str2));
                }
            }
