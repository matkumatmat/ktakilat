...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    public static class Builder<K, V> {
        ...
        public static final class DuplicateKey {
            ...
            public IllegalArgumentException exception() {
                ...
                StringBuilder u = ba.u(valueOf4.length() + valueOf3.length() + valueOf2.length() + valueOf.length() + 39, "Multiple entries with same key: ", valueOf, "=", valueOf2);
                u.append(" and ");
                u.append(valueOf3);
                u.append("=");
                u.append(valueOf4);
    ...
    public static IllegalArgumentException conflictException(String str, Object obj, Object obj2) {
        ...
        return new IllegalArgumentException(ba.r(ba.u(valueOf2.length() + valueOf.length() + ba.e(34, str), "Multiple entries with same ", str, ": ", valueOf), " and ", valueOf2));
    }
