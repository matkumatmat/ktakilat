...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        if (readInt >= 0) {
            ...
            while (i < readInt) {
                ...
                if (readInt2 > 0) {
                    ...
                    if (build.size() == readInt2) {
                        ...
                        throw new InvalidObjectException(e.g(valueOf.length() + 40, "Duplicate key-value pairs exist for key ", valueOf));
                    }
                } else {
                    throw new InvalidObjectException(ba.j(31, readInt2, "Invalid value count "));
                }
            }
            try {
            ...
            throw new InvalidObjectException(ba.j(29, readInt, "Invalid key count "));
        }
    }
