...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    private void deleteFromTableKToV(int i, int i2) {
        ...
        while (true) {
            ...
            if (i3 == -1) {
                ...
                throw new AssertionError(e.g(valueOf.length() + 32, "Expected to find entry with key ", valueOf));
            } else if (i3 == i) {
    ...
    private void deleteFromTableVToK(int i, int i2) {
        ...
        while (true) {
            ...
            if (i3 == -1) {
                ...
                throw new AssertionError(e.g(valueOf.length() + 34, "Expected to find entry with value ", valueOf));
            } else if (i3 == i) {
    ...
    public void replaceKeyInEntry(int i, @ParametricNullness K k, boolean z) {
        ...
        if (findEntryByKey == -1) {
            ...
            throw new IllegalArgumentException(e.g(valueOf.length() + 28, "Key already present in map: ", valueOf));
        }
        if (i3 == i) {
    ...
    public void replaceValueInEntry(int i, @ParametricNullness V v, boolean z) {
        ...
        if (findEntryByValue != -1) {
            if (z) {
                ...
                throw new IllegalArgumentException(e.g(valueOf.length() + 30, "Value already present in map: ", valueOf));
            }
        }
