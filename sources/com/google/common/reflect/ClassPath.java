...
public final class ClassPath {
    ...
    public static final class LocationInfo {
        ...
        private void scan(File file, Set<File> set, ImmutableSet.Builder<ResourceInfo> builder) throws IOException {
            try {
                ...
                access$000.warning(e.i(valueOf2.length() + valueOf.length() + 16, "Cannot access ", valueOf, ": ", valueOf2));
            }
        }
            ...
            for (File file2 : listFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (set.add(canonicalFile)) {
                        scanDirectory(canonicalFile, ba.m(ba.e(ba.e(1, str), name), str, name, RemoteSettings.FORWARD_SLASH_STRING), set, builder);
    ...
    public ImmutableSet<ClassInfo> getTopLevelClasses() {
        return FluentIterable.from(this.resources).filter(ClassInfo.class).filter(new a3(0)).toSet();
    }
