...
final class Types {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            sb.append(access$400.join((Iterable<? extends Object>) Iterables.transform(immutableList, new b(javaVersion2))));
            sb.append('>');
            return sb.toString();
        }
    }
    ...
    public static ParameterizedType newParameterizedTypeWithOwner(@CheckForNull Type type, Class<?> cls, Type... typeArr) {
        ...
        Preconditions.checkArgument(z, "Owner type for unenclosed %s", (Object) cls);
