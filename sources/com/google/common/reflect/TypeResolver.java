...
public final class TypeResolver {
    ...
    public static class WildcardCapturer {
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            ...
            StringBuilder sb = new StringBuilder(ba.e(33, join));
            sb.append("capture#");
    ...
    public static <T> T expectArgument(Class<T> cls, Object obj) {
        try {
            ...
            throw new IllegalArgumentException(ba.m(simpleName.length() + valueOf.length() + 10, valueOf, " is not a ", simpleName));
        }
    }
            ...
            new TypeVisitor() {
                public void visitClass(Class<?> cls) {
                    if (!(type2 instanceof WildcardType)) {
                        ...
                        throw new IllegalArgumentException(e.i(valueOf2.length() + valueOf.length() + 25, "No type mapping from ", valueOf, " to ", valueOf2));
                    }
                }
