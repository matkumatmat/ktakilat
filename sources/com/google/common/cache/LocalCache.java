...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public static final class StrongAccessEntry<K, V> extends StrongEntry<K, V> {
        volatile long accessTime = LocationRequestCompat.PASSIVE_INTERVAL;
        @Weak
    ...
    public static final class StrongAccessWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        volatile long writeTime = LocationRequestCompat.PASSIVE_INTERVAL;
    ...
    public final class WriteThroughEntry implements Map.Entry<K, V> {
        ...
        public String toString() {
            ...
            return ba.m(valueOf2.length() + valueOf.length() + 1, valueOf, "=", valueOf2);
        }
    }
    ...
    public com.google.common.collect.ImmutableMap<K, V> getAll(java.lang.Iterable<? extends K> r8) throws java.util.concurrent.ExecutionException {
        ...
        L_0x0030:
            ...
            java.util.Set r8 = java.util.Collections.unmodifiableSet(r1)     // Catch:{ UnsupportedLoadingOperationException -> 0x007b }
            com.google.common.cache.CacheLoader<? super K, V> r4 = r7.defaultLoader     // Catch:{ UnsupportedLoadingOperationException -> 0x007b }
            java.util.Map r8 = r7.loadAll(r8, r4)     // Catch:{ UnsupportedLoadingOperationException -> 0x007b }
        ...
        L_0x005a:
            ...
            int r5 = r4.length()     // Catch:{ UnsupportedLoadingOperationException -> 0x007b }
            int r5 = r5 + 37
            ...
            r6.append(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x007b }
            r6.append(r4)     // Catch:{ UnsupportedLoadingOperationException -> 0x007b }
            java.lang.String r4 = r6.toString()     // Catch:{ UnsupportedLoadingOperationException -> 0x007b }
    ...
    public Map<K, V> loadAll(Set<? extends K> set, CacheLoader<? super K, V> cacheLoader) throws ExecutionException {
        ...
        try {
            ...
            if (loadAll != null) {
                ...
                throw new CacheLoader.InvalidCacheLoadException(e.g(valueOf.length() + 42, valueOf, " returned null keys or values from loadAll"));
            }
            this.globalStatsCounter.recordLoadException(createStarted.elapsed(TimeUnit.NANOSECONDS));
            String valueOf2 = String.valueOf(cacheLoader);
            throw new CacheLoader.InvalidCacheLoadException(e.g(valueOf2.length() + 31, valueOf2, " returned null map from loadAll"));
