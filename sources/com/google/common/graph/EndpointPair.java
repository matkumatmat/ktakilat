...
public abstract class EndpointPair<N> implements Iterable<N> {
    ...
    public static final class Ordered<N> extends EndpointPair<N> {
        ...
        public String toString() {
            ...
            StringBuilder u = ba.u(valueOf2.length() + valueOf.length() + 6, "<", valueOf, " -> ", valueOf2);
            u.append(">");
            return u.toString();
        }
    ...
    public static final class Unordered<N> extends EndpointPair<N> {
        ...
        public String toString() {
            ...
            StringBuilder u = ba.u(valueOf2.length() + valueOf.length() + 4, "[", valueOf, ", ", valueOf2);
            u.append("]");
            return u.toString();
        }
    ...
    public final N adjacentNode(N n) {
        ...
        throw new IllegalArgumentException(e.i(valueOf2.length() + valueOf.length() + 36, "EndpointPair ", valueOf, " does not contain node ", valueOf2));
    }
