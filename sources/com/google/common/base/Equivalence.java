...
public abstract class Equivalence<T> {
    ...
    public static final class EquivalentToPredicate<T> implements Predicate<T>, Serializable {
        ...
        public EquivalentToPredicate(Equivalence<T> equivalence2, @CheckForNull T t) {
        ...
        public String toString() {
            ...
            return e.i(valueOf2.length() + valueOf.length() + 15, valueOf, ".equivalentTo(", valueOf2, ")");
        }
    }
    ...
    public static final class Wrapper<T> implements Serializable {
        ...
        public String toString() {
            ...
            return e.i(valueOf2.length() + valueOf.length() + 7, valueOf, ".wrap(", valueOf2, ")");
        }
