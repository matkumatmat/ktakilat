...
public final class Predicates {
    ...
    public static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        public String toString() {
            ...
            return e.i(valueOf2.length() + valueOf.length() + 2, valueOf, "(", valueOf2, ")");
        }
    ...
    public static class ContainsPatternFromStringPredicate extends ContainsPatternPredicate {
        ...
        public String toString() {
            ...
            return ba.m(ba.e(28, pattern), "Predicates.containsPattern(", pattern, ")");
        }
    }
    ...
    public static class ContainsPatternPredicate implements Predicate<CharSequence>, Serializable {
        ...
        public String toString() {
            ...
            return ba.m(ba.e(21, toStringHelper), "Predicates.contains(", toStringHelper, ")");
        }
    ...
    public static class InPredicate<T> implements Predicate<T>, Serializable {
        ...
        public String toString() {
            ...
            return ba.m(valueOf.length() + 15, "Predicates.in(", valueOf, ")");
        }
    ...
    public static class InstanceOfPredicate<T> implements Predicate<T>, Serializable {
        ...
        public String toString() {
            ...
            return ba.m(name.length() + 23, "Predicates.instanceOf(", name, ")");
        }
    ...
    public static class IsEqualToPredicate implements Predicate<Object>, Serializable {
        ...
        public String toString() {
            String valueOf = String.valueOf(this.target);
            return ba.m(valueOf.length() + 20, "Predicates.equalTo(", valueOf, ")");
        }
    ...
    public static class NotPredicate<T> implements Predicate<T>, Serializable {
        ...
        public String toString() {
            ...
            return ba.m(valueOf.length() + 16, "Predicates.not(", valueOf, ")");
        }
    }
    ...
    public static class SubtypeOfPredicate implements Predicate<Class<?>>, Serializable {
        ...
        public String toString() {
            String name = this.clazz.getName();
            return ba.m(name.length() + 22, "Predicates.subtypeOf(", name, ")");
        }
