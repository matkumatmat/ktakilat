...
public abstract class BaseEncoding {
    ...
    public static final class Alphabet {
        ...
        public Alphabet(String str, char[] cArr) {
            ...
            try {
                ...
                throw new IllegalArgumentException(ba.j(35, cArr.length, "Illegal alphabet length "), e2);
            }
        }
    ...
    public static final class Base16Encoding extends StandardBaseEncoding {
        ...
        public int decodeTo(byte[] bArr, CharSequence charSequence) throws DecodingException {
            ...
            throw new DecodingException(ba.j(32, charSequence.length(), "Invalid input length "));
        }
    ...
    public static final class Base64Encoding extends StandardBaseEncoding {
        ...
        public int decodeTo(byte[] bArr, CharSequence charSequence) throws DecodingException {
            ...
            throw new DecodingException(ba.j(32, trimTrailingPadding.length(), "Invalid input length "));
        }
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            ...
            while (i2 >= 3) {
                int i4 = (bArr[i] & UnsignedBytes.MAX_VALUE) << Ascii.DLE;
                int i5 = i + 2;
                i += 3;
                byte b = ((bArr[i + 1] & UnsignedBytes.MAX_VALUE) << 8) | i4 | (bArr[i5] & UnsignedBytes.MAX_VALUE);
    ...
    public static final class SeparatedBaseEncoding extends BaseEncoding {
        ...
        public String toString() {
            ...
            return ba.q(ba.u(ba.e(valueOf.length() + 31, str), valueOf, ".withSeparator(\"", str, "\", "), ")", this.afterEveryChars);
        }
                ...
                public int read() throws IOException {
                    ...
                    while (true) {
                        ...
                        if (read != -1) {
                            ...
                            throw new DecodingException(ba.j(32, this.readChars, "Invalid input length "));
                        }
                    }
                    throw new DecodingException(ba.j(41, this.readChars, "Padding cannot start at index "));
                }
