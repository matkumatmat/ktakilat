...
public final class ByteStreams {
    ...
    public static int read(InputStream inputStream, byte[] bArr, int i, int i2) throws IOException {
        ...
        throw new IndexOutOfBoundsException(ba.l(i2, "len (", ") cannot be negative"));
    }
    ...
    public static void skipFully(InputStream inputStream, long j) throws IOException {
        ...
        if (skipUpTo < j) {
            ...
            sb.append(skipUpTo);
            sb.append(" bytes; ");
            throw new EOFException(ba.p(sb, j, " bytes expected"));
        }
    }
    ...
    public static ByteArrayDataOutput newDataOutput(int i) {
        ...
        throw new IllegalArgumentException(ba.k(i, "Invalid size: "));
    }
