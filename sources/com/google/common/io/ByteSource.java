...
public abstract class ByteSource {
    ...
    public class AsCharSource extends CharSource {
        ...
        public String toString() {
            ...
            return e.i(valueOf.length() + ba.e(15, obj), obj, ".asCharSource(", valueOf, ")");
        }
    }
    ...
    public static class ByteArrayByteSource extends ByteSource {
        ...
        public ByteSource slice(long j, long j2) {
            ...
            long min2 = Math.min(j2, ((long) this.length) - min);
        ...
        public String toString() {
            ...
            return ba.m(ba.e(17, truncate), "ByteSource.wrap(", truncate, ")");
        }
    ...
    public static final class ConcatenatedByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            return ba.m(valueOf.length() + 19, "ByteSource.concat(", valueOf, ")");
        }
    }
    ...
    public final class SlicedByteSource extends ByteSource {
        ...
        public SlicedByteSource(long j, long j2) {
            ...
            Preconditions.checkArgument(z, "offset (%s) may not be negative", j);
            Preconditions.checkArgument(j2 >= 0 ? true : z2, "length (%s) may not be negative", j2);
            this.offset = j;
            this.length = j2;
        }
        ...
        public String toString() {
            ...
            long j = this.offset;
            long j2 = this.length;
            StringBuilder sb = new StringBuilder(ba.e(50, obj));
            sb.append(obj);
            sb.append(".slice(");
            sb.append(j);
            sb.append(", ");
