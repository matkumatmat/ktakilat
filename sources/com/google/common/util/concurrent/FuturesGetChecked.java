...
final class FuturesGetChecked {
    ...
    private static <X extends Exception> X newWithCause(Class<X> cls, Throwable th) {
        ...
        throw new IllegalArgumentException(ba.m(valueOf.length() + 82, "No appropriate constructor for exception of type ", valueOf, " in response to chained exception"), th);
    }
