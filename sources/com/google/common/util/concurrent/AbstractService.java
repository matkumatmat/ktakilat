...
public abstract class AbstractService implements Service {
    ...
    public static final class StateSnapshot {
        ...
        public Throwable failureCause() {
            ...
            Preconditions.checkState(z, "failureCause() is only valid if the service has failed, service is %s", (Object) state2);
            Throwable th = this.failure;
            Objects.requireNonNull(th);
            return th;
        }

        public StateSnapshot(Service.State state2, boolean z, @CheckForNull Throwable th) {
            boolean z2 = true;
            ...
            Preconditions.checkArgument((th != null) != (state2 == Service.State.FAILED) ? false : z2, "A failure cause should be set if and only if the state is failed.  Got %s and %s instead.", (Object) state2, (Object) th);
            this.state = state2;
    ...
    private void checkCurrentState(Service.State state) {
        ...
        if (state2 == Service.State.FAILED) {
            ...
            StringBuilder u = ba.u(valueOf2.length() + valueOf.length() + 56, "Expected the service ", valueOf, " to be ", valueOf2);
            u.append(", but the service has FAILED");
            throw new IllegalStateException(u.toString(), failureCause());
        }
        String valueOf3 = String.valueOf(this);
        String valueOf4 = String.valueOf(state);
        String valueOf5 = String.valueOf(state2);
        throw new IllegalStateException(ba.r(ba.u(valueOf5.length() + valueOf4.length() + valueOf3.length() + 38, "Expected the service ", valueOf3, " to be ", valueOf4), ", but was ", valueOf5));
    }
    ...
    private void enqueueFailedEvent(final Service.State state, final Throwable th) {
        this.listeners.enqueue(new ListenerCallQueue.Event<Service.Listener>(this) {
            public String toString() {
                ...
                StringBuilder u = ba.u(valueOf2.length() + valueOf.length() + 27, "failed({from = ", valueOf, ", cause = ", valueOf2);
                u.append("})");
                return u.toString();
            }
    ...
    private static ListenerCallQueue.Event<Service.Listener> stoppingEvent(final Service.State state) {
        return new ListenerCallQueue.Event<Service.Listener>() {
            public String toString() {
                ...
                return ba.m(valueOf.length() + 19, "stopping({from = ", valueOf, "})");
            }
    ...
    private static ListenerCallQueue.Event<Service.Listener> terminatedEvent(final Service.State state) {
        return new ListenerCallQueue.Event<Service.Listener>() {
            public String toString() {
                String valueOf = String.valueOf(Service.State.this);
                return ba.m(valueOf.length() + 21, "terminated({from = ", valueOf, "})");
            }
    ...
    public final Service startAsync() {
        ...
        String valueOf = String.valueOf(this);
        throw new IllegalStateException(ba.m(valueOf.length() + 33, "Service ", valueOf, " has already been started"));
    }
    ...
    public String toString() {
        ...
        String valueOf = String.valueOf(state());
        return e.i(valueOf.length() + simpleName.length() + 3, simpleName, " [", valueOf, "]");
    }
    ...
    public final void awaitRunning(long j, TimeUnit timeUnit) throws TimeoutException {
        if (this.monitor.enterWhenUninterruptibly(this.hasReachedRunning, j, timeUnit)) {
            ...
            String valueOf = String.valueOf(this);
            throw new TimeoutException(ba.m(valueOf.length() + 50, "Timed out waiting for ", valueOf, " to reach the RUNNING state."));
        }
    }
    ...
    public final void awaitTerminated(long j, TimeUnit timeUnit) throws TimeoutException {
        if (this.monitor.enterWhenUninterruptibly(this.isStopped, j, timeUnit)) {
            ...
            String valueOf = String.valueOf(this);
            String valueOf2 = String.valueOf(state());
            throw new TimeoutException(e.i(valueOf2.length() + valueOf.length() + 65, "Timed out waiting for ", valueOf, " to reach a terminal state. Current state: ", valueOf2));
        }
    }
}
