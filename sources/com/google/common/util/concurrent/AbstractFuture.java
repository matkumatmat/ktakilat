...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        public boolean casListeners(AbstractFuture<?> abstractFuture, @CheckForNull Listener listener, Listener listener2) {
            return b.a(UNSAFE, abstractFuture, LISTENERS_OFFSET, listener, listener2);
        }

        public boolean casValue(AbstractFuture<?> abstractFuture, @CheckForNull Object obj, Object obj2) {
            return b.a(UNSAFE, abstractFuture, VALUE_OFFSET, obj, obj2);
        }

        public boolean casWaiters(AbstractFuture<?> abstractFuture, @CheckForNull Waiter waiter, @CheckForNull Waiter waiter2) {
            return b.a(UNSAFE, abstractFuture, WAITERS_OFFSET, waiter, waiter2);
        }
    ...
    private void addPendingString(StringBuilder sb) {
        ...
        if (obj instanceof SetFuture) {
            ...
            try {
                ...
                str = e.g(valueOf.length() + 38, "Exception thrown from implementation: ", valueOf);
            }
            if (str != null) {
                sb.append(", info=[");
                sb.append(str);
    ...
    public static Object getFutureValue(ListenableFuture<?> listenableFuture) {
        ...
        if (listenableFuture instanceof Trusted) {
            ...
            try {
                ...
                return new Cancellation(false, new IllegalArgumentException(e.g(valueOf2.length() + 84, "get() did not throw CancellationException, despite reporting isCancelled() == true: ", valueOf2), e));
            } catch (CancellationException e2) {
                if (isCancelled) {
                    return new Cancellation(false, e2);
                }
                String valueOf3 = String.valueOf(listenableFuture);
                return new Failure(new IllegalArgumentException(e.g(valueOf3.length() + 77, "get() threw CancellationException, despite reporting isCancelled() == false: ", valueOf3), e2));
            } catch (Throwable th) {
    ...
    public V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            StringBuilder sb = new StringBuilder(ba.e(28, lowerCase2));
            sb.append("Waited ");
            sb.append(j2);
            ...
            if (nanos + 1000 < 0) {
                ...
                if (i > 0) {
                    ...
                    StringBuilder sb3 = new StringBuilder(ba.e(valueOf.length() + 21, lowerCase));
                    sb3.append(valueOf);
                    sb3.append(convert);
            ...
            throw new TimeoutException(ba.m(ba.e(ba.e(5, sb2), abstractFuture), sb2, " for ", abstractFuture));
        }
        throw new InterruptedException();
    }
