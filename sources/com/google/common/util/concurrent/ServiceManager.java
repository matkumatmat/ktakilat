...
public final class ServiceManager implements ServiceManagerBridge {
        ...
        public void failed(Service.State state2, Throwable th) {
            ...
            if (serviceManagerState != null) {
                if (!(this.service instanceof NoOpService)) {
                    ...
                    StringBuilder u = ba.u(valueOf2.length() + valueOf.length() + 34, "Service ", valueOf, " has failed in the ", valueOf2);
                    u.append(" state.");
                    access$200.log(level, u.toString(), th);
                }
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        while (it.hasNext()) {
            ...
            Preconditions.checkArgument(z, "Can only manage NEW services, %s", (Object) service);
        }
    ...
    public ServiceManager startAsync() {
        ...
        while (it.hasNext()) {
            ...
            Preconditions.checkState(z, "Not all services are NEW, cannot start %s", (Object) this);
        }
        ...
        while (it2.hasNext()) {
            ...
            try {
                ...
                logger2.log(level, e.g(valueOf.length() + 24, "Unable to start Service ", valueOf), e);
            }
        }
        return this;
    }
    ...
    public static final class ServiceManagerState {
        ...
        public void checkHealthy() {
            ...
            if (multiset.count(state) != this.numberOfServices) {
                ...
                throw new IllegalStateException(e.g(valueOf.length() + 79, "Expected to be healthy after starting. The following services are not running: ", valueOf));
            }
        }
        ...
        public void enqueueFailedEvent(final Service service) {
            this.listeners.enqueue(new ListenerCallQueue.Event<Listener>(this) {
                public String toString() {
                    ...
                    return ba.m(valueOf.length() + 18, "failed({service=", valueOf, "})");
                }
