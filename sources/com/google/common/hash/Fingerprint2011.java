...
final class Fingerprint2011 extends AbstractNonStreamingHashFunction {
    ...
    public static long fingerprint(byte[] bArr, int i, int i2) {
        ...
        long j3 = K0;
        if (i2 >= 8) {
            j2 = LittleEndianByteArray.load64(bArr, i);
        } else {
            j2 = -6505348102511208375L;
        }
        if (i2 >= 9) {
            j3 = LittleEndianByteArray.load64(bArr, (i + i2) - 8);
        }
        long hash128to64 = hash128to64(j + j3, j2);
    ...
    private static long fullFingerprint(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            weakHashLength32WithSeeds(bArr4, i5 + 32, rotateRight5 + jArr2[1], j3, jArr2);
            i5 += 64;
            i6 -= 64;
            if (i6 == 0) {
                return hash128to64((shiftMix(j3) * K1) + hash128to64(jArr3[0], jArr2[0]) + j2, hash128to64(jArr3[1], jArr2[1]) + rotateRight5);
            }
            shiftMix = j2;
            rotateRight2 = j3;
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        int i4 = i + i3;
        int i5 = i4 - 16;
        long load642 = ((j + LittleEndianByteArray.load64(bArr2, i5)) * K0) + LittleEndianByteArray.load64(bArr, i);
        ...
        return shiftMix((shiftMix(((load648 + load646 + rotateRight4) * K0) + ((Long.rotateRight(load648, 31) + rotateRight5 + Long.rotateRight(load647, 7) + rotateRight6 + j2) * K2)) * K0) + rotateRight4) * K2;
    }
