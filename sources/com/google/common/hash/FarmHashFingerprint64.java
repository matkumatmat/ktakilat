...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        if (i2 >= 8) {
            ...
            return shiftMix((((long) ((bArr[i] & UnsignedBytes.MAX_VALUE) + ((bArr[(i2 >> 1) + i] & UnsignedBytes.MAX_VALUE) << 8))) * K2) ^ (((long) (i2 + ((bArr[(i2 - 1) + i] & UnsignedBytes.MAX_VALUE) << 2))) * K0)) * K2;
        }
    }
    ...
    private static long hashLength17to32(byte[] bArr, int i, int i2) {
        ...
        return hashLength16((LittleEndianByteArray.load64(bArr2, i3 - 16) * K2) + Long.rotateRight(load643, 30) + Long.rotateRight(load64 + load642, 43), Long.rotateRight(load642 + K2, 18) + load64 + load643, j);
    }
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        int i3 = i + i2;
        long load643 = LittleEndianByteArray.load64(bArr2, i3 - 8) * j;
        long rotateRight = Long.rotateRight(load643, 30) + Long.rotateRight(load64 + load642, 43) + (LittleEndianByteArray.load64(bArr2, i3 - 16) * K2);
        ...
        return hashLength16(((hashLength16 + LittleEndianByteArray.load64(bArr2, i3 - 24)) * j) + Long.rotateRight(load646, 30) + Long.rotateRight(load644 + load645, 43), Long.rotateRight(load645 + load64, 18) + load644 + load646, j);
    }
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            long load642 = jArr[0] + LittleEndianByteArray.load64(bArr2, i8 + 40) + rotateRight2;
            ...
            if (i9 == i4) {
                ...
                long load643 = (jArr[0] * 9) + LittleEndianByteArray.load64(bArr2, i6 - 23) + (Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bArr2, i6 - 15), 42) * j4);
                ...
                weakHashLength32WithSeeds(bArr3, i6 - 31, rotateRight5 + jArr2[1], load643 + LittleEndianByteArray.load64(bArr2, i6 - 47), jArr2);
                long j7 = j4;
                return hashLength16((shiftMix(load643) * K0) + hashLength16(jArr[0], jArr2[0], j7) + rotateRight4, hashLength16(jArr[1], jArr2[1], j7) + rotateRight5, j7);
            }
            i8 = i9;
            shiftMix = j3;
            j2 = load642;
