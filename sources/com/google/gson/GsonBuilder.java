...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i, int i2, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !"".equals(str.trim())) {
            defaultDateTypeAdapter2 = new DefaultDateTypeAdapter((Class<? extends java.util.Date>) cls3, str);
            defaultDateTypeAdapter = new DefaultDateTypeAdapter((Class<? extends java.util.Date>) cls2, str);
            defaultDateTypeAdapter3 = new DefaultDateTypeAdapter((Class<? extends java.util.Date>) cls, str);
        } else if (i != 2 && i2 != 2) {
            DefaultDateTypeAdapter defaultDateTypeAdapter4 = new DefaultDateTypeAdapter(cls3, i, i2);
            DefaultDateTypeAdapter defaultDateTypeAdapter5 = new DefaultDateTypeAdapter(cls2, i, i2);
            DefaultDateTypeAdapter defaultDateTypeAdapter6 = new DefaultDateTypeAdapter(cls, i, i2);
        ...
        list.add(TypeAdapters.newFactory(cls3, defaultDateTypeAdapter2));
        list.add(TypeAdapters.newFactory(cls2, defaultDateTypeAdapter));
        list.add(TypeAdapters.newFactory(cls, defaultDateTypeAdapter3));
    }
