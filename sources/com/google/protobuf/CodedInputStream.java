...
public abstract class CodedInputStream {
            ...
            if (i2 != i) {
                ...
                if (b3 >= 0) {
                    ...
                    if (b4 < 0) {
                        ...
                        if (b5 >= 0) {
                            b2 = b5 ^ UnsignedBytes.MAX_POWER_OF_TWO;
                        } else {
                            int i6 = i + 4;
                            ...
                            if (b6 < 0) {
                                ...
                                i5 = i + 5;
                                byte b7 = bArr[i6];
                                byte b8 = (b6 ^ (b7 << Ascii.FS)) ^ UnsignedBytes.MAX_POWER_OF_TWO;
                                if (b7 < 0) {
                                    i6 = i + 6;
                                    if (bArr[i5] < 0) {
                                        i5 = i + 7;
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return ((UnsafeUtil.getByte(j + 3) & UnsignedBytes.MAX_VALUE) << Ascii.CAN) | (UnsafeUtil.getByte(j) & UnsignedBytes.MAX_VALUE) | ((UnsafeUtil.getByte(1 + j) & UnsignedBytes.MAX_VALUE) << 8) | ((UnsafeUtil.getByte(2 + j) & UnsignedBytes.MAX_VALUE) << Ascii.DLE);
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            long j2 = (((long) UnsafeUtil.getByte(j)) & 255) | ((((long) UnsafeUtil.getByte(1 + j)) & 255) << 8);
            return ((((long) UnsafeUtil.getByte(j + 7)) & 255) << 56) | ((((long) UnsafeUtil.getByte(2 + j)) & 255) << 16) | j2 | ((((long) UnsafeUtil.getByte(3 + j)) & 255) << 24) | ((((long) UnsafeUtil.getByte(4 + j)) & 255) << 32) | ((((long) UnsafeUtil.getByte(5 + j)) & 255) << 40) | ((((long) UnsafeUtil.getByte(6 + j)) & 255) << 48);
        }
    ...
    public static final class StreamDecoder extends CodedInputStream {
        ...
        private boolean tryRefillBuffer(int i) throws IOException {
            ...
            if (i2 + i > this.bufferSize) {
                ...
                throw new IllegalStateException(ba.l(i, "refillBuffer() called when ", " bytes were already available in buffer"));
            }
        }
    ...
    public final int setRecursionLimit(int i) {
        ...
        throw new IllegalArgumentException(ba.k(i, "Recursion limit cannot be negative: "));
    }
    ...
    public final int setSizeLimit(int i) {
        ...
        throw new IllegalArgumentException(ba.k(i, "Size limit cannot be negative: "));
    }
