        ...
        public final void encodeUtf8Default(CharSequence charSequence, ByteBuffer byteBuffer) {
            ...
            while (i2 < length) {
                try {
                    ...
                    throw new ArrayIndexOutOfBoundsException("Failed writing " + charSequence.charAt(i2) + " at index " + (Math.max(i2, (position - byteBuffer.position()) + 1) + position2));
                }
            }
            if (i2 == length) {
            ...
            while (i2 < length) {
                ...
                if (charAt2 < 128) {
                    ...
                    try {
                        ...
                        throw new ArrayIndexOutOfBoundsException("Failed writing " + charSequence.charAt(i2) + " at index " + (Math.max(i2, (position - byteBuffer.position()) + 1) + position22));
                    }
                    ...
                    if (i3 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        throw new ArrayIndexOutOfBoundsException("Failed writing " + charSequence.charAt(i2) + " at index " + (Math.max(i2, (position - byteBuffer.position()) + 1) + position222));
                                    }
                                } catch (IndexOutOfBoundsException unused4) {
                                    position = i4;
                                    i2 = i3;
                                    int position2222 = byteBuffer.position();
                                    throw new ArrayIndexOutOfBoundsException("Failed writing " + charSequence.charAt(i2) + " at index " + (Math.max(i2, (position - byteBuffer.position()) + 1) + position2222));
                                }
                            } else {
                                i2 = i3;
                            }
                            ...
                            throw new ArrayIndexOutOfBoundsException("Failed writing " + charSequence.charAt(i2) + " at index " + (Math.max(i2, (position - byteBuffer.position()) + 1) + position22222));
                        }
                    }
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        public void encodeUtf8Direct(java.lang.CharSequence r30, java.nio.ByteBuffer r31) {
            /*
                ...
                r0 = r30
                r1 = r31
                long r2 = com.google.protobuf.UnsafeUtil.addressOffset(r31)
                int r4 = r31.position()
                long r4 = (long) r4
                long r4 = r4 + r2
                int r6 = r31.limit()
            ...
            L_0x0097:
                ...
                r1 = r1 | r12
                byte r1 = (byte) r1
                com.google.protobuf.UnsafeUtil.putByte(r10, r1)
                r27 = r6
                r1 = r9
                r9 = 128(0x80, float:1.794E-43)
                r23 = 1
            ...
            L_0x00c5:
                ...
                r3 = r3 | r9
                byte r3 = (byte) r3
                com.google.protobuf.UnsafeUtil.putByte(r10, r3)
                long r10 = r4 + r21
                int r3 = r2 >>> 6
                r3 = r3 & 63
                r3 = r3 | r9
                byte r3 = (byte) r3
                com.google.protobuf.UnsafeUtil.putByte(r6, r3)
                r6 = 4
                long r4 = r4 + r6
                r2 = r2 & 63
                r2 = r2 | r9
                byte r2 = (byte) r2
                com.google.protobuf.UnsafeUtil.putByte(r10, r2)
            L_0x010f:
                int r1 = r1 + 1
                r9 = r1
                r2 = r19
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0059, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r13, r1) > -65) goto L_0x005e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x009e, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r13, r1) > -65) goto L_0x00a0;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int partialIsValidUtf8(int r12, byte[] r13, int r14, int r15) {
            ...
            L_0x0011:
                ...
                long r7 = r7 + r1
                byte r12 = com.google.protobuf.UnsafeUtil.getByte((byte[]) r13, (long) r1)
            ...
            L_0x005f:
                ...
                long r9 = r1 + r7
                byte r4 = com.google.protobuf.UnsafeUtil.getByte((byte[]) r13, (long) r1)
            ...
            L_0x0079:
                ...
                long r9 = r1 + r7
                byte r0 = com.google.protobuf.UnsafeUtil.getByte((byte[]) r13, (long) r1)
                int r12 = (r9 > r14 ? 1 : (r9 == r14 ? 0 : -1))
                if (r12 < 0) goto L_0x008a
                int r12 = com.google.protobuf.Utf8.incompleteStateFor((int) r3, (int) r4, (int) r0)
                return r12
            L_0x008a:
                r1 = r9
            L_0x008b:
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x002e, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r1) > -65) goto L_0x0034;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0062, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r1) > -65) goto L_0x0064;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:53:0x00a3, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r1) > -65) goto L_0x00a5;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int partialIsValidUtf8Direct(int r11, java.nio.ByteBuffer r12, int r13, int r14) {
            /*
                ...
                long r1 = com.google.protobuf.UnsafeUtil.addressOffset(r12)
                long r3 = (long) r13
                long r1 = r1 + r3
                int r14 = r14 - r13
                long r12 = (long) r14
            ...
            L_0x001b:
                ...
                long r6 = r6 + r1
                byte r11 = com.google.protobuf.UnsafeUtil.getByte(r1)
            ...
            L_0x0065:
                ...
                long r8 = r1 + r6
                byte r3 = com.google.protobuf.UnsafeUtil.getByte(r1)
                int r11 = (r8 > r12 ? 1 : (r8 == r12 ? 0 : -1))
                if (r11 < 0) goto L_0x007a
                int r11 = com.google.protobuf.Utf8.incompleteStateFor(r14, r3)
                return r11
            L_0x007a:
                r1 = r8
                goto L_0x007f
            ...
            L_0x007f:
                ...
                int r11 = com.google.protobuf.Utf8.incompleteStateFor((int) r14, (int) r3, (int) r0)
                return r11
            L_0x0090:
                r1 = r8
            L_0x0091:
