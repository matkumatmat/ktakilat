...
public final class ErrorCorrection {
    ...
    public static String a(int i, String str) {
        ...
        throw new IllegalArgumentException(ba.k(i, "Illegal number of error correction codewords specified: "));
    }
}
