...
public final class KotlinExtensions {
    ...
    public static final <T> Object await(@NotNull Call<T> call, @NotNull Continuation<? super T> continuation) {
        ...
        cancellableContinuationImpl.s(new KotlinExtensions$await$$inlined$suspendCancellableCoroutine$lambda$1(call));
    ...
    public static final <T> Object awaitNullable(@NotNull Call<T> call, @NotNull Continuation<? super T> continuation) {
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(1, IntrinsicsKt.b(continuation));
        cancellableContinuationImpl.s(new KotlinExtensions$await$$inlined$suspendCancellableCoroutine$lambda$2(call));
    ...
    public static final <T> Object awaitResponse(@NotNull Call<T> call, @NotNull Continuation<? super Response<T>> continuation) {
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(1, IntrinsicsKt.b(continuation));
        cancellableContinuationImpl.s(new KotlinExtensions$awaitResponse$$inlined$suspendCancellableCoroutine$lambda$1(call));
    ...
    public static final <T> T create(@NotNull Retrofit retrofit) {
        Intrinsics.e(retrofit, "$this$create");
        Intrinsics.j();
        throw null;
    }
    ...
    public static final java.lang.Object suspendAndThrow(@org.jetbrains.annotations.NotNull java.lang.Exception r4, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<?> r5) {
        ...
        L_0x0035:
            ...
            r0.L$0 = r4
            r0.label = r3
            kotlinx.coroutines.scheduling.DefaultScheduler r5 = kotlinx.coroutines.Dispatchers.f767a
