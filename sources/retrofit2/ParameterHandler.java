...
abstract class ParameterHandler<T> {
                ...
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        if (value != null) {
                            ...
                            throw Utils.parameterError(this.method, this.p, ba.o("Field map contained null value for key '", str, "'."), new Object[0]);
                        }
                    } else {
                ...
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        if (value != null) {
                            ...
                            throw Utils.parameterError(this.method, this.p, ba.o("Header map contained null value for key '", str, "'."), new Object[0]);
                        }
                    } else {
            ...
            if (map != null) {
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        Object value = next.getValue();
                        if (value != null) {
                            requestBuilder.addPart(okhttp3.Headers.of(HttpHeaders.CONTENT_DISPOSITION, ba.o("form-data; name=\"", str, "\""), "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            throw Utils.parameterError(this.method, this.p, ba.o("Part map contained null value for key '", str, "'."), new Object[0]);
                        }
                    } else {
    ...
    public static final class Path<T> extends ParameterHandler<T> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable T t) throws IOException {
            ...
            throw Utils.parameterError(this.method, this.p, ba.r(new StringBuilder("Path parameter \""), this.name, "\" value must not be null."), new Object[0]);
        }
    }
                ...
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        if (value != null) {
                            ...
                            throw Utils.parameterError(this.method, this.p, ba.o("Query map contained null value for key '", str, "'."), new Object[0]);
                        }
                    } else {
