...
final class RequestFactory {
                    ...
                    if (annotation instanceof QueryMap) {
                        ...
                        if (annotation instanceof Part) {
                            ...
                            if (this.isMultipart) {
                                ...
                                if (!value5.isEmpty()) {
                                    Headers of = Headers.of(HttpHeaders.CONTENT_DISPOSITION, ba.o("form-data; name=\"", value5, "\""), "Content-Transfer-Encoding", part.encoding());
    ...
    public Request create(Object[] objArr) throws IOException {
        ...
        throw new IllegalArgumentException(ba.q(ba.t(length, "Argument count (", ") doesn't match expected count ("), ")", parameterHandlerArr.length));
    }
}
