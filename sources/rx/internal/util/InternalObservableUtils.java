...
public enum InternalObservableUtils {
    ...
    public static final class ReplaySupplierBufferTime<T> implements Func0<ConnectableObservable<T>> {
        ...
        public ReplaySupplierBufferTime(Observable<T> observable, long j, TimeUnit timeUnit, Scheduler scheduler2) {
            this.unit = timeUnit;
            this.source = observable;
            this.time = j;
    ...
    public static final class ReplaySupplierTime<T> implements Func0<ConnectableObservable<T>> {
        ...
        public ReplaySupplierTime(Observable<T> observable, int i, long j, TimeUnit timeUnit, Scheduler scheduler2) {
            this.time = j;
            this.unit = timeUnit;
            this.scheduler = scheduler2;
            this.bufferSize = i;
