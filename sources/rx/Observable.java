...
public class Observable<T> {
    ...
    public final AssertableSubscriber<T> test() {
        AssertableSubscriberObservable create = AssertableSubscriberObservable.create(LocationRequestCompat.PASSIVE_INTERVAL);
        subscribe(create);
        return create;
    }
    ...
    public final <R> Observable<R> concatMapEager(Func1<? super T, ? extends Observable<? extends R>> func1, int i) {
        ...
        throw new IllegalArgumentException(ba.k(i, "capacityHint > 0 required but it was "));
    }
    ...
    public final Observable<Observable<T>> window(int i, int i2) {
        if (i <= 0) {
            throw new IllegalArgumentException(ba.k(i, "count > 0 required but it was "));
        } else if (i2 > 0) {
            return lift(new OperatorWindowWithSize(i, i2));
        } else {
            throw new IllegalArgumentException(ba.k(i2, "skip > 0 required but it was "));
        }
    }
