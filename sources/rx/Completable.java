...
public class Completable {
    ...
    public Completable(OnSubscribe onSubscribe2, boolean z) {
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe((CompletableSubscriber) new CompletableSubscriber() {
                    public void onCompleted() {
                        ...
                        AnonymousClass16 r3 = AnonymousClass16.this;
                        compositeSubscription.add(worker.schedule(r2, j2, timeUnit2));
                    }
                    ...
                    public void onError(final Throwable th) {
                        if (z2) {
                            ...
                            AnonymousClass16 r6 = AnonymousClass16.this;
                            compositeSubscription.add(worker.schedule(r2, j2, timeUnit2));
                            return;
                        }
                        completableSubscriber.onError(th);
