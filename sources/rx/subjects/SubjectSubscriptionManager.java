    ...
    public static final class SubjectObserver<T> implements Observer<T> {
        ...
        public void emitFirst(java.lang.Object r2) {
            /*
                r1 = this;
                monitor-enter(r1)
                boolean r0 = r1.first     // Catch:{ all -> 0x001a }
                if (r0 == 0) goto L_0x001c
                boolean r0 = r1.emitting     // Catch:{ all -> 0x001a }
                if (r0 == 0) goto L_0x000a
                goto L_0x001c
            L_0x000a:
                r0 = 0
                r1.first = r0     // Catch:{ all -> 0x001a }
        ...
        public void emitNext(java.lang.Object r2) {
            /*
                ...
                monitor-enter(r1)
                r0 = 0
                r1.first = r0     // Catch:{ all -> 0x0018 }
                boolean r0 = r1.emitting     // Catch:{ all -> 0x0018 }
                if (r0 == 0) goto L_0x0021
                java.util.List<java.lang.Object> r0 = r1.queue     // Catch:{ all -> 0x0018 }
                if (r0 != 0) goto L_0x001a
                java.util.ArrayList r0 = new java.util.ArrayList     // Catch:{ all -> 0x0018 }
                r0.<init>()     // Catch:{ all -> 0x0018 }
                r1.queue = r0     // Catch:{ all -> 0x0018 }
                goto L_0x001a
            L_0x0018:
                r2 = move-exception
                goto L_0x0026
